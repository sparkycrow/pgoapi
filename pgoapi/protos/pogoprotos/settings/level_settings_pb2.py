...
_LEVELSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.settings.LevelSettings.trainer_cp_modifier',
            index=0,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.LevelSettings.trainer_difficulty_modifier',
            index=1,
            number=3,
            type=1,
            cpp_type=5,
...
LevelSettings = _reflection.GeneratedProtocolMessageType(
    'LevelSettings',
    (_message.Message, ),
    dict(
