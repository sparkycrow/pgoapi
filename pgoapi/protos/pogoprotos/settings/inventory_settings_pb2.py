...
_INVENTORYSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='max_pokemon',
            full_name='pogoprotos.settings.InventorySettings.max_pokemon',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='max_bag_items',
            full_name='pogoprotos.settings.InventorySettings.max_bag_items',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='base_pokemon',
            full_name='pogoprotos.settings.InventorySettings.base_pokemon',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='base_bag_items',
            full_name='pogoprotos.settings.InventorySettings.base_bag_items',
            index=3,
            number=4,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='base_eggs',
            full_name='pogoprotos.settings.InventorySettings.base_eggs',
            index=4,
            number=5,
            type=5,
            cpp_type=1,
...
InventorySettings = _reflection.GeneratedProtocolMessageType(
    'InventorySettings',
    (_message.Message, ),
    dict(
