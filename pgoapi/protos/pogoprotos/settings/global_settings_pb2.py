...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_settings_dot_event__settings__pb2.DESCRIPTOR,
        pogoprotos_dot_settings_dot_festival__settings__pb2.DESCRIPTOR,
        pogoprotos_dot_settings_dot_fort__settings__pb2.DESCRIPTOR,
        pogoprotos_dot_settings_dot_gps__settings__pb2.DESCRIPTOR,
        pogoprotos_dot_settings_dot_inventory__settings__pb2.DESCRIPTOR,
        pogoprotos_dot_settings_dot_level__settings__pb2.DESCRIPTOR,
        pogoprotos_dot_settings_dot_map__settings__pb2.DESCRIPTOR,
        pogoprotos_dot_settings_dot_news__settings__pb2.DESCRIPTOR,
        pogoprotos_dot_settings_dot_notification__settings__pb2.DESCRIPTOR,
        pogoprotos_dot_settings_dot_passcode__settings__pb2.DESCRIPTOR,
        pogoprotos_dot_settings_dot_sfida__settings__pb2.DESCRIPTOR,
        pogoprotos_dot_settings_dot_translation__settings__pb2.DESCRIPTOR,
    ])
...
_GLOBALSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='fort_settings',
            full_name='pogoprotos.settings.GlobalSettings.fort_settings',
            index=0,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='map_settings',
            full_name='pogoprotos.settings.GlobalSettings.map_settings',
            index=1,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='level_settings',
            full_name='pogoprotos.settings.GlobalSettings.level_settings',
            index=2,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.settings.GlobalSettings.inventory_settings',
            index=3,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='gps_settings',
            full_name='pogoprotos.settings.GlobalSettings.gps_settings',
            index=5,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.settings.GlobalSettings.festival_settings',
            index=6,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='event_settings',
            full_name='pogoprotos.settings.GlobalSettings.event_settings',
            index=7,
            number=9,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.settings.GlobalSettings.max_pokemon_types',
            index=8,
            number=10,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='sfida_settings',
            full_name='pogoprotos.settings.GlobalSettings.sfida_settings',
            index=9,
            number=11,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='news_settings',
            full_name='pogoprotos.settings.GlobalSettings.news_settings',
            index=10,
            number=12,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.settings.GlobalSettings.translation_settings',
            index=11,
            number=13,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.settings.GlobalSettings.passcode_settings',
            index=12,
            number=14,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.GlobalSettings.notification_settings',
            index=13,
            number=15,
            type=11,
            cpp_type=10,
...
_GLOBALSETTINGS.fields_by_name[
    'fort_settings'].message_type = pogoprotos_dot_settings_dot_fort__settings__pb2._FORTSETTINGS
_GLOBALSETTINGS.fields_by_name[
    'map_settings'].message_type = pogoprotos_dot_settings_dot_map__settings__pb2._MAPSETTINGS
_GLOBALSETTINGS.fields_by_name[
    'level_settings'].message_type = pogoprotos_dot_settings_dot_level__settings__pb2._LEVELSETTINGS
_GLOBALSETTINGS.fields_by_name[
    'inventory_settings'].message_type = pogoprotos_dot_settings_dot_inventory__settings__pb2._INVENTORYSETTINGS
_GLOBALSETTINGS.fields_by_name[
    'gps_settings'].message_type = pogoprotos_dot_settings_dot_gps__settings__pb2._GPSSETTINGS
_GLOBALSETTINGS.fields_by_name[
    'festival_settings'].message_type = pogoprotos_dot_settings_dot_festival__settings__pb2._FESTIVALSETTINGS
_GLOBALSETTINGS.fields_by_name[
    'event_settings'].message_type = pogoprotos_dot_settings_dot_event__settings__pb2._EVENTSETTINGS
_GLOBALSETTINGS.fields_by_name[
    'sfida_settings'].message_type = pogoprotos_dot_settings_dot_sfida__settings__pb2._SFIDASETTINGS
_GLOBALSETTINGS.fields_by_name[
    'news_settings'].message_type = pogoprotos_dot_settings_dot_news__settings__pb2._NEWSSETTINGS
_GLOBALSETTINGS.fields_by_name[
    'translation_settings'].message_type = pogoprotos_dot_settings_dot_translation__settings__pb2._TRANSLATIONSETTINGS
_GLOBALSETTINGS.fields_by_name[
    'passcode_settings'].message_type = pogoprotos_dot_settings_dot_passcode__settings__pb2._PASSCODESETTINGS
_GLOBALSETTINGS.fields_by_name[
    'notification_settings'].message_type = pogoprotos_dot_settings_dot_notification__settings__pb2._NOTIFICATIONSETTINGS
DESCRIPTOR.message_types_by_name['GlobalSettings'] = _GLOBALSETTINGS

GlobalSettings = _reflection.GeneratedProtocolMessageType(
    'GlobalSettings',
    (_message.Message, ),
    dict(
