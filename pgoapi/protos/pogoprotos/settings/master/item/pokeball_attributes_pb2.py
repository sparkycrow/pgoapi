...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_enums_dot_item__effect__pb2.DESCRIPTOR,
    ])
...
_POKEBALLATTRIBUTES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='item_effect',
            full_name=
            'pogoprotos.settings.master.item.PokeballAttributes.item_effect',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='capture_multi',
            full_name=
            'pogoprotos.settings.master.item.PokeballAttributes.capture_multi',
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.item.PokeballAttributes.capture_multi_effect',
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.item.PokeballAttributes.item_effect_mod',
            index=3,
            number=4,
            type=2,
            cpp_type=6,
...
_POKEBALLATTRIBUTES.fields_by_name[
    'item_effect'].enum_type = pogoprotos_dot_enums_dot_item__effect__pb2._ITEMEFFECT
DESCRIPTOR.message_types_by_name['PokeballAttributes'] = _POKEBALLATTRIBUTES

PokeballAttributes = _reflection.GeneratedProtocolMessageType(
    'PokeballAttributes',
    (_message.Message, ),
    dict(
