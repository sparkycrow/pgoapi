...
_INCENSEATTRIBUTES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.item.IncenseAttributes.incense_lifetime_seconds',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='pokemon_type',
            full_name=
            'pogoprotos.settings.master.item.IncenseAttributes.pokemon_type',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.item.IncenseAttributes.pokemon_incense_type_probability',
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.item.IncenseAttributes.standing_time_between_encounters_seconds',
            index=3,
            number=4,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.item.IncenseAttributes.moving_time_between_encounter_seconds',
            index=4,
            number=5,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.item.IncenseAttributes.distance_required_for_shorter_interval_meters',
            index=5,
            number=6,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.item.IncenseAttributes.pokemon_attracted_length_sec',
            index=6,
            number=7,
            type=5,
            cpp_type=1,
...
_INCENSEATTRIBUTES.fields_by_name[
...
IncenseAttributes = _reflection.GeneratedProtocolMessageType(
    'IncenseAttributes',
    (_message.Message, ),
    dict(
