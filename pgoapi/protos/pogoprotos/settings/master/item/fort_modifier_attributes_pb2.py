...
_FORTMODIFIERATTRIBUTES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.item.FortModifierAttributes.modifier_lifetime_seconds',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.item.FortModifierAttributes.troy_disk_num_pokemon_spawned',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
DESCRIPTOR.message_types_by_name[
    'FortModifierAttributes'] = _FORTMODIFIERATTRIBUTES

FortModifierAttributes = _reflection.GeneratedProtocolMessageType(
    'FortModifierAttributes',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_FORTMODIFIERATTRIBUTES,
        __module__=
        'pogoprotos.settings.master.item.fort_modifier_attributes_pb2'
