...
_FOODATTRIBUTES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='item_effect',
            full_name=
            'pogoprotos.settings.master.item.FoodAttributes.item_effect',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.item.FoodAttributes.item_effect_percent',
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='growth_percent',
            full_name=
            'pogoprotos.settings.master.item.FoodAttributes.growth_percent',
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.item.FoodAttributes.berry_multiplier',
            index=3,
            number=4,
            type=2,
            cpp_type=6,
...
_FOODATTRIBUTES.fields_by_name[
...
FoodAttributes = _reflection.GeneratedProtocolMessageType(
    'FoodAttributes',
    (_message.Message, ),
    dict(
