...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_inventory_dot_inventory__upgrade__type__pb2.DESCRIPTOR,
    ])
...
_INVENTORYUPGRADEATTRIBUTES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.item.InventoryUpgradeAttributes.additional_storage',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='upgrade_type',
            full_name=
            'pogoprotos.settings.master.item.InventoryUpgradeAttributes.upgrade_type',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
...
_INVENTORYUPGRADEATTRIBUTES.fields_by_name[
    'upgrade_type'].enum_type = pogoprotos_dot_inventory_dot_inventory__upgrade__type__pb2._INVENTORYUPGRADETYPE
DESCRIPTOR.message_types_by_name[
    'InventoryUpgradeAttributes'] = _INVENTORYUPGRADEATTRIBUTES

InventoryUpgradeAttributes = _reflection.GeneratedProtocolMessageType(
    'InventoryUpgradeAttributes',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_INVENTORYUPGRADEATTRIBUTES,
        __module__=
        'pogoprotos.settings.master.item.inventory_upgrade_attributes_pb2'
