...
_GYMBATTLESETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='energy_per_sec',
            full_name=
            'pogoprotos.settings.master.GymBattleSettings.energy_per_sec',
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymBattleSettings.dodge_energy_cost',
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymBattleSettings.retarget_seconds',
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymBattleSettings.enemy_attack_interval',
            index=3,
            number=4,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymBattleSettings.attack_server_interval',
            index=4,
            number=5,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymBattleSettings.round_duration_seconds',
            index=5,
            number=6,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymBattleSettings.bonus_time_per_ally_seconds',
            index=6,
            number=7,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymBattleSettings.maximum_attackers_per_battle',
            index=7,
            number=8,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymBattleSettings.same_type_attack_bonus_multiplier',
            index=8,
            number=9,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='maximum_energy',
            full_name=
            'pogoprotos.settings.master.GymBattleSettings.maximum_energy',
            index=9,
            number=10,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymBattleSettings.energy_delta_per_health_lost',
            index=10,
            number=11,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymBattleSettings.dodge_duration_ms',
            index=11,
            number=12,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymBattleSettings.minimum_player_level',
            index=12,
            number=13,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymBattleSettings.swap_duration_ms',
            index=13,
            number=14,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymBattleSettings.dodge_damage_reduction_percent',
            index=14,
            number=15,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymBattleSettings.minimum_raid_player_level',
            index=15,
            number=16,
            type=5,
            cpp_type=1,
...
GymBattleSettings = _reflection.GeneratedProtocolMessageType(
    'GymBattleSettings',
    (_message.Message, ),
    dict(
