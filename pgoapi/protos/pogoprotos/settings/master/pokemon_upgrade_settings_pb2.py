...
_POKEMONUPGRADESETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.PokemonUpgradeSettings.upgrades_per_level',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.PokemonUpgradeSettings.allowed_levels_above_player',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='candy_cost',
            full_name=
            'pogoprotos.settings.master.PokemonUpgradeSettings.candy_cost',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='stardust_cost',
            full_name=
            'pogoprotos.settings.master.PokemonUpgradeSettings.stardust_cost',
            index=3,
            number=4,
            type=5,
            cpp_type=1,
...
DESCRIPTOR.message_types_by_name[
    'PokemonUpgradeSettings'] = _POKEMONUPGRADESETTINGS

PokemonUpgradeSettings = _reflection.GeneratedProtocolMessageType(
