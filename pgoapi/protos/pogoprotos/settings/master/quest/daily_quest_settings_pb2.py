...
_DAILYQUESTSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.quest.DailyQuestSettings.buckets_per_day',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='streak_length',
            full_name=
            'pogoprotos.settings.master.quest.DailyQuestSettings.streak_length',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.quest.DailyQuestSettings.bonus_multiplier',
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.quest.DailyQuestSettings.streak_bonus_multiplier',
            index=3,
            number=4,
            type=2,
            cpp_type=6,
...
DailyQuestSettings = _reflection.GeneratedProtocolMessageType(
    'DailyQuestSettings',
    (_message.Message, ),
    dict(
