...
_PLAYERLEVELSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='rank_num',
            full_name='pogoprotos.settings.master.PlayerLevelSettings.rank_num',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.PlayerLevelSettings.required_experience',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='cp_multiplier',
            full_name=
            'pogoprotos.settings.master.PlayerLevelSettings.cp_multiplier',
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.PlayerLevelSettings.max_encounter_player_level',
            index=4,
            number=5,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.PlayerLevelSettings.max_raid_encounter_player_level',
            index=5,
            number=6,
            type=5,
            cpp_type=1,
...
PlayerLevelSettings = _reflection.GeneratedProtocolMessageType(
    'PlayerLevelSettings',
    (_message.Message, ),
    dict(
