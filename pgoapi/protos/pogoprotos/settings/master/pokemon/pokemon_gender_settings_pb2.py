...
_POKEMONGENDERSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='male_percent',
            full_name=
            'pogoprotos.settings.master.pokemon.PokemonGenderSettings.male_percent',
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='female_percent',
            full_name=
            'pogoprotos.settings.master.pokemon.PokemonGenderSettings.female_percent',
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.pokemon.PokemonGenderSettings.genderless_percent',
            index=2,
            number=3,
            type=2,
            cpp_type=6,
...
DESCRIPTOR.message_types_by_name[
    'PokemonGenderSettings'] = _POKEMONGENDERSETTINGS

PokemonGenderSettings = _reflection.GeneratedProtocolMessageType(
    'PokemonGenderSettings',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_POKEMONGENDERSETTINGS,
        __module__=
        'pogoprotos.settings.master.pokemon.pokemon_gender_settings_pb2'
