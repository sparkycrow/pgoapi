...
_EVOLUTIONBRANCH = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='evolution',
            full_name=
            'pogoprotos.settings.master.pokemon.EvolutionBranch.evolution',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.pokemon.EvolutionBranch.evolution_item_requirement',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='candy_cost',
            full_name=
            'pogoprotos.settings.master.pokemon.EvolutionBranch.candy_cost',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
...
_EVOLUTIONBRANCH.fields_by_name[
    'evolution'].enum_type = pogoprotos_dot_enums_dot_pokemon__id__pb2._POKEMONID
_EVOLUTIONBRANCH.fields_by_name[
...
EvolutionBranch = _reflection.GeneratedProtocolMessageType(
    'EvolutionBranch',
    (_message.Message, ),
    dict(
