...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        pogoprotos_dot_enums_dot_pokemon__rarity__pb2.DESCRIPTOR,
        pogoprotos_dot_enums_dot_pokemon__type__pb2.DESCRIPTOR,
        pogoprotos_dot_enums_dot_pokemon__move__pb2.DESCRIPTOR,
        pogoprotos_dot_enums_dot_pokemon__family__id__pb2.DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_pokemon_dot_stats__attributes__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_pokemon_dot_camera__attributes__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_pokemon_dot_encounter__attributes__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_pokemon_dot_evolution__branch__pb2.
        DESCRIPTOR,
    ])
...
_POKEMONSETTINGS_BUDDYSIZE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name='BUDDY_MEDIUM', index=0, number=0, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='BUDDY_SHOULDER', index=1, number=1, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='BUDDY_BIG', index=2, number=2, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='BUDDY_FLYING', index=3, number=3, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='BUDDY_BABY', index=4, number=4, options=None, type=None),
    ],
...
_POKEMONSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name='pogoprotos.settings.master.PokemonSettings.pokemon_id',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='model_scale',
            full_name='pogoprotos.settings.master.PokemonSettings.model_scale',
            index=1,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='type',
            full_name='pogoprotos.settings.master.PokemonSettings.type',
            index=2,
            number=4,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='type_2',
            full_name='pogoprotos.settings.master.PokemonSettings.type_2',
            index=3,
            number=5,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='camera',
            full_name='pogoprotos.settings.master.PokemonSettings.camera',
            index=4,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='encounter',
            full_name='pogoprotos.settings.master.PokemonSettings.encounter',
            index=5,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='stats',
            full_name='pogoprotos.settings.master.PokemonSettings.stats',
            index=6,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='quick_moves',
            full_name='pogoprotos.settings.master.PokemonSettings.quick_moves',
            index=7,
            number=9,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.PokemonSettings.cinematic_moves',
            index=8,
            number=10,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='animation_time',
            full_name=
            'pogoprotos.settings.master.PokemonSettings.animation_time',
            index=9,
            number=11,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='evolution_ids',
            full_name=
            'pogoprotos.settings.master.PokemonSettings.evolution_ids',
            index=10,
            number=12,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='evolution_pips',
            full_name=
            'pogoprotos.settings.master.PokemonSettings.evolution_pips',
            index=11,
            number=13,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='rarity',
            full_name='pogoprotos.settings.master.PokemonSettings.rarity',
            index=12,
            number=14,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.PokemonSettings.pokedex_height_m',
            index=13,
            number=15,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.PokemonSettings.pokedex_weight_kg',
            index=14,
            number=16,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.PokemonSettings.parent_pokemon_id',
            index=15,
            number=17,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='height_std_dev',
            full_name=
            'pogoprotos.settings.master.PokemonSettings.height_std_dev',
            index=16,
            number=18,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='weight_std_dev',
            full_name=
            'pogoprotos.settings.master.PokemonSettings.weight_std_dev',
            index=17,
            number=19,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.PokemonSettings.km_distance_to_hatch',
            index=18,
            number=20,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='family_id',
            full_name='pogoprotos.settings.master.PokemonSettings.family_id',
            index=19,
            number=21,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.PokemonSettings.candy_to_evolve',
            index=20,
            number=22,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.PokemonSettings.km_buddy_distance',
            index=21,
            number=23,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='buddy_size',
            full_name='pogoprotos.settings.master.PokemonSettings.buddy_size',
            index=22,
            number=24,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='model_height',
            full_name='pogoprotos.settings.master.PokemonSettings.model_height',
            index=23,
            number=25,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.PokemonSettings.evolution_branch',
            index=24,
            number=26,
            type=11,
            cpp_type=10,
...
_POKEMONSETTINGS.fields_by_name[
    'pokemon_id'].enum_type = pogoprotos_dot_enums_dot_pokemon__id__pb2._POKEMONID
_POKEMONSETTINGS.fields_by_name[
    'type'].enum_type = pogoprotos_dot_enums_dot_pokemon__type__pb2._POKEMONTYPE
_POKEMONSETTINGS.fields_by_name[
    'type_2'].enum_type = pogoprotos_dot_enums_dot_pokemon__type__pb2._POKEMONTYPE
_POKEMONSETTINGS.fields_by_name[
    'camera'].message_type = pogoprotos_dot_settings_dot_master_dot_pokemon_dot_camera__attributes__pb2._CAMERAATTRIBUTES
_POKEMONSETTINGS.fields_by_name[
    'encounter'].message_type = pogoprotos_dot_settings_dot_master_dot_pokemon_dot_encounter__attributes__pb2._ENCOUNTERATTRIBUTES
_POKEMONSETTINGS.fields_by_name[
    'stats'].message_type = pogoprotos_dot_settings_dot_master_dot_pokemon_dot_stats__attributes__pb2._STATSATTRIBUTES
_POKEMONSETTINGS.fields_by_name[
    'quick_moves'].enum_type = pogoprotos_dot_enums_dot_pokemon__move__pb2._POKEMONMOVE
_POKEMONSETTINGS.fields_by_name[
    'cinematic_moves'].enum_type = pogoprotos_dot_enums_dot_pokemon__move__pb2._POKEMONMOVE
_POKEMONSETTINGS.fields_by_name[
    'evolution_ids'].enum_type = pogoprotos_dot_enums_dot_pokemon__id__pb2._POKEMONID
_POKEMONSETTINGS.fields_by_name[
    'rarity'].enum_type = pogoprotos_dot_enums_dot_pokemon__rarity__pb2._POKEMONRARITY
_POKEMONSETTINGS.fields_by_name[
    'parent_pokemon_id'].enum_type = pogoprotos_dot_enums_dot_pokemon__id__pb2._POKEMONID
_POKEMONSETTINGS.fields_by_name[
    'family_id'].enum_type = pogoprotos_dot_enums_dot_pokemon__family__id__pb2._POKEMONFAMILYID
_POKEMONSETTINGS.fields_by_name[
    'buddy_size'].enum_type = _POKEMONSETTINGS_BUDDYSIZE
_POKEMONSETTINGS.fields_by_name[
    'evolution_branch'].message_type = pogoprotos_dot_settings_dot_master_dot_pokemon_dot_evolution__branch__pb2._EVOLUTIONBRANCH
...
PokemonSettings = _reflection.GeneratedProtocolMessageType(
    'PokemonSettings',
    (_message.Message, ),
    dict(
