...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_data_dot_player_dot_player__avatar__type__pb2.
        DESCRIPTOR,
        pogoprotos_dot_enums_dot_badge__type__pb2.DESCRIPTOR,
        pogoprotos_dot_enums_dot_slot__pb2.DESCRIPTOR,
    ])
...
_AVATARCUSTOMIZATIONSETTINGS_AVATARCUSTOMIZATIONPROMOTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='SALE', index=1, number=1, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='FEATURED', index=2, number=2, options=None, type=None),
    ],
...
_AVATARCUSTOMIZATIONSETTINGS_AVATARCUSTOMIZATIONUNLOCKTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='DEFAULT', index=1, number=1, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='MEDAL_REWARD', index=2, number=2, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='IAP_CLOTHING', index=3, number=3, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='LEVEL_REWARD', index=4, number=4, options=None, type=None),
    ],
    containing_type=None,
    options=None,
...
_AVATARCUSTOMIZATIONSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='enabled',
            full_name=
            'pogoprotos.settings.master.AvatarCustomizationSettings.enabled',
            index=0,
            number=1,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='avatar_type',
            full_name=
            'pogoprotos.settings.master.AvatarCustomizationSettings.avatar_type',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='slot',
            full_name=
            'pogoprotos.settings.master.AvatarCustomizationSettings.slot',
            index=2,
            number=3,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='bundle_name',
            full_name=
            'pogoprotos.settings.master.AvatarCustomizationSettings.bundle_name',
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='asset_name',
            full_name=
            'pogoprotos.settings.master.AvatarCustomizationSettings.asset_name',
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='group_name',
            full_name=
            'pogoprotos.settings.master.AvatarCustomizationSettings.group_name',
            index=5,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='sort_order',
            full_name=
            'pogoprotos.settings.master.AvatarCustomizationSettings.sort_order',
            index=6,
            number=7,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='unlock_type',
            full_name=
            'pogoprotos.settings.master.AvatarCustomizationSettings.unlock_type',
            index=7,
            number=8,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='promo_type',
            full_name=
            'pogoprotos.settings.master.AvatarCustomizationSettings.promo_type',
            index=8,
            number=9,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.AvatarCustomizationSettings.unlock_badge_type',
            index=9,
            number=10,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='iap_sku',
            full_name=
            'pogoprotos.settings.master.AvatarCustomizationSettings.iap_sku',
            index=10,
            number=11,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.AvatarCustomizationSettings.unlock_badge_level',
            index=11,
            number=12,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='icon_name',
            full_name=
            'pogoprotos.settings.master.AvatarCustomizationSettings.icon_name',
            index=12,
            number=13,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.AvatarCustomizationSettings.unlock_player_level',
            index=13,
            number=14,
            type=5,
            cpp_type=1,
...
_AVATARCUSTOMIZATIONSETTINGS.fields_by_name[
    'avatar_type'].enum_type = pogoprotos_dot_data_dot_player_dot_player__avatar__type__pb2._PLAYERAVATARTYPE
_AVATARCUSTOMIZATIONSETTINGS.fields_by_name[
    'slot'].enum_type = pogoprotos_dot_enums_dot_slot__pb2._SLOT
_AVATARCUSTOMIZATIONSETTINGS.fields_by_name[
    'unlock_type'].enum_type = _AVATARCUSTOMIZATIONSETTINGS_AVATARCUSTOMIZATIONUNLOCKTYPE
_AVATARCUSTOMIZATIONSETTINGS.fields_by_name[
    'promo_type'].enum_type = _AVATARCUSTOMIZATIONSETTINGS_AVATARCUSTOMIZATIONPROMOTYPE
_AVATARCUSTOMIZATIONSETTINGS.fields_by_name[
    'unlock_badge_type'].enum_type = pogoprotos_dot_enums_dot_badge__type__pb2._BADGETYPE
...
DESCRIPTOR.message_types_by_name[
    'AvatarCustomizationSettings'] = _AVATARCUSTOMIZATIONSETTINGS

AvatarCustomizationSettings = _reflection.GeneratedProtocolMessageType(
    'AvatarCustomizationSettings',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_AVATARCUSTOMIZATIONSETTINGS,
        __module__=
        'pogoprotos.settings.master.avatar_customization_settings_pb2'
