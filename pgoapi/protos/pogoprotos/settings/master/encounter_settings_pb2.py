...
_ENCOUNTERSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.EncounterSettings.spin_bonus_threshold',
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.EncounterSettings.excellent_throw_threshold',
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.EncounterSettings.great_throw_threshold',
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.EncounterSettings.nice_throw_threshold',
            index=3,
            number=4,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.EncounterSettings.milestone_threshold',
            index=4,
            number=5,
            type=5,
            cpp_type=1,
...
EncounterSettings = _reflection.GeneratedProtocolMessageType(
    'EncounterSettings',
    (_message.Message, ),
    dict(
