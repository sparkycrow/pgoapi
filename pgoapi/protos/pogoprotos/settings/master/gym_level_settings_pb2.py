...
_GYMLEVELSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymLevelSettings.required_experience',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='leader_slots',
            full_name=
            'pogoprotos.settings.master.GymLevelSettings.leader_slots',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='trainer_slots',
            full_name=
            'pogoprotos.settings.master.GymLevelSettings.trainer_slots',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymLevelSettings.search_roll_bonus',
            index=3,
            number=4,
            type=5,
            cpp_type=1,
...
GymLevelSettings = _reflection.GeneratedProtocolMessageType(
    'GymLevelSettings',
    (_message.Message, ),
    dict(
