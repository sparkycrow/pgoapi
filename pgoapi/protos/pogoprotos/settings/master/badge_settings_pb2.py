...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        pogoprotos_dot_data_dot_badge_dot_badge__capture__reward__pb2.
        DESCRIPTOR,
    ])
...
_BADGESETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='badge_type',
            full_name='pogoprotos.settings.master.BadgeSettings.badge_type',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='badge_rank',
            full_name='pogoprotos.settings.master.BadgeSettings.badge_rank',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='targets',
            full_name='pogoprotos.settings.master.BadgeSettings.targets',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='capture_reward',
            full_name='pogoprotos.settings.master.BadgeSettings.capture_reward',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
...
_BADGESETTINGS.fields_by_name[
    'badge_type'].enum_type = pogoprotos_dot_enums_dot_badge__type__pb2._BADGETYPE
_BADGESETTINGS.fields_by_name[
    'capture_reward'].message_type = pogoprotos_dot_data_dot_badge_dot_badge__capture__reward__pb2._BADGECAPTUREREWARD
DESCRIPTOR.message_types_by_name['BadgeSettings'] = _BADGESETTINGS

BadgeSettings = _reflection.GeneratedProtocolMessageType(
    'BadgeSettings',
    (_message.Message, ),
    dict(
