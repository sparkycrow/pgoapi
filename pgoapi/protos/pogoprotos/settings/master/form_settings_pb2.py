...
_FORMSETTINGS_FORM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='form',
            full_name='pogoprotos.settings.master.FormSettings.Form.form',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.FormSettings.Form.asset_bundle_value',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_FORMSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='pokemon',
            full_name='pogoprotos.settings.master.FormSettings.pokemon',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='forms',
            full_name='pogoprotos.settings.master.FormSettings.forms',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_FORMSETTINGS_FORM.fields_by_name[
    'form'].enum_type = pogoprotos_dot_enums_dot_form__pb2._FORM
_FORMSETTINGS_FORM.containing_type = _FORMSETTINGS
_FORMSETTINGS.fields_by_name[
    'pokemon'].enum_type = pogoprotos_dot_enums_dot_pokemon__id__pb2._POKEMONID
...
FormSettings = _reflection.GeneratedProtocolMessageType(
    'FormSettings',
    (_message.Message, ),
    dict(
