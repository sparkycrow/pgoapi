...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_enums_dot_item__category__pb2.DESCRIPTOR,
        ...
        pogoprotos_dot_settings_dot_master_dot_item_dot_food__attributes__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_item_dot_potion__attributes__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_item_dot_revive__attributes__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_item_dot_battle__attributes__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_item_dot_incense__attributes__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_item_dot_pokeball__attributes__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_item_dot_fort__modifier__attributes__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_item_dot_egg__incubator__attributes__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_item_dot_experience__boost__attributes__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_item_dot_inventory__upgrade__attributes__pb2.
        DESCRIPTOR,
    ])
...
_ITEMSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='item_id',
            full_name='pogoprotos.settings.master.ItemSettings.item_id',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='item_type',
            full_name='pogoprotos.settings.master.ItemSettings.item_type',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='category',
            full_name='pogoprotos.settings.master.ItemSettings.category',
            index=2,
            number=3,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='drop_freq',
            full_name='pogoprotos.settings.master.ItemSettings.drop_freq',
            index=3,
            number=4,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.ItemSettings.drop_trainer_level',
            index=4,
            number=5,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='pokeball',
            full_name='pogoprotos.settings.master.ItemSettings.pokeball',
            index=5,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='potion',
            full_name='pogoprotos.settings.master.ItemSettings.potion',
            index=6,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='revive',
            full_name='pogoprotos.settings.master.ItemSettings.revive',
            index=7,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='battle',
            full_name='pogoprotos.settings.master.ItemSettings.battle',
            index=8,
            number=9,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='food',
            full_name='pogoprotos.settings.master.ItemSettings.food',
            index=9,
            number=10,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.ItemSettings.inventory_upgrade',
            index=10,
            number=11,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='xp_boost',
            full_name='pogoprotos.settings.master.ItemSettings.xp_boost',
            index=11,
            number=12,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='incense',
            full_name='pogoprotos.settings.master.ItemSettings.incense',
            index=12,
            number=13,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='egg_incubator',
            full_name='pogoprotos.settings.master.ItemSettings.egg_incubator',
            index=13,
            number=14,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='fort_modifier',
            full_name='pogoprotos.settings.master.ItemSettings.fort_modifier',
            index=14,
            number=15,
            type=11,
            cpp_type=10,
...
_ITEMSETTINGS.fields_by_name[
    'category'].enum_type = pogoprotos_dot_enums_dot_item__category__pb2._ITEMCATEGORY
_ITEMSETTINGS.fields_by_name[
    'pokeball'].message_type = pogoprotos_dot_settings_dot_master_dot_item_dot_pokeball__attributes__pb2._POKEBALLATTRIBUTES
_ITEMSETTINGS.fields_by_name[
    'potion'].message_type = pogoprotos_dot_settings_dot_master_dot_item_dot_potion__attributes__pb2._POTIONATTRIBUTES
_ITEMSETTINGS.fields_by_name[
    'revive'].message_type = pogoprotos_dot_settings_dot_master_dot_item_dot_revive__attributes__pb2._REVIVEATTRIBUTES
_ITEMSETTINGS.fields_by_name[
    'battle'].message_type = pogoprotos_dot_settings_dot_master_dot_item_dot_battle__attributes__pb2._BATTLEATTRIBUTES
_ITEMSETTINGS.fields_by_name[
    'food'].message_type = pogoprotos_dot_settings_dot_master_dot_item_dot_food__attributes__pb2._FOODATTRIBUTES
_ITEMSETTINGS.fields_by_name[
    'inventory_upgrade'].message_type = pogoprotos_dot_settings_dot_master_dot_item_dot_inventory__upgrade__attributes__pb2._INVENTORYUPGRADEATTRIBUTES
_ITEMSETTINGS.fields_by_name[
    'xp_boost'].message_type = pogoprotos_dot_settings_dot_master_dot_item_dot_experience__boost__attributes__pb2._EXPERIENCEBOOSTATTRIBUTES
_ITEMSETTINGS.fields_by_name[
    'incense'].message_type = pogoprotos_dot_settings_dot_master_dot_item_dot_incense__attributes__pb2._INCENSEATTRIBUTES
_ITEMSETTINGS.fields_by_name[
    'egg_incubator'].message_type = pogoprotos_dot_settings_dot_master_dot_item_dot_egg__incubator__attributes__pb2._EGGINCUBATORATTRIBUTES
_ITEMSETTINGS.fields_by_name[
    'fort_modifier'].message_type = pogoprotos_dot_settings_dot_master_dot_item_dot_fort__modifier__attributes__pb2._FORTMODIFIERATTRIBUTES
DESCRIPTOR.message_types_by_name['ItemSettings'] = _ITEMSETTINGS

ItemSettings = _reflection.GeneratedProtocolMessageType(
    'ItemSettings',
    (_message.Message, ),
    dict(
