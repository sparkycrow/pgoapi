...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_enums_dot_camera__target__pb2.DESCRIPTOR,
        pogoprotos_dot_enums_dot_camera__interpolation__pb2.DESCRIPTOR,
    ])
...
_CAMERASETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='next_camera',
            full_name='pogoprotos.settings.master.CameraSettings.next_camera',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='interpolation',
            full_name='pogoprotos.settings.master.CameraSettings.interpolation',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='target_type',
            full_name='pogoprotos.settings.master.CameraSettings.target_type',
            index=2,
            number=3,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='ease_in_speed',
            full_name='pogoprotos.settings.master.CameraSettings.ease_in_speed',
            index=3,
            number=4,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='ease_out_speed',
            full_name=
            'pogoprotos.settings.master.CameraSettings.ease_out_speed',
            index=4,
            number=5,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.CameraSettings.duration_seconds',
            index=5,
            number=6,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='wait_seconds',
            full_name='pogoprotos.settings.master.CameraSettings.wait_seconds',
            index=6,
            number=7,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.CameraSettings.transition_seconds',
            index=7,
            number=8,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='angle_degree',
            full_name='pogoprotos.settings.master.CameraSettings.angle_degree',
            index=8,
            number=9,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.CameraSettings.angle_offset_degree',
            index=9,
            number=10,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='pitch_degree',
            full_name='pogoprotos.settings.master.CameraSettings.pitch_degree',
            index=10,
            number=11,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.CameraSettings.pitch_offset_degree',
            index=11,
            number=12,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='roll_degree',
            full_name='pogoprotos.settings.master.CameraSettings.roll_degree',
            index=12,
            number=13,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.CameraSettings.distance_meters',
            index=13,
            number=14,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='height_percent',
            full_name=
            'pogoprotos.settings.master.CameraSettings.height_percent',
            index=14,
            number=15,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='vert_ctr_ratio',
            full_name=
            'pogoprotos.settings.master.CameraSettings.vert_ctr_ratio',
            index=15,
            number=16,
            type=2,
            cpp_type=6,
...
_CAMERASETTINGS.fields_by_name[
    'interpolation'].enum_type = pogoprotos_dot_enums_dot_camera__interpolation__pb2._CAMERAINTERPOLATION
_CAMERASETTINGS.fields_by_name[
    'target_type'].enum_type = pogoprotos_dot_enums_dot_camera__target__pb2._CAMERATARGET
DESCRIPTOR.message_types_by_name['CameraSettings'] = _CAMERASETTINGS

CameraSettings = _reflection.GeneratedProtocolMessageType(
    'CameraSettings',
    (_message.Message, ),
    dict(
