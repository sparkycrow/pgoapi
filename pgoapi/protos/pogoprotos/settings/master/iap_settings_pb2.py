...
_IAPSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.IapSettings.daily_bonus_coins',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.IapSettings.daily_defender_bonus_per_pokemon',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.IapSettings.daily_defender_bonus_max_defenders',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.IapSettings.min_time_between_claims_ms',
            index=4,
            number=5,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.IapSettings.daily_bonus_enabled',
            index=5,
            number=6,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.IapSettings.daily_defender_bonus_enabled',
            index=6,
            number=7,
            type=8,
            cpp_type=7,
...
IapSettings = _reflection.GeneratedProtocolMessageType(
    'IapSettings',
    (_message.Message, ),
    dict(
