...
_GYMBADGEGMTSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='target',
            full_name='pogoprotos.settings.master.GymBadgeGmtSettings.target',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymBadgeGmtSettings.battle_winning_score_per_defender_cp',
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymBadgeGmtSettings.gym_defending_score_per_minute',
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymBadgeGmtSettings.berry_feeding_score',
            index=3,
            number=4,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymBadgeGmtSettings.pokemon_deploy_score',
            index=4,
            number=5,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymBadgeGmtSettings.raid_battle_winning_score',
            index=5,
            number=6,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.GymBadgeGmtSettings.lose_all_battles_score',
            index=6,
            number=7,
            type=5,
            cpp_type=1,
...
GymBadgeGmtSettings = _reflection.GeneratedProtocolMessageType(
    'GymBadgeGmtSettings',
    (_message.Message, ),
    dict(
