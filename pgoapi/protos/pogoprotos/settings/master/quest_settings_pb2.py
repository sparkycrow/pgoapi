...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        pogoprotos_dot_settings_dot_master_dot_quest_dot_daily__quest__settings__pb2.
        DESCRIPTOR,
    ])
...
_QUESTSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='quest_type',
            full_name='pogoprotos.settings.master.QuestSettings.quest_type',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='daily_quest',
            full_name='pogoprotos.settings.master.QuestSettings.daily_quest',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_QUESTSETTINGS.fields_by_name[
    'quest_type'].enum_type = pogoprotos_dot_enums_dot_quest__type__pb2._QUESTTYPE
_QUESTSETTINGS.fields_by_name[
    'daily_quest'].message_type = pogoprotos_dot_settings_dot_master_dot_quest_dot_daily__quest__settings__pb2._DAILYQUESTSETTINGS
DESCRIPTOR.message_types_by_name['QuestSettings'] = _QUESTSETTINGS

QuestSettings = _reflection.GeneratedProtocolMessageType(
    'QuestSettings',
    (_message.Message, ),
    dict(
