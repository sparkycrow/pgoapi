...
_MOVESETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='movement_id',
            full_name='pogoprotos.settings.master.MoveSettings.movement_id',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='animation_id',
            full_name='pogoprotos.settings.master.MoveSettings.animation_id',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='pokemon_type',
            full_name='pogoprotos.settings.master.MoveSettings.pokemon_type',
            index=2,
            number=3,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='power',
            full_name='pogoprotos.settings.master.MoveSettings.power',
            index=3,
            number=4,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.settings.master.MoveSettings.accuracy_chance',
            index=4,
            number=5,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.settings.master.MoveSettings.critical_chance',
            index=5,
            number=6,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='heal_scalar',
            full_name='pogoprotos.settings.master.MoveSettings.heal_scalar',
            index=6,
            number=7,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.MoveSettings.stamina_loss_scalar',
            index=7,
            number=8,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.MoveSettings.trainer_level_min',
            index=8,
            number=9,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.MoveSettings.trainer_level_max',
            index=9,
            number=10,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='vfx_name',
            full_name='pogoprotos.settings.master.MoveSettings.vfx_name',
            index=10,
            number=11,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='duration_ms',
            full_name='pogoprotos.settings.master.MoveSettings.duration_ms',
            index=11,
            number=12,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.MoveSettings.damage_window_start_ms',
            index=12,
            number=13,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.master.MoveSettings.damage_window_end_ms',
            index=13,
            number=14,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='energy_delta',
            full_name='pogoprotos.settings.master.MoveSettings.energy_delta',
            index=14,
            number=15,
            type=5,
            cpp_type=1,
...
_MOVESETTINGS.fields_by_name[
    'movement_id'].enum_type = pogoprotos_dot_enums_dot_pokemon__move__pb2._POKEMONMOVE
_MOVESETTINGS.fields_by_name[
    'pokemon_type'].enum_type = pogoprotos_dot_enums_dot_pokemon__type__pb2._POKEMONTYPE
DESCRIPTOR.message_types_by_name['MoveSettings'] = _MOVESETTINGS

MoveSettings = _reflection.GeneratedProtocolMessageType(
    'MoveSettings',
    (_message.Message, ),
    dict(
