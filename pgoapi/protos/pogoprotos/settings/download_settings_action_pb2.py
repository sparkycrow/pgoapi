...
_DOWNLOADSETTINGSACTION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='hash',
            full_name='pogoprotos.settings.DownloadSettingsAction.hash',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
DESCRIPTOR.message_types_by_name[
    'DownloadSettingsAction'] = _DOWNLOADSETTINGSACTION

DownloadSettingsAction = _reflection.GeneratedProtocolMessageType(
