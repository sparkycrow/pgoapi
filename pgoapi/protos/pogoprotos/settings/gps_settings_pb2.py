...
_GPSSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.GpsSettings.driving_warning_speed_meters_per_second',
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.GpsSettings.driving_warning_cooldown_minutes',
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.GpsSettings.driving_speed_sample_count',
            index=3,
            number=4,
            type=5,
            cpp_type=1,
...
GpsSettings = _reflection.GeneratedProtocolMessageType(
    'GpsSettings',
    (_message.Message, ),
    dict(
