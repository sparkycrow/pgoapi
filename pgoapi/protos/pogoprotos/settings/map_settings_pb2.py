...
_MAPSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.settings.MapSettings.pokemon_visible_range',
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.settings.MapSettings.poke_nav_range_meters',
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.settings.MapSettings.encounter_range_meters',
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.MapSettings.get_map_objects_min_refresh_seconds',
            index=3,
            number=4,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.MapSettings.get_map_objects_max_refresh_seconds',
            index=4,
            number=5,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.MapSettings.get_map_objects_min_distance_meters',
            index=5,
            number=6,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.settings.MapSettings.google_maps_api_key',
            index=6,
            number=7,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.MapSettings.min_nearby_hide_sightings',
            index=7,
            number=8,
            type=5,
            cpp_type=1,
...
MapSettings = _reflection.GeneratedProtocolMessageType(
    'MapSettings',
    (_message.Message, ),
    dict(
