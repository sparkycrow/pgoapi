...
_FORTSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.FortSettings.interaction_range_meters',
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.FortSettings.max_total_deployed_pokemon',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.FortSettings.max_player_deployed_pokemon',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.FortSettings.deploy_stamina_multiplier',
            index=3,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.FortSettings.deploy_attack_multiplier',
            index=4,
            number=5,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.FortSettings.far_interaction_range_meters',
            index=5,
            number=6,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='disable_gyms',
            full_name='pogoprotos.settings.FortSettings.disable_gyms',
            index=6,
            number=7,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.FortSettings.max_same_pokemon_at_fort',
            index=7,
            number=8,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.settings.FortSettings.max_player_total_deployed_pokemon',
            index=8,
            number=9,
            type=5,
            cpp_type=1,
...
FortSettings = _reflection.GeneratedProtocolMessageType(
    'FortSettings',
    (_message.Message, ),
    dict(
