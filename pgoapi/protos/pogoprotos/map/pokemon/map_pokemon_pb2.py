...
_MAPPOKEMON = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='spawn_point_id',
            full_name='pogoprotos.map.pokemon.MapPokemon.spawn_point_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='encounter_id',
            full_name='pogoprotos.map.pokemon.MapPokemon.encounter_id',
            index=1,
            number=2,
            type=6,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name='pogoprotos.map.pokemon.MapPokemon.pokemon_id',
            index=2,
            number=3,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.map.pokemon.MapPokemon.expiration_timestamp_ms',
            index=3,
            number=4,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='latitude',
            full_name='pogoprotos.map.pokemon.MapPokemon.latitude',
            index=4,
            number=5,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='longitude',
            full_name='pogoprotos.map.pokemon.MapPokemon.longitude',
            index=5,
            number=6,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.map.pokemon.MapPokemon.pokemon_display',
            index=6,
            number=7,
            type=11,
            cpp_type=10,
...
MapPokemon = _reflection.GeneratedProtocolMessageType(
    'MapPokemon',
    (_message.Message, ),
    dict(
