...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_data_dot_food__value__pb2.DESCRIPTOR,
...
_MOTIVATEDPOKEMON = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='pokemon',
            full_name='pogoprotos.map.pokemon.MotivatedPokemon.pokemon',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='deploy_ms',
            full_name='pogoprotos.map.pokemon.MotivatedPokemon.deploy_ms',
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.map.pokemon.MotivatedPokemon.cp_when_deployed',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='motivation_now',
            full_name='pogoprotos.map.pokemon.MotivatedPokemon.motivation_now',
            index=3,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='cp_now',
            full_name='pogoprotos.map.pokemon.MotivatedPokemon.cp_now',
            index=4,
            number=5,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='berry_value',
            full_name='pogoprotos.map.pokemon.MotivatedPokemon.berry_value',
            index=5,
            number=6,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.map.pokemon.MotivatedPokemon.feed_cooldown_duration_millis',
            index=6,
            number=7,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='food_value',
            full_name='pogoprotos.map.pokemon.MotivatedPokemon.food_value',
            index=7,
            number=8,
            type=11,
            cpp_type=10,
...
_MOTIVATEDPOKEMON.fields_by_name[
    'pokemon'].message_type = pogoprotos_dot_data_dot_pokemon__data__pb2._POKEMONDATA
_MOTIVATEDPOKEMON.fields_by_name[
    'food_value'].message_type = pogoprotos_dot_data_dot_food__value__pb2._FOODVALUE
DESCRIPTOR.message_types_by_name['MotivatedPokemon'] = _MOTIVATEDPOKEMON

MotivatedPokemon = _reflection.GeneratedProtocolMessageType(
    'MotivatedPokemon',
    (_message.Message, ),
    dict(
