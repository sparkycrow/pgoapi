...
_LOBBYPOKEMON = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='id',
            full_name='pogoprotos.map.pokemon.LobbyPokemon.id',
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='pokedex_id',
            full_name='pogoprotos.map.pokemon.LobbyPokemon.pokedex_id',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='cp',
            full_name='pogoprotos.map.pokemon.LobbyPokemon.cp',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='percent_health',
            full_name='pogoprotos.map.pokemon.LobbyPokemon.percent_health',
            index=3,
            number=4,
            type=2,
            cpp_type=6,
...
_LOBBYPOKEMON.fields_by_name[
    'pokedex_id'].enum_type = pogoprotos_dot_enums_dot_pokemon__id__pb2._POKEMONID
DESCRIPTOR.message_types_by_name['LobbyPokemon'] = _LOBBYPOKEMON

LobbyPokemon = _reflection.GeneratedProtocolMessageType(
    'LobbyPokemon',
    (_message.Message, ),
    dict(
