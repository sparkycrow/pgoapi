...
_NEARBYPOKEMON = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name='pogoprotos.map.pokemon.NearbyPokemon.pokemon_id',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.map.pokemon.NearbyPokemon.distance_in_meters',
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='encounter_id',
            full_name='pogoprotos.map.pokemon.NearbyPokemon.encounter_id',
            index=2,
            number=3,
            type=6,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='fort_id',
            full_name='pogoprotos.map.pokemon.NearbyPokemon.fort_id',
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.map.pokemon.NearbyPokemon.pokemon_display',
            index=5,
            number=6,
            type=11,
            cpp_type=10,
...
NearbyPokemon = _reflection.GeneratedProtocolMessageType(
    'NearbyPokemon',
    (_message.Message, ),
    dict(
