...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_map_dot_spawn__point__pb2.DESCRIPTOR,
        pogoprotos_dot_map_dot_fort_dot_fort__data__pb2.DESCRIPTOR,
        pogoprotos_dot_map_dot_fort_dot_fort__summary__pb2.DESCRIPTOR,
        pogoprotos_dot_map_dot_pokemon_dot_nearby__pokemon__pb2.DESCRIPTOR,
        pogoprotos_dot_map_dot_pokemon_dot_wild__pokemon__pb2.DESCRIPTOR,
        pogoprotos_dot_map_dot_pokemon_dot_map__pokemon__pb2.DESCRIPTOR,
    ])
...
_MAPCELL = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='s2_cell_id',
            full_name='pogoprotos.map.MapCell.s2_cell_id',
            index=0,
            number=1,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.map.MapCell.current_timestamp_ms',
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='forts',
            full_name='pogoprotos.map.MapCell.forts',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='spawn_points',
            full_name='pogoprotos.map.MapCell.spawn_points',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.map.MapCell.deleted_objects',
            index=4,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.map.MapCell.is_truncated_list',
            index=5,
            number=7,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='fort_summaries',
            full_name='pogoprotos.map.MapCell.fort_summaries',
            index=6,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.map.MapCell.decimated_spawn_points',
            index=7,
            number=9,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='wild_pokemons',
            full_name='pogoprotos.map.MapCell.wild_pokemons',
            index=8,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.map.MapCell.catchable_pokemons',
            index=9,
            number=10,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.map.MapCell.nearby_pokemons',
            index=10,
            number=11,
            type=11,
            cpp_type=10,
...
_MAPCELL.fields_by_name[
    'forts'].message_type = pogoprotos_dot_map_dot_fort_dot_fort__data__pb2._FORTDATA
_MAPCELL.fields_by_name[
    'spawn_points'].message_type = pogoprotos_dot_map_dot_spawn__point__pb2._SPAWNPOINT
_MAPCELL.fields_by_name[
    'fort_summaries'].message_type = pogoprotos_dot_map_dot_fort_dot_fort__summary__pb2._FORTSUMMARY
_MAPCELL.fields_by_name[
    'decimated_spawn_points'].message_type = pogoprotos_dot_map_dot_spawn__point__pb2._SPAWNPOINT
_MAPCELL.fields_by_name[
    'wild_pokemons'].message_type = pogoprotos_dot_map_dot_pokemon_dot_wild__pokemon__pb2._WILDPOKEMON
_MAPCELL.fields_by_name[
    'catchable_pokemons'].message_type = pogoprotos_dot_map_dot_pokemon_dot_map__pokemon__pb2._MAPPOKEMON
_MAPCELL.fields_by_name[
    'nearby_pokemons'].message_type = pogoprotos_dot_map_dot_pokemon_dot_nearby__pokemon__pb2._NEARBYPOKEMON
DESCRIPTOR.message_types_by_name['MapCell'] = _MAPCELL

MapCell = _reflection.GeneratedProtocolMessageType(
    'MapCell',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_MAPCELL,
