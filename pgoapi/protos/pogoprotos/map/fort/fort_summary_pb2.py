...
_FORTSUMMARY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.map.fort.FortSummary.fort_summary_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.map.fort.FortSummary.last_modified_timestamp_ms',
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='latitude',
            full_name='pogoprotos.map.fort.FortSummary.latitude',
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='longitude',
            full_name='pogoprotos.map.fort.FortSummary.longitude',
            index=3,
            number=4,
            type=1,
            cpp_type=5,
...
FortSummary = _reflection.GeneratedProtocolMessageType(
    'FortSummary',
    (_message.Message, ),
    dict(
