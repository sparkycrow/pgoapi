...
_FORTMODIFIER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='item_id',
            full_name='pogoprotos.map.fort.FortModifier.item_id',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.map.fort.FortModifier.expiration_timestamp_ms',
            index=1,
            number=2,
            type=3,
            cpp_type=2,
...
FortModifier = _reflection.GeneratedProtocolMessageType(
    'FortModifier',
    (_message.Message, ),
    dict(
