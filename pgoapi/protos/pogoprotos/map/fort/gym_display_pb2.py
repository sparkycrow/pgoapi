...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_map_dot_fort_dot_gym__event__pb2.DESCRIPTOR,
    ])
...
_GYMDISPLAY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='gym_event',
            full_name='pogoprotos.map.fort.GymDisplay.gym_event',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.map.fort.GymDisplay.lowest_pokemon_motivation',
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.map.fort.GymDisplay.slots_available',
            index=3,
            number=4,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.map.fort.GymDisplay.occupied_millis',
            index=4,
            number=5,
            type=3,
            cpp_type=2,
...
_GYMDISPLAY.fields_by_name[
    'gym_event'].message_type = pogoprotos_dot_map_dot_fort_dot_gym__event__pb2._GYMEVENT
DESCRIPTOR.message_types_by_name['GymDisplay'] = _GYMDISPLAY

GymDisplay = _reflection.GeneratedProtocolMessageType(
    'GymDisplay',
    (_message.Message, ),
    dict(
