...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_data_dot_pokemon__display__pb2.DESCRIPTOR,
        pogoprotos_dot_data_dot_raid_dot_raid__info__pb2.DESCRIPTOR,
        pogoprotos_dot_enums_dot_pokemon__id__pb2.DESCRIPTOR,
        pogoprotos_dot_enums_dot_team__color__pb2.DESCRIPTOR,
        pogoprotos_dot_inventory_dot_item_dot_item__id__pb2.DESCRIPTOR,
        pogoprotos_dot_map_dot_fort_dot_gym__display__pb2.DESCRIPTOR,
        pogoprotos_dot_map_dot_fort_dot_fort__type__pb2.DESCRIPTOR,
        pogoprotos_dot_map_dot_fort_dot_fort__sponsor__pb2.DESCRIPTOR,
        pogoprotos_dot_map_dot_fort_dot_fort__rendering__type__pb2.DESCRIPTOR,
        pogoprotos_dot_map_dot_fort_dot_fort__lure__info__pb2.DESCRIPTOR,
    ])
...
_FORTDATA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='id',
            full_name='pogoprotos.map.fort.FortData.id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.map.fort.FortData.last_modified_timestamp_ms',
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='latitude',
            full_name='pogoprotos.map.fort.FortData.latitude',
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='longitude',
            full_name='pogoprotos.map.fort.FortData.longitude',
            index=3,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='owned_by_team',
            full_name='pogoprotos.map.fort.FortData.owned_by_team',
            index=4,
            number=5,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.map.fort.FortData.guard_pokemon_id',
            index=5,
            number=6,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.map.fort.FortData.guard_pokemon_cp',
            index=6,
            number=7,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='enabled',
            full_name='pogoprotos.map.fort.FortData.enabled',
            index=7,
            number=8,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='type',
            full_name='pogoprotos.map.fort.FortData.type',
            index=8,
            number=9,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='gym_points',
            full_name='pogoprotos.map.fort.FortData.gym_points',
            index=9,
            number=10,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='is_in_battle',
            full_name='pogoprotos.map.fort.FortData.is_in_battle',
            index=10,
            number=11,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.map.fort.FortData.active_fort_modifier',
            index=11,
            number=12,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='lure_info',
            full_name='pogoprotos.map.fort.FortData.lure_info',
            index=12,
            number=13,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.map.fort.FortData.cooldown_complete_timestamp_ms',
            index=13,
            number=14,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='sponsor',
            full_name='pogoprotos.map.fort.FortData.sponsor',
            index=14,
            number=15,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='rendering_type',
            full_name='pogoprotos.map.fort.FortData.rendering_type',
            index=15,
            number=16,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.map.fort.FortData.deploy_lockout_end_ms',
            index=16,
            number=17,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.map.fort.FortData.guard_pokemon_display',
            index=17,
            number=18,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='closed',
            full_name='pogoprotos.map.fort.FortData.closed',
            index=18,
            number=19,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='raid_info',
            full_name='pogoprotos.map.fort.FortData.raid_info',
            index=19,
            number=20,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='gym_display',
            full_name='pogoprotos.map.fort.FortData.gym_display',
            index=20,
            number=21,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='visited',
            full_name='pogoprotos.map.fort.FortData.visited',
            index=21,
            number=22,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.map.fort.FortData.same_team_deploy_lockout_end_ms',
            index=22,
            number=23,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='allow_checkin',
            full_name='pogoprotos.map.fort.FortData.allow_checkin',
            index=23,
            number=24,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='image_url',
            full_name='pogoprotos.map.fort.FortData.image_url',
            index=24,
            number=25,
            type=9,
            cpp_type=9,
...
_FORTDATA.fields_by_name[
    'owned_by_team'].enum_type = pogoprotos_dot_enums_dot_team__color__pb2._TEAMCOLOR
_FORTDATA.fields_by_name[
    'guard_pokemon_id'].enum_type = pogoprotos_dot_enums_dot_pokemon__id__pb2._POKEMONID
_FORTDATA.fields_by_name[
    'type'].enum_type = pogoprotos_dot_map_dot_fort_dot_fort__type__pb2._FORTTYPE
_FORTDATA.fields_by_name[
    'active_fort_modifier'].enum_type = pogoprotos_dot_inventory_dot_item_dot_item__id__pb2._ITEMID
_FORTDATA.fields_by_name[
    'lure_info'].message_type = pogoprotos_dot_map_dot_fort_dot_fort__lure__info__pb2._FORTLUREINFO
_FORTDATA.fields_by_name[
    'sponsor'].enum_type = pogoprotos_dot_map_dot_fort_dot_fort__sponsor__pb2._FORTSPONSOR
_FORTDATA.fields_by_name[
    'rendering_type'].enum_type = pogoprotos_dot_map_dot_fort_dot_fort__rendering__type__pb2._FORTRENDERINGTYPE
_FORTDATA.fields_by_name[
    'guard_pokemon_display'].message_type = pogoprotos_dot_data_dot_pokemon__display__pb2._POKEMONDISPLAY
_FORTDATA.fields_by_name[
    'raid_info'].message_type = pogoprotos_dot_data_dot_raid_dot_raid__info__pb2._RAIDINFO
_FORTDATA.fields_by_name[
    'gym_display'].message_type = pogoprotos_dot_map_dot_fort_dot_gym__display__pb2._GYMDISPLAY
DESCRIPTOR.message_types_by_name['FortData'] = _FORTDATA

FortData = _reflection.GeneratedProtocolMessageType(
    'FortData',
    (_message.Message, ),
    dict(
