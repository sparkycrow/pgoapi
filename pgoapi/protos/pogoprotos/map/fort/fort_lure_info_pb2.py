...
_FORTLUREINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='fort_id',
            full_name='pogoprotos.map.fort.FortLureInfo.fort_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='encounter_id',
            full_name='pogoprotos.map.fort.FortLureInfo.encounter_id',
            index=1,
            number=2,
            type=6,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.map.fort.FortLureInfo.lure_expires_timestamp_ms',
            index=3,
            number=4,
            type=3,
            cpp_type=2,
...
_FORTLUREINFO.fields_by_name[
    'active_pokemon_id'].enum_type = pogoprotos_dot_enums_dot_pokemon__id__pb2._POKEMONID
DESCRIPTOR.message_types_by_name['FortLureInfo'] = _FORTLUREINFO

FortLureInfo = _reflection.GeneratedProtocolMessageType(
    'FortLureInfo',
    (_message.Message, ),
    dict(
