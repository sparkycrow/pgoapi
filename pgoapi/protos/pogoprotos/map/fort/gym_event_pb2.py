...
_GYMEVENT_EVENT = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name='POKEMON_FED', index=1, number=1, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='POKEMON_RETURNED',
            index=3,
            number=3,
            options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='BATTLE_WON', index=4, number=4, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='BATTLE_LOSS', index=5, number=5, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='RAID_STARTED', index=6, number=6, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='RAID_ENDED', index=7, number=7, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='GYM_NEUTRALIZED', index=8, number=8, options=None,
            type=None),
    ],
...
_GYMEVENT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='trainer',
            full_name='pogoprotos.map.fort.GymEvent.trainer',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='timestamp_ms',
            full_name='pogoprotos.map.fort.GymEvent.timestamp_ms',
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='pokedex_id',
            full_name='pogoprotos.map.fort.GymEvent.pokedex_id',
            index=3,
            number=4,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name='pogoprotos.map.fort.GymEvent.pokemon_id',
            index=4,
            number=5,
            type=6,
            cpp_type=4,
...
GymEvent = _reflection.GeneratedProtocolMessageType(
    'GymEvent',
    (_message.Message, ),
    dict(
