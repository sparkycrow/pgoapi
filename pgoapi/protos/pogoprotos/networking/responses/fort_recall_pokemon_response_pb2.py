...
_FORTRECALLPOKEMONRESPONSE_RESULT = _descriptor.EnumDescriptor(
    name='Result',
    full_name=
    'pogoprotos.networking.responses.FortRecallPokemonResponse.Result',
    filename=None,
    file=DESCRIPTOR,
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='ERROR_NO_PLAYER', index=4, number=4, options=None,
            type=None),
    ],
...
_FORTRECALLPOKEMONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='fort_details',
            full_name=
            'pogoprotos.networking.responses.FortRecallPokemonResponse.fort_details',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_FORTRECALLPOKEMONRESPONSE.fields_by_name[
    'result'].enum_type = _FORTRECALLPOKEMONRESPONSE_RESULT
_FORTRECALLPOKEMONRESPONSE.fields_by_name[
...
DESCRIPTOR.message_types_by_name[
    'FortRecallPokemonResponse'] = _FORTRECALLPOKEMONRESPONSE

FortRecallPokemonResponse = _reflection.GeneratedProtocolMessageType(
    'FortRecallPokemonResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_FORTRECALLPOKEMONRESPONSE,
        __module__=
        'pogoprotos.networking.responses.fort_recall_pokemon_response_pb2'
