...
_UPDATENOTIFICATIONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.UpdateNotificationResponse.notification_ids',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.UpdateNotificationResponse.create_timestamp_ms',
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='state',
            full_name=
            'pogoprotos.networking.responses.UpdateNotificationResponse.state',
            index=2,
            number=3,
            type=14,
            cpp_type=8,
...
_UPDATENOTIFICATIONRESPONSE.fields_by_name[
    'state'].enum_type = pogoprotos_dot_enums_dot_notification__state__pb2._NOTIFICATIONSTATE
DESCRIPTOR.message_types_by_name[
    'UpdateNotificationResponse'] = _UPDATENOTIFICATIONRESPONSE

UpdateNotificationResponse = _reflection.GeneratedProtocolMessageType(
    'UpdateNotificationResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_UPDATENOTIFICATIONRESPONSE,
        __module__=
        'pogoprotos.networking.responses.update_notification_response_pb2'
