...
_USEITEMPOTIONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='result',
            full_name=
            'pogoprotos.networking.responses.UseItemPotionResponse.result',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='stamina',
            full_name=
            'pogoprotos.networking.responses.UseItemPotionResponse.stamina',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_USEITEMPOTIONRESPONSE.fields_by_name[
    'result'].enum_type = _USEITEMPOTIONRESPONSE_RESULT
_USEITEMPOTIONRESPONSE_RESULT.containing_type = _USEITEMPOTIONRESPONSE
DESCRIPTOR.message_types_by_name[
    'UseItemPotionResponse'] = _USEITEMPOTIONRESPONSE

UseItemPotionResponse = _reflection.GeneratedProtocolMessageType(
    'UseItemPotionResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_USEITEMPOTIONRESPONSE,
        __module__=
        'pogoprotos.networking.responses.use_item_potion_response_pb2'
