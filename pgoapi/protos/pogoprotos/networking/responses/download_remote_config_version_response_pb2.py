...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/responses/download_remote_config_version_response.proto',
...
_DOWNLOADREMOTECONFIGVERSIONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.DownloadRemoteConfigVersionResponse.item_templates_timestamp_ms',
            index=1,
            number=2,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.DownloadRemoteConfigVersionResponse.asset_digest_timestamp_ms',
            index=2,
            number=3,
            type=4,
            cpp_type=4,
...
_DOWNLOADREMOTECONFIGVERSIONRESPONSE.fields_by_name[
    'result'].enum_type = _DOWNLOADREMOTECONFIGVERSIONRESPONSE_RESULT
_DOWNLOADREMOTECONFIGVERSIONRESPONSE_RESULT.containing_type = _DOWNLOADREMOTECONFIGVERSIONRESPONSE
DESCRIPTOR.message_types_by_name[
    'DownloadRemoteConfigVersionResponse'] = _DOWNLOADREMOTECONFIGVERSIONRESPONSE

DownloadRemoteConfigVersionResponse = _reflection.GeneratedProtocolMessageType(
    'DownloadRemoteConfigVersionResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_DOWNLOADREMOTECONFIGVERSIONRESPONSE,
        __module__=
        'pogoprotos.networking.responses.download_remote_config_version_response_pb2'
