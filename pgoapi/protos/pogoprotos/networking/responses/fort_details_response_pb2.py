...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        pogoprotos_dot_map_dot_fort_dot_fort__modifier__pb2.DESCRIPTOR,
    ])
...
_FORTDETAILSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='team_color',
            full_name=
            'pogoprotos.networking.responses.FortDetailsResponse.team_color',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='pokemon_data',
            full_name=
            'pogoprotos.networking.responses.FortDetailsResponse.pokemon_data',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='fp',
            full_name='pogoprotos.networking.responses.FortDetailsResponse.fp',
            index=5,
            number=6,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='stamina',
            full_name=
            'pogoprotos.networking.responses.FortDetailsResponse.stamina',
            index=6,
            number=7,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='max_stamina',
            full_name=
            'pogoprotos.networking.responses.FortDetailsResponse.max_stamina',
            index=7,
            number=8,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='type',
            full_name=
            'pogoprotos.networking.responses.FortDetailsResponse.type',
            index=8,
            number=9,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='latitude',
            full_name=
            'pogoprotos.networking.responses.FortDetailsResponse.latitude',
            index=9,
            number=10,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='longitude',
            full_name=
            'pogoprotos.networking.responses.FortDetailsResponse.longitude',
            index=10,
            number=11,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='modifiers',
            full_name=
            'pogoprotos.networking.responses.FortDetailsResponse.modifiers',
            index=12,
            number=13,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='close_soon',
            full_name=
            'pogoprotos.networking.responses.FortDetailsResponse.close_soon',
            index=13,
            number=14,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.FortDetailsResponse.checkin_image_url',
            index=14,
            number=15,
            type=9,
            cpp_type=9,
...
_FORTDETAILSRESPONSE.fields_by_name[
    'team_color'].enum_type = pogoprotos_dot_enums_dot_team__color__pb2._TEAMCOLOR
_FORTDETAILSRESPONSE.fields_by_name[
...
_FORTDETAILSRESPONSE.fields_by_name[
    'modifiers'].message_type = pogoprotos_dot_map_dot_fort_dot_fort__modifier__pb2._FORTMODIFIER
DESCRIPTOR.message_types_by_name['FortDetailsResponse'] = _FORTDETAILSRESPONSE

FortDetailsResponse = _reflection.GeneratedProtocolMessageType(
    'FortDetailsResponse',
    (_message.Message, ),
    dict(
