...
_EVOLVEPOKEMONRESPONSE_RESULT = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='FAILED_INVALID_ITEM_REQUIREMENT',
            index=6,
            number=6,
            options=None,
            type=None),
...
_EVOLVEPOKEMONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='result',
            full_name=
            'pogoprotos.networking.responses.EvolvePokemonResponse.result',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.EvolvePokemonResponse.evolved_pokemon_data',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.EvolvePokemonResponse.experience_awarded',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
...
_EVOLVEPOKEMONRESPONSE.fields_by_name[
    'result'].enum_type = _EVOLVEPOKEMONRESPONSE_RESULT
_EVOLVEPOKEMONRESPONSE.fields_by_name[
    'evolved_pokemon_data'].message_type = pogoprotos_dot_data_dot_pokemon__data__pb2._POKEMONDATA
_EVOLVEPOKEMONRESPONSE_RESULT.containing_type = _EVOLVEPOKEMONRESPONSE
DESCRIPTOR.message_types_by_name[
    'EvolvePokemonResponse'] = _EVOLVEPOKEMONRESPONSE

EvolvePokemonResponse = _reflection.GeneratedProtocolMessageType(
