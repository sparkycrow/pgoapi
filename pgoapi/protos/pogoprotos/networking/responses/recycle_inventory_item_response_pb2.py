...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/responses/recycle_inventory_item_response.proto',
...
_RECYCLEINVENTORYITEMRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='new_count',
            full_name=
            'pogoprotos.networking.responses.RecycleInventoryItemResponse.new_count',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_RECYCLEINVENTORYITEMRESPONSE.fields_by_name[
    'result'].enum_type = _RECYCLEINVENTORYITEMRESPONSE_RESULT
_RECYCLEINVENTORYITEMRESPONSE_RESULT.containing_type = _RECYCLEINVENTORYITEMRESPONSE
DESCRIPTOR.message_types_by_name[
    'RecycleInventoryItemResponse'] = _RECYCLEINVENTORYITEMRESPONSE

RecycleInventoryItemResponse = _reflection.GeneratedProtocolMessageType(
    'RecycleInventoryItemResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_RECYCLEINVENTORYITEMRESPONSE,
        __module__=
        'pogoprotos.networking.responses.recycle_inventory_item_response_pb2'
