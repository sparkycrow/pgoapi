...
_NICKNAMEPOKEMONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='result',
            full_name=
            'pogoprotos.networking.responses.NicknamePokemonResponse.result',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
...
_NICKNAMEPOKEMONRESPONSE.fields_by_name[
    'result'].enum_type = _NICKNAMEPOKEMONRESPONSE_RESULT
_NICKNAMEPOKEMONRESPONSE_RESULT.containing_type = _NICKNAMEPOKEMONRESPONSE
DESCRIPTOR.message_types_by_name[
    'NicknamePokemonResponse'] = _NICKNAMEPOKEMONRESPONSE

NicknamePokemonResponse = _reflection.GeneratedProtocolMessageType(
    'NicknamePokemonResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_NICKNAMEPOKEMONRESPONSE,
        __module__=
        'pogoprotos.networking.responses.nickname_pokemon_response_pb2'
