...
_LEVELUPREWARDSRESPONSE_RESULT = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name='AWARDED_ALREADY', index=2, number=2, options=None,
            type=None),
    ],
...
_LEVELUPREWARDSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='result',
            full_name=
            'pogoprotos.networking.responses.LevelUpRewardsResponse.result',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='items_awarded',
            full_name=
            'pogoprotos.networking.responses.LevelUpRewardsResponse.items_awarded',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='items_unlocked',
            full_name=
            'pogoprotos.networking.responses.LevelUpRewardsResponse.items_unlocked',
            index=2,
            number=4,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.LevelUpRewardsResponse.avatar_template_ids',
            index=3,
            number=5,
            type=9,
            cpp_type=9,
...
_LEVELUPREWARDSRESPONSE.fields_by_name[
    'result'].enum_type = _LEVELUPREWARDSRESPONSE_RESULT
_LEVELUPREWARDSRESPONSE.fields_by_name[
    'items_awarded'].message_type = pogoprotos_dot_inventory_dot_item_dot_item__award__pb2._ITEMAWARD
_LEVELUPREWARDSRESPONSE.fields_by_name[
    'items_unlocked'].enum_type = pogoprotos_dot_inventory_dot_item_dot_item__id__pb2._ITEMID
_LEVELUPREWARDSRESPONSE_RESULT.containing_type = _LEVELUPREWARDSRESPONSE
DESCRIPTOR.message_types_by_name[
    'LevelUpRewardsResponse'] = _LEVELUPREWARDSRESPONSE

LevelUpRewardsResponse = _reflection.GeneratedProtocolMessageType(
    'LevelUpRewardsResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_LEVELUPREWARDSRESPONSE,
        __module__=
        'pogoprotos.networking.responses.level_up_rewards_response_pb2'
