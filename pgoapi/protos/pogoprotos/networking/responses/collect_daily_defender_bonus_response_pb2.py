...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/responses/collect_daily_defender_bonus_response.proto',
...
_COLLECTDAILYDEFENDERBONUSRESPONSE_RESULT = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name='TOO_SOON', index=3, number=3, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='NO_DEFENDERS', index=4, number=4, options=None, type=None),
    ],
...
_COLLECTDAILYDEFENDERBONUSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.CollectDailyDefenderBonusResponse.currency_awarded',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.CollectDailyDefenderBonusResponse.defenders_count',
            index=3,
            number=4,
            type=5,
            cpp_type=1,
...
_COLLECTDAILYDEFENDERBONUSRESPONSE.fields_by_name[
    'result'].enum_type = _COLLECTDAILYDEFENDERBONUSRESPONSE_RESULT
_COLLECTDAILYDEFENDERBONUSRESPONSE_RESULT.containing_type = _COLLECTDAILYDEFENDERBONUSRESPONSE
DESCRIPTOR.message_types_by_name[
    'CollectDailyDefenderBonusResponse'] = _COLLECTDAILYDEFENDERBONUSRESPONSE

CollectDailyDefenderBonusResponse = _reflection.GeneratedProtocolMessageType(
    'CollectDailyDefenderBonusResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_COLLECTDAILYDEFENDERBONUSRESPONSE,
        __module__=
        'pogoprotos.networking.responses.collect_daily_defender_bonus_response_pb2'
