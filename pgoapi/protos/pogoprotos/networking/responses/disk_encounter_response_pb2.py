...
_DISKENCOUNTERRESPONSE_RESULT = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name='NOT_AVAILABLE', index=2, number=2, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='NOT_IN_RANGE', index=3, number=3, options=None, type=None),
        _descriptor.EnumValueDescriptor(
...
_DISKENCOUNTERRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='result',
            full_name=
            'pogoprotos.networking.responses.DiskEncounterResponse.result',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='pokemon_data',
            full_name=
            'pogoprotos.networking.responses.DiskEncounterResponse.pokemon_data',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.DiskEncounterResponse.capture_probability',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='active_item',
            full_name=
            'pogoprotos.networking.responses.DiskEncounterResponse.active_item',
            index=3,
            number=4,
            type=14,
            cpp_type=8,
...
_DISKENCOUNTERRESPONSE.fields_by_name[
    'result'].enum_type = _DISKENCOUNTERRESPONSE_RESULT
_DISKENCOUNTERRESPONSE.fields_by_name[
...
DESCRIPTOR.message_types_by_name[
    'DiskEncounterResponse'] = _DISKENCOUNTERRESPONSE

DiskEncounterResponse = _reflection.GeneratedProtocolMessageType(
