...
_USEITEMREVIVERESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='result',
            full_name=
            'pogoprotos.networking.responses.UseItemReviveResponse.result',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='stamina',
            full_name=
            'pogoprotos.networking.responses.UseItemReviveResponse.stamina',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_USEITEMREVIVERESPONSE.fields_by_name[
    'result'].enum_type = _USEITEMREVIVERESPONSE_RESULT
_USEITEMREVIVERESPONSE_RESULT.containing_type = _USEITEMREVIVERESPONSE
DESCRIPTOR.message_types_by_name[
    'UseItemReviveResponse'] = _USEITEMREVIVERESPONSE

UseItemReviveResponse = _reflection.GeneratedProtocolMessageType(
    'UseItemReviveResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_USEITEMREVIVERESPONSE,
        __module__=
        'pogoprotos.networking.responses.use_item_revive_response_pb2'
