...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        pogoprotos_dot_inventory_dot_item_dot_item__award__pb2.DESCRIPTOR,
        pogoprotos_dot_inventory_dot_loot__pb2.DESCRIPTOR,
...
_FORTSEARCHRESPONSE_RESULT = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name='NO_RESULT_SET', index=0, number=0, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='SUCCESS', index=1, number=1, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='OUT_OF_RANGE', index=2, number=2, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='INVENTORY_FULL', index=4, number=4, options=None, type=None),
        _descriptor.EnumValueDescriptor(
...
_FORTSEARCHRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='result',
            full_name=
            'pogoprotos.networking.responses.FortSearchResponse.result',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='items_awarded',
            full_name=
            'pogoprotos.networking.responses.FortSearchResponse.items_awarded',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='gems_awarded',
            full_name=
            'pogoprotos.networking.responses.FortSearchResponse.gems_awarded',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.FortSearchResponse.pokemon_data_egg',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.FortSearchResponse.experience_awarded',
            index=4,
            number=5,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.FortSearchResponse.cooldown_complete_timestamp_ms',
            index=5,
            number=6,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.FortSearchResponse.chain_hack_sequence_number',
            index=6,
            number=7,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.FortSearchResponse.awarded_gym_badge',
            index=7,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='loot',
            full_name='pogoprotos.networking.responses.FortSearchResponse.loot',
            index=8,
            number=9,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='bonus_loot',
            full_name=
            'pogoprotos.networking.responses.FortSearchResponse.bonus_loot',
            index=9,
            number=10,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='raid_tickets',
            full_name=
            'pogoprotos.networking.responses.FortSearchResponse.raid_tickets',
            index=10,
            number=11,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.FortSearchResponse.team_bonus_loot',
            index=11,
            number=12,
            type=11,
            cpp_type=10,
...
_FORTSEARCHRESPONSE.fields_by_name[
    'result'].enum_type = _FORTSEARCHRESPONSE_RESULT
_FORTSEARCHRESPONSE.fields_by_name[
    'items_awarded'].message_type = pogoprotos_dot_inventory_dot_item_dot_item__award__pb2._ITEMAWARD
_FORTSEARCHRESPONSE.fields_by_name[
    'pokemon_data_egg'].message_type = pogoprotos_dot_data_dot_pokemon__data__pb2._POKEMONDATA
_FORTSEARCHRESPONSE.fields_by_name[
    'awarded_gym_badge'].message_type = pogoprotos_dot_data_dot_badge_dot_awarded__gym__badge__pb2._AWARDEDGYMBADGE
_FORTSEARCHRESPONSE.fields_by_name[
    'loot'].message_type = pogoprotos_dot_inventory_dot_loot__pb2._LOOT
_FORTSEARCHRESPONSE.fields_by_name[
    'bonus_loot'].message_type = pogoprotos_dot_inventory_dot_loot__pb2._LOOT
_FORTSEARCHRESPONSE.fields_by_name[
    'team_bonus_loot'].message_type = pogoprotos_dot_inventory_dot_loot__pb2._LOOT
...
FortSearchResponse = _reflection.GeneratedProtocolMessageType(
    'FortSearchResponse',
    (_message.Message, ),
    dict(
