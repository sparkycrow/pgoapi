...
_SETPLAYERTEAMRESPONSE_STATUS = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='FAILURE', index=3, number=3, options=None, type=None),
    ],
...
_SETPLAYERTEAMRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='status',
            full_name=
            'pogoprotos.networking.responses.SetPlayerTeamResponse.status',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='player_data',
            full_name=
            'pogoprotos.networking.responses.SetPlayerTeamResponse.player_data',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_SETPLAYERTEAMRESPONSE.fields_by_name[
    'status'].enum_type = _SETPLAYERTEAMRESPONSE_STATUS
_SETPLAYERTEAMRESPONSE.fields_by_name[
...
DESCRIPTOR.message_types_by_name[
    'SetPlayerTeamResponse'] = _SETPLAYERTEAMRESPONSE

SetPlayerTeamResponse = _reflection.GeneratedProtocolMessageType(
    'SetPlayerTeamResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_SETPLAYERTEAMRESPONSE,
        __module__=
        'pogoprotos.networking.responses.set_player_team_response_pb2'
