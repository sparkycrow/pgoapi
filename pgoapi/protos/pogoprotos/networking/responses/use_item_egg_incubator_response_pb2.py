...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/responses/use_item_egg_incubator_response.proto',
    ...
    dependencies=[
        pogoprotos_dot_inventory_dot_egg__incubator__pb2.DESCRIPTOR,
    ])
...
_USEITEMEGGINCUBATORRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='egg_incubator',
            full_name=
            'pogoprotos.networking.responses.UseItemEggIncubatorResponse.egg_incubator',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_USEITEMEGGINCUBATORRESPONSE.fields_by_name[
    'result'].enum_type = _USEITEMEGGINCUBATORRESPONSE_RESULT
_USEITEMEGGINCUBATORRESPONSE.fields_by_name[
    'egg_incubator'].message_type = pogoprotos_dot_inventory_dot_egg__incubator__pb2._EGGINCUBATOR
_USEITEMEGGINCUBATORRESPONSE_RESULT.containing_type = _USEITEMEGGINCUBATORRESPONSE
DESCRIPTOR.message_types_by_name[
    'UseItemEggIncubatorResponse'] = _USEITEMEGGINCUBATORRESPONSE

UseItemEggIncubatorResponse = _reflection.GeneratedProtocolMessageType(
    'UseItemEggIncubatorResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_USEITEMEGGINCUBATORRESPONSE,
        __module__=
        'pogoprotos.networking.responses.use_item_egg_incubator_response_pb2'
