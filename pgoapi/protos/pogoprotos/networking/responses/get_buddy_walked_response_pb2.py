...
_GETBUDDYWALKEDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='success',
            full_name=
            'pogoprotos.networking.responses.GetBuddyWalkedResponse.success',
            index=0,
            number=1,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.GetBuddyWalkedResponse.family_candy_id',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.GetBuddyWalkedResponse.candy_earned_count',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
...
_GETBUDDYWALKEDRESPONSE.fields_by_name[
    'family_candy_id'].enum_type = pogoprotos_dot_enums_dot_pokemon__family__id__pb2._POKEMONFAMILYID
DESCRIPTOR.message_types_by_name[
    'GetBuddyWalkedResponse'] = _GETBUDDYWALKEDRESPONSE

GetBuddyWalkedResponse = _reflection.GeneratedProtocolMessageType(
    'GetBuddyWalkedResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_GETBUDDYWALKEDRESPONSE,
        __module__=
        'pogoprotos.networking.responses.get_buddy_walked_response_pb2'
