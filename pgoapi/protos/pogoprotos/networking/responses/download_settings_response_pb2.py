...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_settings_dot_global__settings__pb2.DESCRIPTOR,
    ])
...
_DOWNLOADSETTINGSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='settings',
            full_name=
            'pogoprotos.networking.responses.DownloadSettingsResponse.settings',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_DOWNLOADSETTINGSRESPONSE.fields_by_name[
    'settings'].message_type = pogoprotos_dot_settings_dot_global__settings__pb2._GLOBALSETTINGS
DESCRIPTOR.message_types_by_name[
    'DownloadSettingsResponse'] = _DOWNLOADSETTINGSRESPONSE

DownloadSettingsResponse = _reflection.GeneratedProtocolMessageType(
    'DownloadSettingsResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_DOWNLOADSETTINGSRESPONSE,
        __module__=
        'pogoprotos.networking.responses.download_settings_response_pb2'
