...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_data_dot_asset__digest__entry__pb2.DESCRIPTOR,
    ])
...
_GETASSETDIGESTRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='digest',
            full_name=
            'pogoprotos.networking.responses.GetAssetDigestResponse.digest',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='timestamp_ms',
            full_name=
            'pogoprotos.networking.responses.GetAssetDigestResponse.timestamp_ms',
            index=1,
            number=2,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='result',
            full_name=
            'pogoprotos.networking.responses.GetAssetDigestResponse.result',
            index=2,
            number=3,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='page_offset',
            full_name=
            'pogoprotos.networking.responses.GetAssetDigestResponse.page_offset',
            index=3,
            number=4,
            type=5,
            cpp_type=1,
...
_GETASSETDIGESTRESPONSE.fields_by_name[
    'digest'].message_type = pogoprotos_dot_data_dot_asset__digest__entry__pb2._ASSETDIGESTENTRY
_GETASSETDIGESTRESPONSE.fields_by_name[
    'result'].enum_type = _GETASSETDIGESTRESPONSE_RESULT
_GETASSETDIGESTRESPONSE_RESULT.containing_type = _GETASSETDIGESTRESPONSE
DESCRIPTOR.message_types_by_name[
    'GetAssetDigestResponse'] = _GETASSETDIGESTRESPONSE

GetAssetDigestResponse = _reflection.GeneratedProtocolMessageType(
    'GetAssetDigestResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_GETASSETDIGESTRESPONSE,
        __module__=
        'pogoprotos.networking.responses.get_asset_digest_response_pb2'
