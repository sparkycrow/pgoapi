...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_data_dot_capture_dot_capture__award__pb2.DESCRIPTOR,
    ])
...
_CATCHPOKEMONRESPONSE_CATCHSTATUS = _descriptor.EnumDescriptor(
    name='CatchStatus',
    full_name=
    'pogoprotos.networking.responses.CatchPokemonResponse.CatchStatus',
    filename=None,
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(
            name='CATCH_ERROR', index=0, number=0, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='CATCH_SUCCESS', index=1, number=1, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='CATCH_ESCAPE', index=2, number=2, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='CATCH_FLEE', index=3, number=3, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='CATCH_MISSED', index=4, number=4, options=None, type=None),
    ],
...
_CATCHPOKEMONRESPONSE_CAPTUREREASON = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name='ELEMENTAL_BADGE', index=2, number=2, options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='CRITICAL_CATCH', index=3, number=3, options=None, type=None),
    ],
    containing_type=None,
    options=None,
...
_CATCHPOKEMONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='status',
            full_name=
            'pogoprotos.networking.responses.CatchPokemonResponse.status',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='miss_percent',
            full_name=
            'pogoprotos.networking.responses.CatchPokemonResponse.miss_percent',
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.CatchPokemonResponse.captured_pokemon_id',
            index=2,
            number=3,
            type=6,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='capture_award',
            full_name=
            'pogoprotos.networking.responses.CatchPokemonResponse.capture_award',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='capture_reason',
            full_name=
            'pogoprotos.networking.responses.CatchPokemonResponse.capture_reason',
            index=4,
            number=5,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.CatchPokemonResponse.display_pokedex_id',
            index=5,
            number=6,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.CatchPokemonResponse.throws_remaining',
            index=6,
            number=7,
            type=5,
            cpp_type=1,
...
_CATCHPOKEMONRESPONSE.fields_by_name[
    'status'].enum_type = _CATCHPOKEMONRESPONSE_CATCHSTATUS
_CATCHPOKEMONRESPONSE.fields_by_name[
    'capture_award'].message_type = pogoprotos_dot_data_dot_capture_dot_capture__award__pb2._CAPTUREAWARD
_CATCHPOKEMONRESPONSE.fields_by_name[
    'capture_reason'].enum_type = _CATCHPOKEMONRESPONSE_CAPTUREREASON
...
DESCRIPTOR.message_types_by_name[
    'CatchPokemonResponse'] = _CATCHPOKEMONRESPONSE

CatchPokemonResponse = _reflection.GeneratedProtocolMessageType(
