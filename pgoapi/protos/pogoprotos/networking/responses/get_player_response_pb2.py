...
_GETPLAYERRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='success',
            full_name=
            'pogoprotos.networking.responses.GetPlayerResponse.success',
            index=0,
            number=1,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='player_data',
            full_name=
            'pogoprotos.networking.responses.GetPlayerResponse.player_data',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='banned',
            full_name=
            'pogoprotos.networking.responses.GetPlayerResponse.banned',
            index=2,
            number=3,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='warn',
            full_name='pogoprotos.networking.responses.GetPlayerResponse.warn',
            index=3,
            number=4,
            type=8,
            cpp_type=7,
...
_GETPLAYERRESPONSE.fields_by_name[
...
GetPlayerResponse = _reflection.GeneratedProtocolMessageType(
    'GetPlayerResponse',
    (_message.Message, ),
    dict(
