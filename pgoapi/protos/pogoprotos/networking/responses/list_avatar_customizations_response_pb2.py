...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/responses/list_avatar_customizations_response.proto',
    ...
    dependencies=[
        pogoprotos_dot_data_dot_avatar_dot_avatar__customization__pb2.
        DESCRIPTOR,
    ])
...
_LISTAVATARCUSTOMIZATIONSRESPONSE_RESULT = _descriptor.EnumDescriptor(
    name='Result',
    full_name=
    'pogoprotos.networking.responses.ListAvatarCustomizationsResponse.Result',
    filename=None,
    file=DESCRIPTOR,
    values=[
...
_LISTAVATARCUSTOMIZATIONSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.ListAvatarCustomizationsResponse.avatar_customizations',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_LISTAVATARCUSTOMIZATIONSRESPONSE.fields_by_name[
    'result'].enum_type = _LISTAVATARCUSTOMIZATIONSRESPONSE_RESULT
_LISTAVATARCUSTOMIZATIONSRESPONSE.fields_by_name[
    'avatar_customizations'].message_type = pogoprotos_dot_data_dot_avatar_dot_avatar__customization__pb2._AVATARCUSTOMIZATION
_LISTAVATARCUSTOMIZATIONSRESPONSE_RESULT.containing_type = _LISTAVATARCUSTOMIZATIONSRESPONSE
DESCRIPTOR.message_types_by_name[
    'ListAvatarCustomizationsResponse'] = _LISTAVATARCUSTOMIZATIONSRESPONSE

ListAvatarCustomizationsResponse = _reflection.GeneratedProtocolMessageType(
    'ListAvatarCustomizationsResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_LISTAVATARCUSTOMIZATIONSRESPONSE,
        __module__=
        'pogoprotos.networking.responses.list_avatar_customizations_response_pb2'
