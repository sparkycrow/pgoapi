...
_USEITEMXPBOOSTRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='result',
            full_name=
            'pogoprotos.networking.responses.UseItemXpBoostResponse.result',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='applied_items',
            full_name=
            'pogoprotos.networking.responses.UseItemXpBoostResponse.applied_items',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_USEITEMXPBOOSTRESPONSE.fields_by_name[
    'result'].enum_type = _USEITEMXPBOOSTRESPONSE_RESULT
_USEITEMXPBOOSTRESPONSE.fields_by_name[
...
DESCRIPTOR.message_types_by_name[
    'UseItemXpBoostResponse'] = _USEITEMXPBOOSTRESPONSE

UseItemXpBoostResponse = _reflection.GeneratedProtocolMessageType(
    'UseItemXpBoostResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_USEITEMXPBOOSTRESPONSE,
        __module__=
        'pogoprotos.networking.responses.use_item_xp_boost_response_pb2'
