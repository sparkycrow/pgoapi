...
_INCENSEENCOUNTERRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='result',
            full_name=
            'pogoprotos.networking.responses.IncenseEncounterResponse.result',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='pokemon_data',
            full_name=
            'pogoprotos.networking.responses.IncenseEncounterResponse.pokemon_data',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.IncenseEncounterResponse.capture_probability',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='active_item',
            full_name=
            'pogoprotos.networking.responses.IncenseEncounterResponse.active_item',
            index=3,
            number=4,
            type=14,
            cpp_type=8,
...
_INCENSEENCOUNTERRESPONSE.fields_by_name[
    'result'].enum_type = _INCENSEENCOUNTERRESPONSE_RESULT
_INCENSEENCOUNTERRESPONSE.fields_by_name[
...
DESCRIPTOR.message_types_by_name[
    'IncenseEncounterResponse'] = _INCENSEENCOUNTERRESPONSE

IncenseEncounterResponse = _reflection.GeneratedProtocolMessageType(
    'IncenseEncounterResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_INCENSEENCOUNTERRESPONSE,
        __module__=
        'pogoprotos.networking.responses.incense_encounter_response_pb2'
