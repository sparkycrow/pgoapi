...
_CLAIMCODENAMERESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='is_assignable',
            full_name=
            'pogoprotos.networking.responses.ClaimCodenameResponse.is_assignable',
            index=2,
            number=3,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='updated_player',
            full_name=
            'pogoprotos.networking.responses.ClaimCodenameResponse.updated_player',
            index=4,
            number=5,
            type=11,
            cpp_type=10,
...
_CLAIMCODENAMERESPONSE.fields_by_name[
    'status'].enum_type = _CLAIMCODENAMERESPONSE_STATUS
_CLAIMCODENAMERESPONSE.fields_by_name[
...
DESCRIPTOR.message_types_by_name[
    'ClaimCodenameResponse'] = _CLAIMCODENAMERESPONSE

ClaimCodenameResponse = _reflection.GeneratedProtocolMessageType(
