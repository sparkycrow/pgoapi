...
_UPGRADEPOKEMONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='result',
            full_name=
            'pogoprotos.networking.responses.UpgradePokemonResponse.result',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.UpgradePokemonResponse.upgraded_pokemon',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_UPGRADEPOKEMONRESPONSE.fields_by_name[
    'upgraded_pokemon'].message_type = pogoprotos_dot_data_dot_pokemon__data__pb2._POKEMONDATA
_UPGRADEPOKEMONRESPONSE_RESULT.containing_type = _UPGRADEPOKEMONRESPONSE
DESCRIPTOR.message_types_by_name[
    'UpgradePokemonResponse'] = _UPGRADEPOKEMONRESPONSE

UpgradePokemonResponse = _reflection.GeneratedProtocolMessageType(
    'UpgradePokemonResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_UPGRADEPOKEMONRESPONSE,
        __module__=
        'pogoprotos.networking.responses.upgrade_pokemon_response_pb2'
