...
_GYMGETINFORESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.GymGetInfoResponse.gym_status_and_defenders',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='name',
            full_name='pogoprotos.networking.responses.GymGetInfoResponse.name',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='url',
            full_name='pogoprotos.networking.responses.GymGetInfoResponse.url',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='result',
            full_name=
            'pogoprotos.networking.responses.GymGetInfoResponse.result',
            index=3,
            number=4,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='description',
            full_name=
            'pogoprotos.networking.responses.GymGetInfoResponse.description',
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='secondary_url',
            full_name=
            'pogoprotos.networking.responses.GymGetInfoResponse.secondary_url',
            index=5,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.GymGetInfoResponse.awarded_gym_badge',
            index=6,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.GymGetInfoResponse.checkin_image_url',
            index=7,
            number=8,
            type=9,
            cpp_type=9,
...
_GYMGETINFORESPONSE.fields_by_name[
    'gym_status_and_defenders'].message_type = pogoprotos_dot_data_dot_gym_dot_gym__status__and__defenders__pb2._GYMSTATUSANDDEFENDERS
_GYMGETINFORESPONSE.fields_by_name[
    'result'].enum_type = _GYMGETINFORESPONSE_RESULT
_GYMGETINFORESPONSE.fields_by_name[
...
GymGetInfoResponse = _reflection.GeneratedProtocolMessageType(
    'GymGetInfoResponse',
    (_message.Message, ),
    dict(
