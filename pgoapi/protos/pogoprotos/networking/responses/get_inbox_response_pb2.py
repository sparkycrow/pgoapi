...
_GETINBOXRESPONSE_CLIENTINBOX_NOTIFICATION_LABEL = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name='UNSET_LABEL', index=0, number=0, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='UNREAD', index=1, number=1, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='NEW', index=2, number=2, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='IMMEDIATE', index=3, number=3, options=None, type=None),
    ],
...
_GETINBOXRESPONSE_CLIENTINBOX_NOTIFICATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.GetInboxResponse.ClientInbox.Notification.notification_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='title_key',
            full_name=
            'pogoprotos.networking.responses.GetInboxResponse.ClientInbox.Notification.title_key',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='category',
            full_name=
            'pogoprotos.networking.responses.GetInboxResponse.ClientInbox.Notification.category',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.GetInboxResponse.ClientInbox.Notification.create_timestamp_ms',
            index=3,
            number=4,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='variables',
            full_name=
            'pogoprotos.networking.responses.GetInboxResponse.ClientInbox.Notification.variables',
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='labels',
            full_name=
            'pogoprotos.networking.responses.GetInboxResponse.ClientInbox.Notification.labels',
            index=5,
            number=6,
            type=14,
            cpp_type=8,
...
_GETINBOXRESPONSE_CLIENTINBOX_TEMPLATEVARIABLE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='name',
            full_name=
            'pogoprotos.networking.responses.GetInboxResponse.ClientInbox.TemplateVariable.name',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='literal',
            full_name=
            'pogoprotos.networking.responses.GetInboxResponse.ClientInbox.TemplateVariable.literal',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='key',
            full_name=
            'pogoprotos.networking.responses.GetInboxResponse.ClientInbox.TemplateVariable.key',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='lookup_table',
            full_name=
            'pogoprotos.networking.responses.GetInboxResponse.ClientInbox.TemplateVariable.lookup_table',
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='byte_value',
            full_name=
            'pogoprotos.networking.responses.GetInboxResponse.ClientInbox.TemplateVariable.byte_value',
            index=4,
            number=5,
            type=12,
            cpp_type=9,
...
_GETINBOXRESPONSE_CLIENTINBOX = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='notifications',
            full_name=
            'pogoprotos.networking.responses.GetInboxResponse.ClientInbox.notifications',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.GetInboxResponse.ClientInbox.builtin_variables',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
    ...
    nested_types=[
        ...
        _GETINBOXRESPONSE_CLIENTINBOX_TEMPLATEVARIABLE,
    ],
    enum_types=[],
    options=None,
    is_extendable=False,
...
_GETINBOXRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='inbox',
            full_name='pogoprotos.networking.responses.GetInboxResponse.inbox',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_GETINBOXRESPONSE_CLIENTINBOX_NOTIFICATION.fields_by_name[
    'variables'].message_type = _GETINBOXRESPONSE_CLIENTINBOX_TEMPLATEVARIABLE
_GETINBOXRESPONSE_CLIENTINBOX_NOTIFICATION.fields_by_name[
    'labels'].enum_type = _GETINBOXRESPONSE_CLIENTINBOX_NOTIFICATION_LABEL
...
_GETINBOXRESPONSE_CLIENTINBOX.fields_by_name[
    'notifications'].message_type = _GETINBOXRESPONSE_CLIENTINBOX_NOTIFICATION
_GETINBOXRESPONSE_CLIENTINBOX.fields_by_name[
    'builtin_variables'].message_type = _GETINBOXRESPONSE_CLIENTINBOX_TEMPLATEVARIABLE
...
_GETINBOXRESPONSE.fields_by_name[
    'inbox'].message_type = _GETINBOXRESPONSE_CLIENTINBOX
...
GetInboxResponse = _reflection.GeneratedProtocolMessageType(
    'GetInboxResponse',
    (_message.Message, ),
    dict(
        ClientInbox=_reflection.GeneratedProtocolMessageType(
            'ClientInbox',
            (_message.Message, ),
            dict(
                Notification=_reflection.GeneratedProtocolMessageType(
                    ...
                    dict(
                        ...
                        __module__=
                        'pogoprotos.networking.responses.get_inbox_response_pb2'
                        # @@protoc_insertion_point(class_scope:pogoprotos.networking.responses.GetInboxResponse.ClientInbox.Notification)
                    )),
                TemplateVariable=_reflection.GeneratedProtocolMessageType(
                    'TemplateVariable',
                    (_message.Message, ),
                    dict(
                        DESCRIPTOR=
