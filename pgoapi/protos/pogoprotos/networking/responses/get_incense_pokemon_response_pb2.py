...
_GETINCENSEPOKEMONRESPONSE_RESULT = _descriptor.EnumDescriptor(
    name='Result',
    full_name=
    'pogoprotos.networking.responses.GetIncensePokemonResponse.Result',
    filename=None,
    file=DESCRIPTOR,
    values=[
...
_GETINCENSEPOKEMONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name=
            'pogoprotos.networking.responses.GetIncensePokemonResponse.pokemon_id',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='latitude',
            full_name=
            'pogoprotos.networking.responses.GetIncensePokemonResponse.latitude',
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='longitude',
            full_name=
            'pogoprotos.networking.responses.GetIncensePokemonResponse.longitude',
            index=3,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='encounter_id',
            full_name=
            'pogoprotos.networking.responses.GetIncensePokemonResponse.encounter_id',
            index=5,
            number=6,
            type=6,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.GetIncensePokemonResponse.disappear_timestamp_ms',
            index=6,
            number=7,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.GetIncensePokemonResponse.pokemon_display',
            index=7,
            number=8,
            type=11,
            cpp_type=10,
...
_GETINCENSEPOKEMONRESPONSE.fields_by_name[
    'result'].enum_type = _GETINCENSEPOKEMONRESPONSE_RESULT
_GETINCENSEPOKEMONRESPONSE.fields_by_name[
...
DESCRIPTOR.message_types_by_name[
    'GetIncensePokemonResponse'] = _GETINCENSEPOKEMONRESPONSE

GetIncensePokemonResponse = _reflection.GeneratedProtocolMessageType(
    'GetIncensePokemonResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_GETINCENSEPOKEMONRESPONSE,
        __module__=
        'pogoprotos.networking.responses.get_incense_pokemon_response_pb2'
