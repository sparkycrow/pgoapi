...
_ADDFORTMODIFIERRESPONSE_RESULT = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='TOO_FAR_AWAY', index=3, number=3, options=None, type=None),
        _descriptor.EnumValueDescriptor(
...
_ADDFORTMODIFIERRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='result',
            full_name=
            'pogoprotos.networking.responses.AddFortModifierResponse.result',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='fort_details',
            full_name=
            'pogoprotos.networking.responses.AddFortModifierResponse.fort_details',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_ADDFORTMODIFIERRESPONSE.fields_by_name[
    'result'].enum_type = _ADDFORTMODIFIERRESPONSE_RESULT
_ADDFORTMODIFIERRESPONSE.fields_by_name[
...
DESCRIPTOR.message_types_by_name[
    'AddFortModifierResponse'] = _ADDFORTMODIFIERRESPONSE

AddFortModifierResponse = _reflection.GeneratedProtocolMessageType(
    'AddFortModifierResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_ADDFORTMODIFIERRESPONSE,
        __module__=
        'pogoprotos.networking.responses.add_fort_modifier_response_pb2'
