...
_GETGYMDETAILSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='gym_state',
            full_name=
            'pogoprotos.networking.responses.GetGymDetailsResponse.gym_state',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='result',
            full_name=
            'pogoprotos.networking.responses.GetGymDetailsResponse.result',
            index=3,
            number=4,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='secondary_url',
            full_name=
            'pogoprotos.networking.responses.GetGymDetailsResponse.secondary_url',
            index=5,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.GetGymDetailsResponse.checkin_image_url',
            index=6,
            number=7,
            type=9,
            cpp_type=9,
...
_GETGYMDETAILSRESPONSE.fields_by_name[
    'gym_state'].message_type = pogoprotos_dot_data_dot_gym_dot_gym__state__pb2._GYMSTATE
_GETGYMDETAILSRESPONSE.fields_by_name[
    'result'].enum_type = _GETGYMDETAILSRESPONSE_RESULT
_GETGYMDETAILSRESPONSE_RESULT.containing_type = _GETGYMDETAILSRESPONSE
DESCRIPTOR.message_types_by_name[
    'GetGymDetailsResponse'] = _GETGYMDETAILSRESPONSE

GetGymDetailsResponse = _reflection.GeneratedProtocolMessageType(
    'GetGymDetailsResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_GETGYMDETAILSRESPONSE,
        __module__=
        'pogoprotos.networking.responses.get_gym_details_response_pb2'
