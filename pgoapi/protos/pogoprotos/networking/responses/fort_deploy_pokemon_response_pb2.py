...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        pogoprotos_dot_data_dot_gym_dot_gym__state__pb2.DESCRIPTOR,
        pogoprotos_dot_networking_dot_responses_dot_fort__details__response__pb2.
        DESCRIPTOR,
    ])
...
_FORTDEPLOYPOKEMONRESPONSE_RESULT = _descriptor.EnumDescriptor(
    name='Result',
    full_name=
    'pogoprotos.networking.responses.FortDeployPokemonResponse.Result',
    filename=None,
    file=DESCRIPTOR,
    values=[
...
_FORTDEPLOYPOKEMONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='fort_details',
            full_name=
            'pogoprotos.networking.responses.FortDeployPokemonResponse.fort_details',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='pokemon_data',
            full_name=
            'pogoprotos.networking.responses.FortDeployPokemonResponse.pokemon_data',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='gym_state',
            full_name=
            'pogoprotos.networking.responses.FortDeployPokemonResponse.gym_state',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
...
_FORTDEPLOYPOKEMONRESPONSE.fields_by_name[
    'result'].enum_type = _FORTDEPLOYPOKEMONRESPONSE_RESULT
_FORTDEPLOYPOKEMONRESPONSE.fields_by_name[
    'fort_details'].message_type = pogoprotos_dot_networking_dot_responses_dot_fort__details__response__pb2._FORTDETAILSRESPONSE
_FORTDEPLOYPOKEMONRESPONSE.fields_by_name[
    'pokemon_data'].message_type = pogoprotos_dot_data_dot_pokemon__data__pb2._POKEMONDATA
_FORTDEPLOYPOKEMONRESPONSE.fields_by_name[
    'gym_state'].message_type = pogoprotos_dot_data_dot_gym_dot_gym__state__pb2._GYMSTATE
_FORTDEPLOYPOKEMONRESPONSE_RESULT.containing_type = _FORTDEPLOYPOKEMONRESPONSE
DESCRIPTOR.message_types_by_name[
    'FortDeployPokemonResponse'] = _FORTDEPLOYPOKEMONRESPONSE

FortDeployPokemonResponse = _reflection.GeneratedProtocolMessageType(
    'FortDeployPokemonResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_FORTDEPLOYPOKEMONRESPONSE,
        __module__=
        'pogoprotos.networking.responses.fort_deploy_pokemon_response_pb2'
