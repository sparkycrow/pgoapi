...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_data_dot_logs_dot_action__log__entry__pb2.DESCRIPTOR,
    ])
...
_SFIDAACTIONLOGRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='result',
            full_name=
            'pogoprotos.networking.responses.SfidaActionLogResponse.result',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='log_entries',
            full_name=
            'pogoprotos.networking.responses.SfidaActionLogResponse.log_entries',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_SFIDAACTIONLOGRESPONSE.fields_by_name[
    'result'].enum_type = _SFIDAACTIONLOGRESPONSE_RESULT
_SFIDAACTIONLOGRESPONSE.fields_by_name[
    'log_entries'].message_type = pogoprotos_dot_data_dot_logs_dot_action__log__entry__pb2._ACTIONLOGENTRY
_SFIDAACTIONLOGRESPONSE_RESULT.containing_type = _SFIDAACTIONLOGRESPONSE
DESCRIPTOR.message_types_by_name[
    'SfidaActionLogResponse'] = _SFIDAACTIONLOGRESPONSE

SfidaActionLogResponse = _reflection.GeneratedProtocolMessageType(
    'SfidaActionLogResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_SFIDAACTIONLOGRESPONSE,
        __module__=
        'pogoprotos.networking.responses.sfida_action_log_response_pb2'
