...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_inventory_dot_applied__item__pb2.DESCRIPTOR,
    ])
...
_USEINCENSERESPONSE_RESULT = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='LOCATION_UNSET', index=4, number=4, options=None, type=None),
    ],
...
_USEINCENSERESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='result',
            full_name=
            'pogoprotos.networking.responses.UseIncenseResponse.result',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.UseIncenseResponse.applied_incense',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_USEINCENSERESPONSE.fields_by_name[
    'result'].enum_type = _USEINCENSERESPONSE_RESULT
_USEINCENSERESPONSE.fields_by_name[
    'applied_incense'].message_type = pogoprotos_dot_inventory_dot_applied__item__pb2._APPLIEDITEM
...
UseIncenseResponse = _reflection.GeneratedProtocolMessageType(
    'UseIncenseResponse',
    (_message.Message, ),
    dict(
