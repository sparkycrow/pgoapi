...
_SETBUDDYPOKEMONRESPONSE_RESULT = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name='UNEST', index=0, number=0, options=None, type=None),
        _descriptor.EnumValueDescriptor(
...
_SETBUDDYPOKEMONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='result',
            full_name=
            'pogoprotos.networking.responses.SetBuddyPokemonResponse.result',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='updated_buddy',
            full_name=
            'pogoprotos.networking.responses.SetBuddyPokemonResponse.updated_buddy',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_SETBUDDYPOKEMONRESPONSE.fields_by_name[
    'result'].enum_type = _SETBUDDYPOKEMONRESPONSE_RESULT
_SETBUDDYPOKEMONRESPONSE.fields_by_name[
    'updated_buddy'].message_type = pogoprotos_dot_data_dot_buddy__pokemon__pb2._BUDDYPOKEMON
_SETBUDDYPOKEMONRESPONSE_RESULT.containing_type = _SETBUDDYPOKEMONRESPONSE
DESCRIPTOR.message_types_by_name[
    'SetBuddyPokemonResponse'] = _SETBUDDYPOKEMONRESPONSE

SetBuddyPokemonResponse = _reflection.GeneratedProtocolMessageType(
    'SetBuddyPokemonResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_SETBUDDYPOKEMONRESPONSE,
        __module__=
        'pogoprotos.networking.responses.set_buddy_pokemon_response_pb2'
