...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/responses/download_item_templates_response.proto',
    ...
    dependencies=[
        pogoprotos_dot_settings_dot_master_dot_avatar__customization__settings__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_badge__settings__pb2.DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_camera__settings__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_encounter__settings__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_equipped__badge__settings__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_form__settings__pb2.DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_gym__battle__settings__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_gym__level__settings__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_iap__item__display__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_iap__settings__pb2.DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_item__settings__pb2.DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_move__sequence__settings__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_move__settings__pb2.DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_player__level__settings__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_pokemon__settings__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_pokemon__upgrade__settings__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_quest__settings__pb2.DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_type__effective__settings__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_gender__settings__pb2.
        DESCRIPTOR,
        pogoprotos_dot_settings_dot_master_dot_gym__badge__gmt__settings__pb2.
        DESCRIPTOR,
    ])
...
_DOWNLOADITEMTEMPLATESRESPONSE_RESULT = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name='PAGE', index=2, number=2, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='RETRY', index=3, number=3, options=None, type=None),
    ],
...
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.pokemon_settings',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='item_settings',
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.item_settings',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='move_settings',
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.move_settings',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.move_sequence_settings',
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='type_effective',
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.type_effective',
            index=5,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='badge_settings',
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.badge_settings',
            index=6,
            number=10,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='camera',
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.camera',
            index=7,
            number=11,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='player_level',
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.player_level',
            index=8,
            number=12,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='gym_level',
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.gym_level',
            index=9,
            number=13,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.battle_settings',
            index=10,
            number=14,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.encounter_settings',
            index=11,
            number=15,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.iap_item_display',
            index=12,
            number=16,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='iap_settings',
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.iap_settings',
            index=13,
            number=17,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.pokemon_upgrades',
            index=14,
            number=18,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.equipped_badges',
            index=15,
            number=19,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='quest_settings',
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.quest_settings',
            index=16,
            number=20,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.avatar_customization',
            index=17,
            number=21,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='form_settings',
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.form_settings',
            index=18,
            number=22,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.gender_settings',
            index=19,
            number=23,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.ItemTemplate.gym_badge_settings',
            index=20,
            number=24,
            type=11,
            cpp_type=10,
...
_DOWNLOADITEMTEMPLATESRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='item_templates',
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.item_templates',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='timestamp_ms',
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.timestamp_ms',
            index=2,
            number=3,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='page_offset',
            full_name=
            'pogoprotos.networking.responses.DownloadItemTemplatesResponse.page_offset',
            index=3,
            number=4,
            type=5,
            cpp_type=1,
...
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name[
    'pokemon_settings'].message_type = pogoprotos_dot_settings_dot_master_dot_pokemon__settings__pb2._POKEMONSETTINGS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name[
    'item_settings'].message_type = pogoprotos_dot_settings_dot_master_dot_item__settings__pb2._ITEMSETTINGS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name[
    'move_settings'].message_type = pogoprotos_dot_settings_dot_master_dot_move__settings__pb2._MOVESETTINGS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name[
    'move_sequence_settings'].message_type = pogoprotos_dot_settings_dot_master_dot_move__sequence__settings__pb2._MOVESEQUENCESETTINGS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name[
    'type_effective'].message_type = pogoprotos_dot_settings_dot_master_dot_type__effective__settings__pb2._TYPEEFFECTIVESETTINGS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name[
    'badge_settings'].message_type = pogoprotos_dot_settings_dot_master_dot_badge__settings__pb2._BADGESETTINGS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name[
    'camera'].message_type = pogoprotos_dot_settings_dot_master_dot_camera__settings__pb2._CAMERASETTINGS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name[
    'player_level'].message_type = pogoprotos_dot_settings_dot_master_dot_player__level__settings__pb2._PLAYERLEVELSETTINGS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name[
    'gym_level'].message_type = pogoprotos_dot_settings_dot_master_dot_gym__level__settings__pb2._GYMLEVELSETTINGS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name[
    'battle_settings'].message_type = pogoprotos_dot_settings_dot_master_dot_gym__battle__settings__pb2._GYMBATTLESETTINGS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name[
    'encounter_settings'].message_type = pogoprotos_dot_settings_dot_master_dot_encounter__settings__pb2._ENCOUNTERSETTINGS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name[
    'iap_item_display'].message_type = pogoprotos_dot_settings_dot_master_dot_iap__item__display__pb2._IAPITEMDISPLAY
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name[
    'iap_settings'].message_type = pogoprotos_dot_settings_dot_master_dot_iap__settings__pb2._IAPSETTINGS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name[
    'pokemon_upgrades'].message_type = pogoprotos_dot_settings_dot_master_dot_pokemon__upgrade__settings__pb2._POKEMONUPGRADESETTINGS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name[
    'equipped_badges'].message_type = pogoprotos_dot_settings_dot_master_dot_equipped__badge__settings__pb2._EQUIPPEDBADGESETTINGS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name[
    'quest_settings'].message_type = pogoprotos_dot_settings_dot_master_dot_quest__settings__pb2._QUESTSETTINGS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name[
    'avatar_customization'].message_type = pogoprotos_dot_settings_dot_master_dot_avatar__customization__settings__pb2._AVATARCUSTOMIZATIONSETTINGS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name[
    'form_settings'].message_type = pogoprotos_dot_settings_dot_master_dot_form__settings__pb2._FORMSETTINGS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name[
    'gender_settings'].message_type = pogoprotos_dot_settings_dot_master_dot_gender__settings__pb2._GENDERSETTINGS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.fields_by_name[
    'gym_badge_settings'].message_type = pogoprotos_dot_settings_dot_master_dot_gym__badge__gmt__settings__pb2._GYMBADGEGMTSETTINGS
_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE.containing_type = _DOWNLOADITEMTEMPLATESRESPONSE
_DOWNLOADITEMTEMPLATESRESPONSE.fields_by_name[
    'result'].enum_type = _DOWNLOADITEMTEMPLATESRESPONSE_RESULT
_DOWNLOADITEMTEMPLATESRESPONSE.fields_by_name[
    'item_templates'].message_type = _DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE
_DOWNLOADITEMTEMPLATESRESPONSE_RESULT.containing_type = _DOWNLOADITEMTEMPLATESRESPONSE
DESCRIPTOR.message_types_by_name[
    'DownloadItemTemplatesResponse'] = _DOWNLOADITEMTEMPLATESRESPONSE

DownloadItemTemplatesResponse = _reflection.GeneratedProtocolMessageType(
    'DownloadItemTemplatesResponse',
    (_message.Message, ),
    dict(
        ItemTemplate=_reflection.GeneratedProtocolMessageType(
            'ItemTemplate',
            (_message.Message, ),
            dict(
                DESCRIPTOR=_DOWNLOADITEMTEMPLATESRESPONSE_ITEMTEMPLATE,
                __module__=
                'pogoprotos.networking.responses.download_item_templates_response_pb2'
