...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/responses/register_background_device_response.proto',
    ...
    dependencies=[
        pogoprotos_dot_data_dot_background__token__pb2.DESCRIPTOR,
    ])
...
_REGISTERBACKGROUNDDEVICERESPONSE_STATUS = _descriptor.EnumDescriptor(
    name='Status',
    full_name=
    'pogoprotos.networking.responses.RegisterBackgroundDeviceResponse.Status',
    filename=None,
    file=DESCRIPTOR,
    values=[
...
_REGISTERBACKGROUNDDEVICERESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='token',
            full_name=
            'pogoprotos.networking.responses.RegisterBackgroundDeviceResponse.token',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_REGISTERBACKGROUNDDEVICERESPONSE.fields_by_name[
    'status'].enum_type = _REGISTERBACKGROUNDDEVICERESPONSE_STATUS
_REGISTERBACKGROUNDDEVICERESPONSE.fields_by_name[
    'token'].message_type = pogoprotos_dot_data_dot_background__token__pb2._BACKGROUNDTOKEN
_REGISTERBACKGROUNDDEVICERESPONSE_STATUS.containing_type = _REGISTERBACKGROUNDDEVICERESPONSE
DESCRIPTOR.message_types_by_name[
    'RegisterBackgroundDeviceResponse'] = _REGISTERBACKGROUNDDEVICERESPONSE

RegisterBackgroundDeviceResponse = _reflection.GeneratedProtocolMessageType(
    'RegisterBackgroundDeviceResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_REGISTERBACKGROUNDDEVICERESPONSE,
        __module__=
        'pogoprotos.networking.responses.register_background_device_response_pb2'
