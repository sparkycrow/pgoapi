...
_GETGYMBADGEDETAILSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='gym_badge',
            full_name=
            'pogoprotos.networking.responses.GetGymBadgeDetailsResponse.gym_badge',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='gym_defender',
            full_name=
            'pogoprotos.networking.responses.GetGymBadgeDetailsResponse.gym_defender',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='success',
            full_name=
            'pogoprotos.networking.responses.GetGymBadgeDetailsResponse.success',
            index=2,
            number=3,
            type=8,
            cpp_type=7,
...
_GETGYMBADGEDETAILSRESPONSE.fields_by_name[
...
DESCRIPTOR.message_types_by_name[
    'GetGymBadgeDetailsResponse'] = _GETGYMBADGEDETAILSRESPONSE

GetGymBadgeDetailsResponse = _reflection.GeneratedProtocolMessageType(
    'GetGymBadgeDetailsResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_GETGYMBADGEDETAILSRESPONSE,
        __module__=
        'pogoprotos.networking.responses.get_gym_badge_details_response_pb2'
