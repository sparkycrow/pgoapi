...
_GETHATCHEDEGGSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='success',
            full_name=
            'pogoprotos.networking.responses.GetHatchedEggsResponse.success',
            index=0,
            number=1,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name=
            'pogoprotos.networking.responses.GetHatchedEggsResponse.pokemon_id',
            index=1,
            number=2,
            type=6,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.GetHatchedEggsResponse.experience_awarded',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='candy_awarded',
            full_name=
            'pogoprotos.networking.responses.GetHatchedEggsResponse.candy_awarded',
            index=3,
            number=4,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.GetHatchedEggsResponse.stardust_awarded',
            index=4,
            number=5,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='egg_km_walked',
            full_name=
            'pogoprotos.networking.responses.GetHatchedEggsResponse.egg_km_walked',
            index=5,
            number=6,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.GetHatchedEggsResponse.hatched_pokemon',
            index=6,
            number=7,
            type=11,
            cpp_type=10,
...
_GETHATCHEDEGGSRESPONSE.fields_by_name[
    'hatched_pokemon'].message_type = pogoprotos_dot_data_dot_pokemon__data__pb2._POKEMONDATA
DESCRIPTOR.message_types_by_name[
    'GetHatchedEggsResponse'] = _GETHATCHEDEGGSRESPONSE

GetHatchedEggsResponse = _reflection.GeneratedProtocolMessageType(
    'GetHatchedEggsResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_GETHATCHEDEGGSRESPONSE,
        __module__=
        'pogoprotos.networking.responses.get_hatched_eggs_response_pb2'
...
_GETHATCHEDEGGSRESPONSE.fields_by_name[
    'pokemon_id']._options = _descriptor._ParseOptions(
