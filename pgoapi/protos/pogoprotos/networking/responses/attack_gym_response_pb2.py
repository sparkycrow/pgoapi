...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        DESCRIPTOR,
        pogoprotos_dot_data_dot_battle_dot_battle__update__pb2.DESCRIPTOR,
    ])
...
_ATTACKGYMRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='result',
            full_name=
            'pogoprotos.networking.responses.AttackGymResponse.result',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='battle_log',
            full_name=
            'pogoprotos.networking.responses.AttackGymResponse.battle_log',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.AttackGymResponse.active_defender',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.AttackGymResponse.active_attacker',
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='battle_update',
            full_name=
            'pogoprotos.networking.responses.AttackGymResponse.battle_update',
            index=5,
            number=6,
            type=11,
            cpp_type=10,
...
_ATTACKGYMRESPONSE.fields_by_name[
    'result'].enum_type = _ATTACKGYMRESPONSE_RESULT
_ATTACKGYMRESPONSE.fields_by_name[
    'battle_log'].message_type = pogoprotos_dot_data_dot_battle_dot_battle__log__pb2._BATTLELOG
_ATTACKGYMRESPONSE.fields_by_name[
    'active_defender'].message_type = pogoprotos_dot_data_dot_battle_dot_battle__pokemon__info__pb2._BATTLEPOKEMONINFO
_ATTACKGYMRESPONSE.fields_by_name[
    'active_attacker'].message_type = pogoprotos_dot_data_dot_battle_dot_battle__pokemon__info__pb2._BATTLEPOKEMONINFO
_ATTACKGYMRESPONSE.fields_by_name[
    'battle_update'].message_type = pogoprotos_dot_data_dot_battle_dot_battle__update__pb2._BATTLEUPDATE
...
AttackGymResponse = _reflection.GeneratedProtocolMessageType(
    'AttackGymResponse',
    (_message.Message, ),
    dict(
