...
_SETAVATARRESPONSE_STATUS = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name='SLOT_NOT_ALLOWED',
            index=4,
            number=4,
            options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='ITEM_NOT_OWNED', index=5, number=5, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='INVALID_AVATAR_TYPE',
            index=6,
            number=6,
            options=None,
            type=None),
...
_SETAVATARRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='status',
            full_name=
            'pogoprotos.networking.responses.SetAvatarResponse.status',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='player_data',
            full_name=
            'pogoprotos.networking.responses.SetAvatarResponse.player_data',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_SETAVATARRESPONSE.fields_by_name[
    'status'].enum_type = _SETAVATARRESPONSE_STATUS
_SETAVATARRESPONSE.fields_by_name[
...
SetAvatarResponse = _reflection.GeneratedProtocolMessageType(
    'SetAvatarResponse',
    (_message.Message, ),
    dict(
