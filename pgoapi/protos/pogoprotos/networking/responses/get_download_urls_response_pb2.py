...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_data_dot_download__url__entry__pb2.DESCRIPTOR,
    ])
...
_GETDOWNLOADURLSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='download_urls',
            full_name=
            'pogoprotos.networking.responses.GetDownloadUrlsResponse.download_urls',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_GETDOWNLOADURLSRESPONSE.fields_by_name[
    'download_urls'].message_type = pogoprotos_dot_data_dot_download__url__entry__pb2._DOWNLOADURLENTRY
DESCRIPTOR.message_types_by_name[
    'GetDownloadUrlsResponse'] = _GETDOWNLOADURLSRESPONSE

GetDownloadUrlsResponse = _reflection.GeneratedProtocolMessageType(
    'GetDownloadUrlsResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_GETDOWNLOADURLSRESPONSE,
        __module__=
        'pogoprotos.networking.responses.get_download_urls_response_pb2'
