...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        pogoprotos_dot_map_dot_map__objects__status__pb2.DESCRIPTOR,
    ])
...
_GETMAPOBJECTSRESPONSE_TIMEOFDAY = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name='DAY', index=1, number=1, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='NIGHT', index=2, number=2, options=None, type=None),
    ],
...
_GETMAPOBJECTSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='map_cells',
            full_name=
            'pogoprotos.networking.responses.GetMapObjectsResponse.map_cells',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='status',
            full_name=
            'pogoprotos.networking.responses.GetMapObjectsResponse.status',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='time_of_day',
            full_name=
            'pogoprotos.networking.responses.GetMapObjectsResponse.time_of_day',
            index=2,
            number=3,
            type=14,
            cpp_type=8,
...
_GETMAPOBJECTSRESPONSE.fields_by_name[
    'map_cells'].message_type = pogoprotos_dot_map_dot_map__cell__pb2._MAPCELL
_GETMAPOBJECTSRESPONSE.fields_by_name[
    'status'].enum_type = pogoprotos_dot_map_dot_map__objects__status__pb2._MAPOBJECTSSTATUS
_GETMAPOBJECTSRESPONSE.fields_by_name[
    'time_of_day'].enum_type = _GETMAPOBJECTSRESPONSE_TIMEOFDAY
_GETMAPOBJECTSRESPONSE_TIMEOFDAY.containing_type = _GETMAPOBJECTSRESPONSE
DESCRIPTOR.message_types_by_name[
    'GetMapObjectsResponse'] = _GETMAPOBJECTSRESPONSE

GetMapObjectsResponse = _reflection.GeneratedProtocolMessageType(
    'GetMapObjectsResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_GETMAPOBJECTSRESPONSE,
        __module__=
        'pogoprotos.networking.responses.get_map_objects_response_pb2'
