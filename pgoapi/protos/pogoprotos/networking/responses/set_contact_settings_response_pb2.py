...
_SETCONTACTSETTINGSRESPONSE_STATUS = _descriptor.EnumDescriptor(
    name='Status',
    full_name=
    'pogoprotos.networking.responses.SetContactSettingsResponse.Status',
    filename=None,
    file=DESCRIPTOR,
    values=[
...
_SETCONTACTSETTINGSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='player_data',
            full_name=
            'pogoprotos.networking.responses.SetContactSettingsResponse.player_data',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_SETCONTACTSETTINGSRESPONSE.fields_by_name[
    'status'].enum_type = _SETCONTACTSETTINGSRESPONSE_STATUS
_SETCONTACTSETTINGSRESPONSE.fields_by_name[
...
DESCRIPTOR.message_types_by_name[
    'SetContactSettingsResponse'] = _SETCONTACTSETTINGSRESPONSE

SetContactSettingsResponse = _reflection.GeneratedProtocolMessageType(
    'SetContactSettingsResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_SETCONTACTSETTINGSRESPONSE,
        __module__=
        'pogoprotos.networking.responses.set_contact_settings_response_pb2'
