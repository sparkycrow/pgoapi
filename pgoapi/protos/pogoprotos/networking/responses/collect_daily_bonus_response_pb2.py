...
_COLLECTDAILYBONUSRESPONSE_RESULT = _descriptor.EnumDescriptor(
    name='Result',
    full_name=
    'pogoprotos.networking.responses.CollectDailyBonusResponse.Result',
    filename=None,
    file=DESCRIPTOR,
    values=[
...
_COLLECTDAILYBONUSRESPONSE.fields_by_name[
    'result'].enum_type = _COLLECTDAILYBONUSRESPONSE_RESULT
_COLLECTDAILYBONUSRESPONSE_RESULT.containing_type = _COLLECTDAILYBONUSRESPONSE
DESCRIPTOR.message_types_by_name[
    'CollectDailyBonusResponse'] = _COLLECTDAILYBONUSRESPONSE

CollectDailyBonusResponse = _reflection.GeneratedProtocolMessageType(
    'CollectDailyBonusResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_COLLECTDAILYBONUSRESPONSE,
        __module__=
        'pogoprotos.networking.responses.collect_daily_bonus_response_pb2'
