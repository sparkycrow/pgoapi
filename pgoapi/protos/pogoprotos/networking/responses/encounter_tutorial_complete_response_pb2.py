...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/responses/encounter_tutorial_complete_response.proto',
...
_ENCOUNTERTUTORIALCOMPLETERESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='pokemon_data',
            full_name=
            'pogoprotos.networking.responses.EncounterTutorialCompleteResponse.pokemon_data',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='capture_award',
            full_name=
            'pogoprotos.networking.responses.EncounterTutorialCompleteResponse.capture_award',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_ENCOUNTERTUTORIALCOMPLETERESPONSE.fields_by_name[
    'result'].enum_type = _ENCOUNTERTUTORIALCOMPLETERESPONSE_RESULT
_ENCOUNTERTUTORIALCOMPLETERESPONSE.fields_by_name[
...
DESCRIPTOR.message_types_by_name[
    'EncounterTutorialCompleteResponse'] = _ENCOUNTERTUTORIALCOMPLETERESPONSE

EncounterTutorialCompleteResponse = _reflection.GeneratedProtocolMessageType(
    'EncounterTutorialCompleteResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_ENCOUNTERTUTORIALCOMPLETERESPONSE,
        __module__=
        'pogoprotos.networking.responses.encounter_tutorial_complete_response_pb2'
