...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_inventory_dot_inventory__delta__pb2.DESCRIPTOR,
    ])
...
_GETINVENTORYRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='success',
            full_name=
            'pogoprotos.networking.responses.GetInventoryResponse.success',
            index=0,
            number=1,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.GetInventoryResponse.inventory_delta',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_GETINVENTORYRESPONSE.fields_by_name[
    'inventory_delta'].message_type = pogoprotos_dot_inventory_dot_inventory__delta__pb2._INVENTORYDELTA
DESCRIPTOR.message_types_by_name[
    'GetInventoryResponse'] = _GETINVENTORYRESPONSE

GetInventoryResponse = _reflection.GeneratedProtocolMessageType(
