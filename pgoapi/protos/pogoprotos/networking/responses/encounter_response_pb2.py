...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_data_dot_capture_dot_capture__probability__pb2.
        DESCRIPTOR,
...
_ENCOUNTERRESPONSE_BACKGROUND = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name='PARK', index=0, number=0, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='DESERT', index=1, number=1, options=None, type=None),
    ],
...
_ENCOUNTERRESPONSE_STATUS = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name='ENCOUNTER_ERROR', index=0, number=0, options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
...
_ENCOUNTERRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='wild_pokemon',
            full_name=
            'pogoprotos.networking.responses.EncounterResponse.wild_pokemon',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='background',
            full_name=
            'pogoprotos.networking.responses.EncounterResponse.background',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='status',
            full_name=
            'pogoprotos.networking.responses.EncounterResponse.status',
            index=2,
            number=3,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.EncounterResponse.capture_probability',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='active_item',
            full_name=
            'pogoprotos.networking.responses.EncounterResponse.active_item',
            index=4,
            number=5,
            type=14,
            cpp_type=8,
...
_ENCOUNTERRESPONSE.fields_by_name[
    'wild_pokemon'].message_type = pogoprotos_dot_map_dot_pokemon_dot_wild__pokemon__pb2._WILDPOKEMON
_ENCOUNTERRESPONSE.fields_by_name[
    'background'].enum_type = _ENCOUNTERRESPONSE_BACKGROUND
_ENCOUNTERRESPONSE.fields_by_name[
    'status'].enum_type = _ENCOUNTERRESPONSE_STATUS
_ENCOUNTERRESPONSE.fields_by_name[
    'capture_probability'].message_type = pogoprotos_dot_data_dot_capture_dot_capture__probability__pb2._CAPTUREPROBABILITY
_ENCOUNTERRESPONSE.fields_by_name[
    'active_item'].enum_type = pogoprotos_dot_inventory_dot_item_dot_item__id__pb2._ITEMID
...
EncounterResponse = _reflection.GeneratedProtocolMessageType(
    'EncounterResponse',
    (_message.Message, ),
    dict(
