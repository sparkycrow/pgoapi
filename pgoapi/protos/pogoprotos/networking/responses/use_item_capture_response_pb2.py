...
_USEITEMCAPTURERESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='success',
            full_name=
            'pogoprotos.networking.responses.UseItemCaptureResponse.success',
            index=0,
            number=1,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.responses.UseItemCaptureResponse.item_capture_mult',
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='item_flee_mult',
            full_name=
            'pogoprotos.networking.responses.UseItemCaptureResponse.item_flee_mult',
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='stop_movement',
            full_name=
            'pogoprotos.networking.responses.UseItemCaptureResponse.stop_movement',
            index=3,
            number=4,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='stop_attack',
            full_name=
            'pogoprotos.networking.responses.UseItemCaptureResponse.stop_attack',
            index=4,
            number=5,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='target_max',
            full_name=
            'pogoprotos.networking.responses.UseItemCaptureResponse.target_max',
            index=5,
            number=6,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='target_slow',
            full_name=
            'pogoprotos.networking.responses.UseItemCaptureResponse.target_slow',
            index=6,
            number=7,
            type=8,
            cpp_type=7,
...
DESCRIPTOR.message_types_by_name[
    'UseItemCaptureResponse'] = _USEITEMCAPTURERESPONSE

UseItemCaptureResponse = _reflection.GeneratedProtocolMessageType(
    'UseItemCaptureResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_USEITEMCAPTURERESPONSE,
        __module__=
        'pogoprotos.networking.responses.use_item_capture_response_pb2'
