...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/responses/mark_tutorial_complete_response.proto',
    ...
    dependencies=[
        pogoprotos_dot_data_dot_player__data__pb2.DESCRIPTOR,
    ])
...
_MARKTUTORIALCOMPLETERESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='success',
            full_name=
            'pogoprotos.networking.responses.MarkTutorialCompleteResponse.success',
            index=0,
            number=1,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='player_data',
            full_name=
            'pogoprotos.networking.responses.MarkTutorialCompleteResponse.player_data',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_MARKTUTORIALCOMPLETERESPONSE.fields_by_name[
    'player_data'].message_type = pogoprotos_dot_data_dot_player__data__pb2._PLAYERDATA
DESCRIPTOR.message_types_by_name[
    'MarkTutorialCompleteResponse'] = _MARKTUTORIALCOMPLETERESPONSE

MarkTutorialCompleteResponse = _reflection.GeneratedProtocolMessageType(
    'MarkTutorialCompleteResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_MARKTUTORIALCOMPLETERESPONSE,
        __module__=
        'pogoprotos.networking.responses.mark_tutorial_complete_response_pb2'
