...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/platform/responses/buy_item_poke_coins_response.proto',
...
_BUYITEMPOKECOINSRESPONSE = _descriptor.Descriptor(
    ...
    full_name=
    'pogoprotos.networking.platform.responses.BuyItemPokeCoinsResponse',
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name='result',
            full_name=
            'pogoprotos.networking.platform.responses.BuyItemPokeCoinsResponse.result',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
...
_BUYITEMPOKECOINSRESPONSE.fields_by_name[
    'result'].enum_type = _BUYITEMPOKECOINSRESPONSE_STATUS
_BUYITEMPOKECOINSRESPONSE_STATUS.containing_type = _BUYITEMPOKECOINSRESPONSE
DESCRIPTOR.message_types_by_name[
    'BuyItemPokeCoinsResponse'] = _BUYITEMPOKECOINSRESPONSE

BuyItemPokeCoinsResponse = _reflection.GeneratedProtocolMessageType(
    'BuyItemPokeCoinsResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_BUYITEMPOKECOINSRESPONSE,
        __module__=
        'pogoprotos.networking.platform.responses.buy_item_poke_coins_response_pb2'
