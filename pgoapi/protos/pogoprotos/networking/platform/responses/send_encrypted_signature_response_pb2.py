...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/platform/responses/send_encrypted_signature_response.proto',
...
_SENDENCRYPTEDSIGNATURERESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='received',
            full_name=
            'pogoprotos.networking.platform.responses.SendEncryptedSignatureResponse.received',
            index=0,
            number=1,
            type=8,
            cpp_type=7,
...
DESCRIPTOR.message_types_by_name[
    'SendEncryptedSignatureResponse'] = _SENDENCRYPTEDSIGNATURERESPONSE

SendEncryptedSignatureResponse = _reflection.GeneratedProtocolMessageType(
    'SendEncryptedSignatureResponse',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_SENDENCRYPTEDSIGNATURERESPONSE,
        __module__=
        'pogoprotos.networking.platform.responses.send_encrypted_signature_response_pb2'
