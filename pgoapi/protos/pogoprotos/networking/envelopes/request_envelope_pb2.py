...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_networking_dot_requests_dot_request__pb2.DESCRIPTOR,
        pogoprotos_dot_networking_dot_envelopes_dot_auth__ticket__pb2.
        DESCRIPTOR,
        pogoprotos_dot_networking_dot_platform_dot_platform__request__type__pb2.
        DESCRIPTOR,
    ])
...
_REQUESTENVELOPE_AUTHINFO_JWT = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='unknown2',
            full_name=
            'pogoprotos.networking.envelopes.RequestEnvelope.AuthInfo.JWT.unknown2',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_REQUESTENVELOPE_AUTHINFO = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='token',
            full_name=
            'pogoprotos.networking.envelopes.RequestEnvelope.AuthInfo.token',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_REQUESTENVELOPE_PLATFORMREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='type',
            full_name=
            'pogoprotos.networking.envelopes.RequestEnvelope.PlatformRequest.type',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.envelopes.RequestEnvelope.PlatformRequest.request_message',
            index=1,
            number=2,
            type=12,
            cpp_type=9,
...
_REQUESTENVELOPE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='status_code',
            full_name=
            'pogoprotos.networking.envelopes.RequestEnvelope.status_code',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='request_id',
            full_name=
            'pogoprotos.networking.envelopes.RequestEnvelope.request_id',
            index=1,
            number=3,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='requests',
            full_name=
            'pogoprotos.networking.envelopes.RequestEnvelope.requests',
            index=2,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.envelopes.RequestEnvelope.platform_requests',
            index=3,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='latitude',
            full_name=
            'pogoprotos.networking.envelopes.RequestEnvelope.latitude',
            index=4,
            number=7,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='longitude',
            full_name=
            'pogoprotos.networking.envelopes.RequestEnvelope.longitude',
            index=5,
            number=8,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='accuracy',
            full_name=
            'pogoprotos.networking.envelopes.RequestEnvelope.accuracy',
            index=6,
            number=9,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='auth_info',
            full_name=
            'pogoprotos.networking.envelopes.RequestEnvelope.auth_info',
            index=7,
            number=10,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='auth_ticket',
            full_name=
            'pogoprotos.networking.envelopes.RequestEnvelope.auth_ticket',
            index=8,
            number=11,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.envelopes.RequestEnvelope.ms_since_last_locationfix',
            index=9,
            number=12,
            type=3,
            cpp_type=2,
    ...
    nested_types=[
        ...
        _REQUESTENVELOPE_PLATFORMREQUEST,
    ],
    enum_types=[],
    options=None,
    is_extendable=False,
...
_REQUESTENVELOPE_AUTHINFO.fields_by_name[
    'token'].message_type = _REQUESTENVELOPE_AUTHINFO_JWT
_REQUESTENVELOPE_AUTHINFO.containing_type = _REQUESTENVELOPE
_REQUESTENVELOPE_PLATFORMREQUEST.fields_by_name[
    'type'].enum_type = pogoprotos_dot_networking_dot_platform_dot_platform__request__type__pb2._PLATFORMREQUESTTYPE
_REQUESTENVELOPE_PLATFORMREQUEST.containing_type = _REQUESTENVELOPE
_REQUESTENVELOPE.fields_by_name[
    'requests'].message_type = pogoprotos_dot_networking_dot_requests_dot_request__pb2._REQUEST
_REQUESTENVELOPE.fields_by_name[
    'platform_requests'].message_type = _REQUESTENVELOPE_PLATFORMREQUEST
_REQUESTENVELOPE.fields_by_name[
    'auth_info'].message_type = _REQUESTENVELOPE_AUTHINFO
_REQUESTENVELOPE.fields_by_name[
    'auth_ticket'].message_type = pogoprotos_dot_networking_dot_envelopes_dot_auth__ticket__pb2._AUTHTICKET
DESCRIPTOR.message_types_by_name['RequestEnvelope'] = _REQUESTENVELOPE

RequestEnvelope = _reflection.GeneratedProtocolMessageType(
    'RequestEnvelope',
    (_message.Message, ),
    dict(
        AuthInfo=_reflection.GeneratedProtocolMessageType(
            ...
            (_message.Message, ),
            dict(
                JWT=_reflection.GeneratedProtocolMessageType(
                    'JWT',
                    (_message.Message, ),
                    dict(
                        DESCRIPTOR=_REQUESTENVELOPE_AUTHINFO_JWT,
                        __module__=
                        'pogoprotos.networking.envelopes.request_envelope_pb2'
        ...
        PlatformRequest=_reflection.GeneratedProtocolMessageType(
            'PlatformRequest',
            (_message.Message, ),
            dict(
