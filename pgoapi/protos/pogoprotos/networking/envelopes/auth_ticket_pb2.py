...
_AUTHTICKET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='start',
            full_name='pogoprotos.networking.envelopes.AuthTicket.start',
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.envelopes.AuthTicket.expire_timestamp_ms',
            index=1,
            number=2,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='end',
            full_name='pogoprotos.networking.envelopes.AuthTicket.end',
            index=2,
            number=3,
            type=12,
            cpp_type=9,
...
AuthTicket = _reflection.GeneratedProtocolMessageType(
    'AuthTicket',
    (_message.Message, ),
    dict(
