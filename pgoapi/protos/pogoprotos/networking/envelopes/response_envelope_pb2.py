...
_RESPONSEENVELOPE_STATUSCODE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name='OK_RPC_URL_IN_RESPONSE',
            index=2,
            number=2,
            options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='BAD_REQUEST', index=3, number=3, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='INVALID_PLATFORM_REQUEST',
            index=5,
            number=52,
            options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='REDIRECT', index=6, number=53, options=None, type=None),
        _descriptor.EnumValueDescriptor(
...
_RESPONSEENVELOPE_PLATFORMRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='type',
            full_name=
            'pogoprotos.networking.envelopes.ResponseEnvelope.PlatformResponse.type',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='response',
            full_name=
            'pogoprotos.networking.envelopes.ResponseEnvelope.PlatformResponse.response',
            index=1,
            number=2,
            type=12,
            cpp_type=9,
...
_RESPONSEENVELOPE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='status_code',
            full_name=
            'pogoprotos.networking.envelopes.ResponseEnvelope.status_code',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='request_id',
            full_name=
            'pogoprotos.networking.envelopes.ResponseEnvelope.request_id',
            index=1,
            number=2,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.envelopes.ResponseEnvelope.platform_returns',
            index=3,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='auth_ticket',
            full_name=
            'pogoprotos.networking.envelopes.ResponseEnvelope.auth_ticket',
            index=4,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='returns',
            full_name=
            'pogoprotos.networking.envelopes.ResponseEnvelope.returns',
            index=5,
            number=100,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='error',
            full_name='pogoprotos.networking.envelopes.ResponseEnvelope.error',
            index=6,
            number=101,
            type=9,
            cpp_type=9,
    ...
    extensions=[],
    nested_types=[
        _RESPONSEENVELOPE_PLATFORMRESPONSE,
    ],
    enum_types=[
...
_RESPONSEENVELOPE_PLATFORMRESPONSE.fields_by_name[
...
_RESPONSEENVELOPE.fields_by_name[
    'status_code'].enum_type = _RESPONSEENVELOPE_STATUSCODE
_RESPONSEENVELOPE.fields_by_name[
    'platform_returns'].message_type = _RESPONSEENVELOPE_PLATFORMRESPONSE
_RESPONSEENVELOPE.fields_by_name[
...
ResponseEnvelope = _reflection.GeneratedProtocolMessageType(
    'ResponseEnvelope',
    (_message.Message, ),
    dict(
        PlatformResponse=_reflection.GeneratedProtocolMessageType(
            'PlatformResponse',
            (_message.Message, ),
            dict(
                DESCRIPTOR=_RESPONSEENVELOPE_PLATFORMRESPONSE,
                __module__=
                'pogoprotos.networking.envelopes.response_envelope_pb2'
