...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/download_settings_message.proto',
...
DESCRIPTOR.message_types_by_name[
    'DownloadSettingsMessage'] = _DOWNLOADSETTINGSMESSAGE

DownloadSettingsMessage = _reflection.GeneratedProtocolMessageType(
    'DownloadSettingsMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_DOWNLOADSETTINGSMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.download_settings_message_pb2'
