...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/release_pokemon_message.proto',
...
_RELEASEPOKEMONMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name=
            'pogoprotos.networking.requests.messages.ReleasePokemonMessage.pokemon_id',
            index=0,
            number=1,
            type=6,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='pokemon_ids',
            full_name=
            'pogoprotos.networking.requests.messages.ReleasePokemonMessage.pokemon_ids',
            index=1,
            number=2,
            type=6,
            cpp_type=4,
...
DESCRIPTOR.message_types_by_name[
    'ReleasePokemonMessage'] = _RELEASEPOKEMONMESSAGE

ReleasePokemonMessage = _reflection.GeneratedProtocolMessageType(
    'ReleasePokemonMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_RELEASEPOKEMONMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.release_pokemon_message_pb2'
