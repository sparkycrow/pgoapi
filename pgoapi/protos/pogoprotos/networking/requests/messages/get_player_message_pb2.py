...
_GETPLAYERMESSAGE_PLAYERLOCALE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='country',
            full_name=
            'pogoprotos.networking.requests.messages.GetPlayerMessage.PlayerLocale.country',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='language',
            full_name=
            'pogoprotos.networking.requests.messages.GetPlayerMessage.PlayerLocale.language',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='timezone',
            full_name=
            'pogoprotos.networking.requests.messages.GetPlayerMessage.PlayerLocale.timezone',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_GETPLAYERMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='player_locale',
            full_name=
            'pogoprotos.networking.requests.messages.GetPlayerMessage.player_locale',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
    ...
    extensions=[],
    nested_types=[
        _GETPLAYERMESSAGE_PLAYERLOCALE,
    ],
    enum_types=[],
    options=None,
    is_extendable=False,
...
_GETPLAYERMESSAGE.fields_by_name[
    'player_locale'].message_type = _GETPLAYERMESSAGE_PLAYERLOCALE
DESCRIPTOR.message_types_by_name['GetPlayerMessage'] = _GETPLAYERMESSAGE

GetPlayerMessage = _reflection.GeneratedProtocolMessageType(
    'GetPlayerMessage',
    (_message.Message, ),
    dict(
        PlayerLocale=_reflection.GeneratedProtocolMessageType(
            'PlayerLocale',
            (_message.Message, ),
            dict(
                DESCRIPTOR=_GETPLAYERMESSAGE_PLAYERLOCALE,
                __module__=
                'pogoprotos.networking.requests.messages.get_player_message_pb2'
