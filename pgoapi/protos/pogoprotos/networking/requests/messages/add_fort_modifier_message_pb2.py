...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/add_fort_modifier_message.proto',
...
_ADDFORTMODIFIERMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='modifier_type',
            full_name=
            'pogoprotos.networking.requests.messages.AddFortModifierMessage.modifier_type',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.AddFortModifierMessage.player_latitude',
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.AddFortModifierMessage.player_longitude',
            index=3,
            number=4,
            type=1,
            cpp_type=5,
...
_ADDFORTMODIFIERMESSAGE.fields_by_name[
    'modifier_type'].enum_type = pogoprotos_dot_inventory_dot_item_dot_item__id__pb2._ITEMID
DESCRIPTOR.message_types_by_name[
    'AddFortModifierMessage'] = _ADDFORTMODIFIERMESSAGE

AddFortModifierMessage = _reflection.GeneratedProtocolMessageType(
    'AddFortModifierMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_ADDFORTMODIFIERMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.add_fort_modifier_message_pb2'
