...
_FORTSEARCHMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='fort_id',
            full_name=
            'pogoprotos.networking.requests.messages.FortSearchMessage.fort_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.FortSearchMessage.player_latitude',
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.FortSearchMessage.player_longitude',
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='fort_latitude',
            full_name=
            'pogoprotos.networking.requests.messages.FortSearchMessage.fort_latitude',
            index=3,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='fort_longitude',
            full_name=
            'pogoprotos.networking.requests.messages.FortSearchMessage.fort_longitude',
            index=4,
            number=5,
            type=1,
            cpp_type=5,
...
FortSearchMessage = _reflection.GeneratedProtocolMessageType(
    'FortSearchMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_FORTSEARCHMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.fort_search_message_pb2'
