...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/use_item_egg_incubator_message.proto',
...
_USEITEMEGGINCUBATORMESSAGE = _descriptor.Descriptor(
    ...
    full_name=
    'pogoprotos.networking.requests.messages.UseItemEggIncubatorMessage',
    filename=None,
    file=DESCRIPTOR,
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name=
            'pogoprotos.networking.requests.messages.UseItemEggIncubatorMessage.pokemon_id',
            index=1,
            number=2,
            type=4,
            cpp_type=4,
...
DESCRIPTOR.message_types_by_name[
    'UseItemEggIncubatorMessage'] = _USEITEMEGGINCUBATORMESSAGE

UseItemEggIncubatorMessage = _reflection.GeneratedProtocolMessageType(
    'UseItemEggIncubatorMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_USEITEMEGGINCUBATORMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.use_item_egg_incubator_message_pb2'
