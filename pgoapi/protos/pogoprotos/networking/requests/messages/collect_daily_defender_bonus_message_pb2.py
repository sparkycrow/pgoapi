...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/collect_daily_defender_bonus_message.proto',
...
_COLLECTDAILYDEFENDERBONUSMESSAGE = _descriptor.Descriptor(
    ...
    full_name=
    'pogoprotos.networking.requests.messages.CollectDailyDefenderBonusMessage',
    filename=None,
    file=DESCRIPTOR,
...
DESCRIPTOR.message_types_by_name[
    'CollectDailyDefenderBonusMessage'] = _COLLECTDAILYDEFENDERBONUSMESSAGE

CollectDailyDefenderBonusMessage = _reflection.GeneratedProtocolMessageType(
    'CollectDailyDefenderBonusMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_COLLECTDAILYDEFENDERBONUSMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.collect_daily_defender_bonus_message_pb2'
