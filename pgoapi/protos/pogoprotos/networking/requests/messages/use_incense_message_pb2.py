...
_USEINCENSEMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='incense_type',
            full_name=
            'pogoprotos.networking.requests.messages.UseIncenseMessage.incense_type',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
...
_USEINCENSEMESSAGE.fields_by_name[
    'incense_type'].enum_type = pogoprotos_dot_inventory_dot_item_dot_item__id__pb2._ITEMID
DESCRIPTOR.message_types_by_name['UseIncenseMessage'] = _USEINCENSEMESSAGE

UseIncenseMessage = _reflection.GeneratedProtocolMessageType(
    'UseIncenseMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_USEINCENSEMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.use_incense_message_pb2'
