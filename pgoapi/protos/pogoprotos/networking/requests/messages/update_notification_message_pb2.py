...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/update_notification_message.proto',
    ...
    dependencies=[
        pogoprotos_dot_enums_dot_notification__state__pb2.DESCRIPTOR,
    ])
...
_UPDATENOTIFICATIONMESSAGE = _descriptor.Descriptor(
    ...
    full_name=
    'pogoprotos.networking.requests.messages.UpdateNotificationMessage',
    filename=None,
    file=DESCRIPTOR,
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.UpdateNotificationMessage.notification_ids',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.UpdateNotificationMessage.create_timestamp_ms',
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='state',
            full_name=
            'pogoprotos.networking.requests.messages.UpdateNotificationMessage.state',
            index=2,
            number=3,
            type=14,
            cpp_type=8,
...
_UPDATENOTIFICATIONMESSAGE.fields_by_name[
    'state'].enum_type = pogoprotos_dot_enums_dot_notification__state__pb2._NOTIFICATIONSTATE
DESCRIPTOR.message_types_by_name[
    'UpdateNotificationMessage'] = _UPDATENOTIFICATIONMESSAGE

UpdateNotificationMessage = _reflection.GeneratedProtocolMessageType(
    'UpdateNotificationMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_UPDATENOTIFICATIONMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.update_notification_message_pb2'
