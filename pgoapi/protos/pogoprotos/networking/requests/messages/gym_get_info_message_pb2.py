...
_GYMGETINFOMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='gym_id',
            full_name=
            'pogoprotos.networking.requests.messages.GymGetInfoMessage.gym_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.GymGetInfoMessage.player_lat_degrees',
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.GymGetInfoMessage.gym_lat_degrees',
            index=3,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.GymGetInfoMessage.gym_lng_degrees',
            index=4,
            number=5,
            type=1,
            cpp_type=5,
...
GymGetInfoMessage = _reflection.GeneratedProtocolMessageType(
    'GymGetInfoMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_GYMGETINFOMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.gym_get_info_message_pb2'
