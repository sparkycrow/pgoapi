...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/encounter_tutorial_complete_message.proto',
...
_ENCOUNTERTUTORIALCOMPLETEMESSAGE = _descriptor.Descriptor(
    ...
    full_name=
    'pogoprotos.networking.requests.messages.EncounterTutorialCompleteMessage',
    filename=None,
    file=DESCRIPTOR,
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name=
            'pogoprotos.networking.requests.messages.EncounterTutorialCompleteMessage.pokemon_id',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
...
_ENCOUNTERTUTORIALCOMPLETEMESSAGE.fields_by_name[
    'pokemon_id'].enum_type = pogoprotos_dot_enums_dot_pokemon__id__pb2._POKEMONID
DESCRIPTOR.message_types_by_name[
    'EncounterTutorialCompleteMessage'] = _ENCOUNTERTUTORIALCOMPLETEMESSAGE

EncounterTutorialCompleteMessage = _reflection.GeneratedProtocolMessageType(
    'EncounterTutorialCompleteMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_ENCOUNTERTUTORIALCOMPLETEMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.encounter_tutorial_complete_message_pb2'
