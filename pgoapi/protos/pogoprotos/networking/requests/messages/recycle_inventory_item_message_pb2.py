...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/recycle_inventory_item_message.proto',
...
_RECYCLEINVENTORYITEMMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='item_id',
            full_name=
            'pogoprotos.networking.requests.messages.RecycleInventoryItemMessage.item_id',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
...
_RECYCLEINVENTORYITEMMESSAGE.fields_by_name[
    'item_id'].enum_type = pogoprotos_dot_inventory_dot_item_dot_item__id__pb2._ITEMID
DESCRIPTOR.message_types_by_name[
    'RecycleInventoryItemMessage'] = _RECYCLEINVENTORYITEMMESSAGE

RecycleInventoryItemMessage = _reflection.GeneratedProtocolMessageType(
    'RecycleInventoryItemMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_RECYCLEINVENTORYITEMMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.recycle_inventory_item_message_pb2'
