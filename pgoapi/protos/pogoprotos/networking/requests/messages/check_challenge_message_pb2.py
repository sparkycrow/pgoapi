...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/check_challenge_message.proto',
...
_CHECKCHALLENGEMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='debug_request',
            full_name=
            'pogoprotos.networking.requests.messages.CheckChallengeMessage.debug_request',
            index=0,
            number=1,
            type=8,
            cpp_type=7,
...
DESCRIPTOR.message_types_by_name[
    'CheckChallengeMessage'] = _CHECKCHALLENGEMESSAGE

CheckChallengeMessage = _reflection.GeneratedProtocolMessageType(
    'CheckChallengeMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_CHECKCHALLENGEMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.check_challenge_message_pb2'
