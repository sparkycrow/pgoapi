...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/fort_deploy_pokemon_message.proto',
...
_FORTDEPLOYPOKEMONMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name=
            'pogoprotos.networking.requests.messages.FortDeployPokemonMessage.pokemon_id',
            index=1,
            number=2,
            type=6,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.FortDeployPokemonMessage.player_latitude',
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.FortDeployPokemonMessage.player_longitude',
            index=3,
            number=4,
            type=1,
            cpp_type=5,
...
DESCRIPTOR.message_types_by_name[
    'FortDeployPokemonMessage'] = _FORTDEPLOYPOKEMONMESSAGE

FortDeployPokemonMessage = _reflection.GeneratedProtocolMessageType(
    'FortDeployPokemonMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_FORTDEPLOYPOKEMONMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.fort_deploy_pokemon_message_pb2'
