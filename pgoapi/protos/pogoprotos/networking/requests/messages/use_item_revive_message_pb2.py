...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/use_item_revive_message.proto',
...
_USEITEMREVIVEMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='item_id',
            full_name=
            'pogoprotos.networking.requests.messages.UseItemReviveMessage.item_id',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name=
            'pogoprotos.networking.requests.messages.UseItemReviveMessage.pokemon_id',
            index=1,
            number=2,
            type=6,
            cpp_type=4,
...
_USEITEMREVIVEMESSAGE.fields_by_name[
    'item_id'].enum_type = pogoprotos_dot_inventory_dot_item_dot_item__id__pb2._ITEMID
DESCRIPTOR.message_types_by_name[
    'UseItemReviveMessage'] = _USEITEMREVIVEMESSAGE

UseItemReviveMessage = _reflection.GeneratedProtocolMessageType(
    'UseItemReviveMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_USEITEMREVIVEMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.use_item_revive_message_pb2'
