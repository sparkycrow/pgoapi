...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/sfida_action_log_message.proto',
...
DESCRIPTOR.message_types_by_name[
    'SfidaActionLogMessage'] = _SFIDAACTIONLOGMESSAGE

SfidaActionLogMessage = _reflection.GeneratedProtocolMessageType(
    'SfidaActionLogMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_SFIDAACTIONLOGMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.sfida_action_log_message_pb2'
