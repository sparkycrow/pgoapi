...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/mark_tutorial_complete_message.proto',
...
_MARKTUTORIALCOMPLETEMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.MarkTutorialCompleteMessage.tutorials_completed',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.MarkTutorialCompleteMessage.send_marketing_emails',
            index=1,
            number=2,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.MarkTutorialCompleteMessage.send_push_notifications',
            index=2,
            number=3,
            type=8,
            cpp_type=7,
...
_MARKTUTORIALCOMPLETEMESSAGE.fields_by_name[
    'tutorials_completed'].enum_type = pogoprotos_dot_enums_dot_tutorial__state__pb2._TUTORIALSTATE
DESCRIPTOR.message_types_by_name[
    'MarkTutorialCompleteMessage'] = _MARKTUTORIALCOMPLETEMESSAGE

MarkTutorialCompleteMessage = _reflection.GeneratedProtocolMessageType(
    'MarkTutorialCompleteMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_MARKTUTORIALCOMPLETEMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.mark_tutorial_complete_message_pb2'
