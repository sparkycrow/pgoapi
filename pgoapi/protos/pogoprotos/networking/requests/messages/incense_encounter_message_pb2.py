...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/incense_encounter_message.proto',
...
_INCENSEENCOUNTERMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='encounter_id',
            full_name=
            'pogoprotos.networking.requests.messages.IncenseEncounterMessage.encounter_id',
            index=0,
            number=1,
            type=4,
            cpp_type=4,
...
DESCRIPTOR.message_types_by_name[
    'IncenseEncounterMessage'] = _INCENSEENCOUNTERMESSAGE

IncenseEncounterMessage = _reflection.GeneratedProtocolMessageType(
    'IncenseEncounterMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_INCENSEENCOUNTERMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.incense_encounter_message_pb2'
