...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/verify_challenge_message.proto',
...
_VERIFYCHALLENGEMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='token',
            full_name=
            'pogoprotos.networking.requests.messages.VerifyChallengeMessage.token',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
DESCRIPTOR.message_types_by_name[
    'VerifyChallengeMessage'] = _VERIFYCHALLENGEMESSAGE

VerifyChallengeMessage = _reflection.GeneratedProtocolMessageType(
    'VerifyChallengeMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_VERIFYCHALLENGEMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.verify_challenge_message_pb2'
