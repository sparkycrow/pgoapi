...
_CATCHPOKEMONMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='encounter_id',
            full_name=
            'pogoprotos.networking.requests.messages.CatchPokemonMessage.encounter_id',
            index=0,
            number=1,
            type=6,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='pokeball',
            full_name=
            'pogoprotos.networking.requests.messages.CatchPokemonMessage.pokeball',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.CatchPokemonMessage.normalized_reticle_size',
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='hit_pokemon',
            full_name=
            'pogoprotos.networking.requests.messages.CatchPokemonMessage.hit_pokemon',
            index=4,
            number=5,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='spin_modifier',
            full_name=
            'pogoprotos.networking.requests.messages.CatchPokemonMessage.spin_modifier',
            index=5,
            number=6,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.CatchPokemonMessage.normalized_hit_position',
            index=6,
            number=7,
            type=1,
            cpp_type=5,
...
_CATCHPOKEMONMESSAGE.fields_by_name[
...
CatchPokemonMessage = _reflection.GeneratedProtocolMessageType(
    'CatchPokemonMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_CATCHPOKEMONMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.catch_pokemon_message_pb2'
