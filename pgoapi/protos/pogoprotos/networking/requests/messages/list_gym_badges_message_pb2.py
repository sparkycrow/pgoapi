...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/list_gym_badges_message.proto',
...
DESCRIPTOR.message_types_by_name[
    'ListGymBadgesMessage'] = _LISTGYMBADGESMESSAGE

ListGymBadgesMessage = _reflection.GeneratedProtocolMessageType(
    'ListGymBadgesMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_LISTGYMBADGESMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.list_gym_badges_message_pb2'
