...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/set_avatar_item_as_viewed_message.proto',
...
_SETAVATARITEMASVIEWEDMESSAGE = _descriptor.Descriptor(
    ...
    full_name=
    'pogoprotos.networking.requests.messages.SetAvatarItemAsViewedMessage',
    filename=None,
    file=DESCRIPTOR,
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.SetAvatarItemAsViewedMessage.avatar_template_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
DESCRIPTOR.message_types_by_name[
    'SetAvatarItemAsViewedMessage'] = _SETAVATARITEMASVIEWEDMESSAGE

SetAvatarItemAsViewedMessage = _reflection.GeneratedProtocolMessageType(
    'SetAvatarItemAsViewedMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_SETAVATARITEMASVIEWEDMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.set_avatar_item_as_viewed_message_pb2'
