...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/nickname_pokemon_message.proto',
...
_NICKNAMEPOKEMONMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name=
            'pogoprotos.networking.requests.messages.NicknamePokemonMessage.pokemon_id',
            index=0,
            number=1,
            type=6,
            cpp_type=4,
...
DESCRIPTOR.message_types_by_name[
    'NicknamePokemonMessage'] = _NICKNAMEPOKEMONMESSAGE

NicknamePokemonMessage = _reflection.GeneratedProtocolMessageType(
    'NicknamePokemonMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_NICKNAMEPOKEMONMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.nickname_pokemon_message_pb2'
