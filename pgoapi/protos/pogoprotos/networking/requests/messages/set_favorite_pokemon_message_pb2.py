...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/set_favorite_pokemon_message.proto',
...
_SETFAVORITEPOKEMONMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name=
            'pogoprotos.networking.requests.messages.SetFavoritePokemonMessage.pokemon_id',
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='is_favorite',
            full_name=
            'pogoprotos.networking.requests.messages.SetFavoritePokemonMessage.is_favorite',
            index=1,
            number=2,
            type=8,
            cpp_type=7,
...
DESCRIPTOR.message_types_by_name[
    'SetFavoritePokemonMessage'] = _SETFAVORITEPOKEMONMESSAGE

SetFavoritePokemonMessage = _reflection.GeneratedProtocolMessageType(
    'SetFavoritePokemonMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_SETFAVORITEPOKEMONMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.set_favorite_pokemon_message_pb2'
