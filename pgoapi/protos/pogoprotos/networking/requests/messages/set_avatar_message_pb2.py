...
_SETAVATARMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='player_avatar',
            full_name=
            'pogoprotos.networking.requests.messages.SetAvatarMessage.player_avatar',
            index=0,
            number=2,
            type=11,
            cpp_type=10,
...
_SETAVATARMESSAGE.fields_by_name[
    'player_avatar'].message_type = pogoprotos_dot_data_dot_player_dot_player__avatar__pb2._PLAYERAVATAR
DESCRIPTOR.message_types_by_name['SetAvatarMessage'] = _SETAVATARMESSAGE

SetAvatarMessage = _reflection.GeneratedProtocolMessageType(
    'SetAvatarMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_SETAVATARMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.set_avatar_message_pb2'
