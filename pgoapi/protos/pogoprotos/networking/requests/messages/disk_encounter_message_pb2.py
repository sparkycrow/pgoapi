...
_DISKENCOUNTERMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='encounter_id',
            full_name=
            'pogoprotos.networking.requests.messages.DiskEncounterMessage.encounter_id',
            index=0,
            number=1,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.DiskEncounterMessage.player_latitude',
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.DiskEncounterMessage.player_longitude',
            index=3,
            number=4,
            type=1,
            cpp_type=5,
...
DESCRIPTOR.message_types_by_name[
    'DiskEncounterMessage'] = _DISKENCOUNTERMESSAGE

DiskEncounterMessage = _reflection.GeneratedProtocolMessageType(
    'DiskEncounterMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_DISKENCOUNTERMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.disk_encounter_message_pb2'
