...
_CLAIMCODENAMEMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='force',
            full_name=
            'pogoprotos.networking.requests.messages.ClaimCodenameMessage.force',
            index=1,
            number=2,
            type=8,
            cpp_type=7,
...
DESCRIPTOR.message_types_by_name[
    'ClaimCodenameMessage'] = _CLAIMCODENAMEMESSAGE

ClaimCodenameMessage = _reflection.GeneratedProtocolMessageType(
    'ClaimCodenameMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_CLAIMCODENAMEMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.claim_codename_message_pb2'
