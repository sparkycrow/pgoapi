...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/download_item_templates_message.proto',
...
_DOWNLOADITEMTEMPLATESMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='paginate',
            full_name=
            'pogoprotos.networking.requests.messages.DownloadItemTemplatesMessage.paginate',
            index=0,
            number=1,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='page_offset',
            full_name=
            'pogoprotos.networking.requests.messages.DownloadItemTemplatesMessage.page_offset',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='page_timestamp',
            full_name=
            'pogoprotos.networking.requests.messages.DownloadItemTemplatesMessage.page_timestamp',
            index=2,
            number=3,
            type=4,
            cpp_type=4,
...
DESCRIPTOR.message_types_by_name[
    'DownloadItemTemplatesMessage'] = _DOWNLOADITEMTEMPLATESMESSAGE

DownloadItemTemplatesMessage = _reflection.GeneratedProtocolMessageType(
    'DownloadItemTemplatesMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_DOWNLOADITEMTEMPLATESMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.download_item_templates_message_pb2'
