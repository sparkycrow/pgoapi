...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/use_item_potion_message.proto',
...
_USEITEMPOTIONMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='item_id',
            full_name=
            'pogoprotos.networking.requests.messages.UseItemPotionMessage.item_id',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name=
            'pogoprotos.networking.requests.messages.UseItemPotionMessage.pokemon_id',
            index=1,
            number=2,
            type=6,
            cpp_type=4,
...
_USEITEMPOTIONMESSAGE.fields_by_name[
    'item_id'].enum_type = pogoprotos_dot_inventory_dot_item_dot_item__id__pb2._ITEMID
DESCRIPTOR.message_types_by_name[
    'UseItemPotionMessage'] = _USEITEMPOTIONMESSAGE

UseItemPotionMessage = _reflection.GeneratedProtocolMessageType(
    'UseItemPotionMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_USEITEMPOTIONMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.use_item_potion_message_pb2'
