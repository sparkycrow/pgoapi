...
_FORTDETAILSMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='latitude',
            full_name=
            'pogoprotos.networking.requests.messages.FortDetailsMessage.latitude',
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='longitude',
            full_name=
            'pogoprotos.networking.requests.messages.FortDetailsMessage.longitude',
            index=2,
            number=3,
            type=1,
            cpp_type=5,
...
FortDetailsMessage = _reflection.GeneratedProtocolMessageType(
    'FortDetailsMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_FORTDETAILSMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.fort_details_message_pb2'
