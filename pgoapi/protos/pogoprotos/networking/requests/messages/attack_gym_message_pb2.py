...
_ATTACKGYMMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='attack_actions',
            full_name=
            'pogoprotos.networking.requests.messages.AttackGymMessage.attack_actions',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.AttackGymMessage.last_retrieved_action',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.AttackGymMessage.player_latitude',
            index=4,
            number=5,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.AttackGymMessage.player_longitude',
            index=5,
            number=6,
            type=1,
            cpp_type=5,
...
_ATTACKGYMMESSAGE.fields_by_name[
    'attack_actions'].message_type = pogoprotos_dot_data_dot_battle_dot_battle__action__pb2._BATTLEACTION
_ATTACKGYMMESSAGE.fields_by_name[
    'last_retrieved_action'].message_type = pogoprotos_dot_data_dot_battle_dot_battle__action__pb2._BATTLEACTION
DESCRIPTOR.message_types_by_name['AttackGymMessage'] = _ATTACKGYMMESSAGE

AttackGymMessage = _reflection.GeneratedProtocolMessageType(
    'AttackGymMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_ATTACKGYMMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.attack_gym_message_pb2'
