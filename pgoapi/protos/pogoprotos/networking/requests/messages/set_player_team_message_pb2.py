...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/set_player_team_message.proto',
...
_SETPLAYERTEAMMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='team',
            full_name=
            'pogoprotos.networking.requests.messages.SetPlayerTeamMessage.team',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
...
_SETPLAYERTEAMMESSAGE.fields_by_name[
    'team'].enum_type = pogoprotos_dot_enums_dot_team__color__pb2._TEAMCOLOR
DESCRIPTOR.message_types_by_name[
    'SetPlayerTeamMessage'] = _SETPLAYERTEAMMESSAGE

SetPlayerTeamMessage = _reflection.GeneratedProtocolMessageType(
    'SetPlayerTeamMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_SETPLAYERTEAMMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.set_player_team_message_pb2'
