...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/upgrade_pokemon_message.proto',
...
_UPGRADEPOKEMONMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name=
            'pogoprotos.networking.requests.messages.UpgradePokemonMessage.pokemon_id',
            index=0,
            number=1,
            type=6,
            cpp_type=4,
...
DESCRIPTOR.message_types_by_name[
    'UpgradePokemonMessage'] = _UPGRADEPOKEMONMESSAGE

UpgradePokemonMessage = _reflection.GeneratedProtocolMessageType(
    'UpgradePokemonMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_UPGRADEPOKEMONMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.upgrade_pokemon_message_pb2'
