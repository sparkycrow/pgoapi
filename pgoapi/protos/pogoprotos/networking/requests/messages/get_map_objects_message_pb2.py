...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/get_map_objects_message.proto',
...
_GETMAPOBJECTSMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='cell_id',
            full_name=
            'pogoprotos.networking.requests.messages.GetMapObjectsMessage.cell_id',
            index=0,
            number=1,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.GetMapObjectsMessage.since_timestamp_ms',
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='latitude',
            full_name=
            'pogoprotos.networking.requests.messages.GetMapObjectsMessage.latitude',
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='longitude',
            full_name=
            'pogoprotos.networking.requests.messages.GetMapObjectsMessage.longitude',
            index=3,
            number=4,
            type=1,
            cpp_type=5,
...
DESCRIPTOR.message_types_by_name[
    'GetMapObjectsMessage'] = _GETMAPOBJECTSMESSAGE

GetMapObjectsMessage = _reflection.GeneratedProtocolMessageType(
    'GetMapObjectsMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_GETMAPOBJECTSMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.get_map_objects_message_pb2'
...
_GETMAPOBJECTSMESSAGE.fields_by_name[
    'cell_id']._options = _descriptor._ParseOptions(
        descriptor_pb2.FieldOptions(), _b('\020\001'))
_GETMAPOBJECTSMESSAGE.fields_by_name['since_timestamp_ms'].has_options = True
_GETMAPOBJECTSMESSAGE.fields_by_name[
    'since_timestamp_ms']._options = _descriptor._ParseOptions(
        descriptor_pb2.FieldOptions(), _b('\020\001'))
