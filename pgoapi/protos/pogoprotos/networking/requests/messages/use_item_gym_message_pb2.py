...
_USEITEMGYMMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='item_id',
            full_name=
            'pogoprotos.networking.requests.messages.UseItemGymMessage.item_id',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.UseItemGymMessage.player_latitude',
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.UseItemGymMessage.player_longitude',
            index=3,
            number=4,
            type=1,
            cpp_type=5,
...
_USEITEMGYMMESSAGE.fields_by_name[
...
UseItemGymMessage = _reflection.GeneratedProtocolMessageType(
    'UseItemGymMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_USEITEMGYMMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.use_item_gym_message_pb2'
