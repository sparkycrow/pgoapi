...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/get_player_profile_message.proto',
...
DESCRIPTOR.message_types_by_name[
    'GetPlayerProfileMessage'] = _GETPLAYERPROFILEMESSAGE

GetPlayerProfileMessage = _reflection.GeneratedProtocolMessageType(
    'GetPlayerProfileMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_GETPLAYERPROFILEMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.get_player_profile_message_pb2'
