...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/level_up_rewards_message.proto',
...
_LEVELUPREWARDSMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='level',
            full_name=
            'pogoprotos.networking.requests.messages.LevelUpRewardsMessage.level',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
...
DESCRIPTOR.message_types_by_name[
    'LevelUpRewardsMessage'] = _LEVELUPREWARDSMESSAGE

LevelUpRewardsMessage = _reflection.GeneratedProtocolMessageType(
    'LevelUpRewardsMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_LEVELUPREWARDSMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.level_up_rewards_message_pb2'
