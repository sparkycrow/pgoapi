...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/get_asset_digest_message.proto',
    ...
    dependencies=[
        pogoprotos_dot_enums_dot_platform__pb2.DESCRIPTOR,
    ])
...
_GETASSETDIGESTMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='platform',
            full_name=
            'pogoprotos.networking.requests.messages.GetAssetDigestMessage.platform',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='app_version',
            full_name=
            'pogoprotos.networking.requests.messages.GetAssetDigestMessage.app_version',
            index=4,
            number=5,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='paginate',
            full_name=
            'pogoprotos.networking.requests.messages.GetAssetDigestMessage.paginate',
            index=5,
            number=6,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='page_offset',
            full_name=
            'pogoprotos.networking.requests.messages.GetAssetDigestMessage.page_offset',
            index=6,
            number=7,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='page_timestamp',
            full_name=
            'pogoprotos.networking.requests.messages.GetAssetDigestMessage.page_timestamp',
            index=7,
            number=8,
            type=4,
            cpp_type=4,
...
_GETASSETDIGESTMESSAGE.fields_by_name[
    'platform'].enum_type = pogoprotos_dot_enums_dot_platform__pb2._PLATFORM
DESCRIPTOR.message_types_by_name[
    'GetAssetDigestMessage'] = _GETASSETDIGESTMESSAGE

GetAssetDigestMessage = _reflection.GeneratedProtocolMessageType(
    'GetAssetDigestMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_GETASSETDIGESTMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.get_asset_digest_message_pb2'
