...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/use_item_xp_boost_message.proto',
...
_USEITEMXPBOOSTMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='item_id',
            full_name=
            'pogoprotos.networking.requests.messages.UseItemXpBoostMessage.item_id',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
...
_USEITEMXPBOOSTMESSAGE.fields_by_name[
    'item_id'].enum_type = pogoprotos_dot_inventory_dot_item_dot_item__id__pb2._ITEMID
DESCRIPTOR.message_types_by_name[
    'UseItemXpBoostMessage'] = _USEITEMXPBOOSTMESSAGE

UseItemXpBoostMessage = _reflection.GeneratedProtocolMessageType(
    'UseItemXpBoostMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_USEITEMXPBOOSTMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.use_item_xp_boost_message_pb2'
