...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/download_remote_config_version_message.proto',
...
_DOWNLOADREMOTECONFIGVERSIONMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='platform',
            full_name=
            'pogoprotos.networking.requests.messages.DownloadRemoteConfigVersionMessage.platform',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='app_version',
            full_name=
            'pogoprotos.networking.requests.messages.DownloadRemoteConfigVersionMessage.app_version',
            index=4,
            number=5,
            type=13,
            cpp_type=3,
...
_DOWNLOADREMOTECONFIGVERSIONMESSAGE.fields_by_name[
    'platform'].enum_type = pogoprotos_dot_enums_dot_platform__pb2._PLATFORM
DESCRIPTOR.message_types_by_name[
    'DownloadRemoteConfigVersionMessage'] = _DOWNLOADREMOTECONFIGVERSIONMESSAGE

DownloadRemoteConfigVersionMessage = _reflection.GeneratedProtocolMessageType(
    'DownloadRemoteConfigVersionMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_DOWNLOADREMOTECONFIGVERSIONMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.download_remote_config_version_message_pb2'
