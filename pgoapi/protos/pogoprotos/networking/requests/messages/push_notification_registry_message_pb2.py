...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/push_notification_registry_message.proto',
...
_PUSHNOTIFICATIONREGISTRYMESSAGE_APNTOKEN = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.PushNotificationRegistryMessage.ApnToken.registration_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.PushNotificationRegistryMessage.ApnToken.bundle_identifier',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.PushNotificationRegistryMessage.ApnToken.payload_byte_size',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
...
_PUSHNOTIFICATIONREGISTRYMESSAGE_GCMTOKEN = _descriptor.Descriptor(
    name='GcmToken',
    full_name=
    'pogoprotos.networking.requests.messages.PushNotificationRegistryMessage.GcmToken',
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name='registration_id',
            full_name=
            'pogoprotos.networking.requests.messages.PushNotificationRegistryMessage.GcmToken.registration_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_PUSHNOTIFICATIONREGISTRYMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='apn_token',
            full_name=
            'pogoprotos.networking.requests.messages.PushNotificationRegistryMessage.apn_token',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='gcm_token',
            full_name=
            'pogoprotos.networking.requests.messages.PushNotificationRegistryMessage.gcm_token',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
    ...
    extensions=[],
    nested_types=[
        _PUSHNOTIFICATIONREGISTRYMESSAGE_APNTOKEN,
        _PUSHNOTIFICATIONREGISTRYMESSAGE_GCMTOKEN,
    ],
    enum_types=[],
    options=None,
    is_extendable=False,
...
_PUSHNOTIFICATIONREGISTRYMESSAGE.fields_by_name[
    'apn_token'].message_type = _PUSHNOTIFICATIONREGISTRYMESSAGE_APNTOKEN
_PUSHNOTIFICATIONREGISTRYMESSAGE.fields_by_name[
    'gcm_token'].message_type = _PUSHNOTIFICATIONREGISTRYMESSAGE_GCMTOKEN
DESCRIPTOR.message_types_by_name[
    'PushNotificationRegistryMessage'] = _PUSHNOTIFICATIONREGISTRYMESSAGE

PushNotificationRegistryMessage = _reflection.GeneratedProtocolMessageType(
    'PushNotificationRegistryMessage',
    (_message.Message, ),
    dict(
        ApnToken=_reflection.GeneratedProtocolMessageType(
            'ApnToken',
            (_message.Message, ),
            dict(
                DESCRIPTOR=_PUSHNOTIFICATIONREGISTRYMESSAGE_APNTOKEN,
                __module__=
                'pogoprotos.networking.requests.messages.push_notification_registry_message_pb2'
                # @@protoc_insertion_point(class_scope:pogoprotos.networking.requests.messages.PushNotificationRegistryMessage.ApnToken)
            )),
        GcmToken=_reflection.GeneratedProtocolMessageType(
            'GcmToken',
            (_message.Message, ),
            dict(
