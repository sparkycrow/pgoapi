...
DESCRIPTOR = _descriptor.FileDescriptor(
    name=
    'pogoprotos/networking/requests/messages/set_contact_settings_message.proto',
...
_SETCONTACTSETTINGSMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.networking.requests.messages.SetContactSettingsMessage.contact_settings',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_SETCONTACTSETTINGSMESSAGE.fields_by_name[
    'contact_settings'].message_type = pogoprotos_dot_data_dot_player_dot_contact__settings__pb2._CONTACTSETTINGS
DESCRIPTOR.message_types_by_name[
    'SetContactSettingsMessage'] = _SETCONTACTSETTINGSMESSAGE

SetContactSettingsMessage = _reflection.GeneratedProtocolMessageType(
    'SetContactSettingsMessage',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_SETCONTACTSETTINGSMESSAGE,
        __module__=
        'pogoprotos.networking.requests.messages.set_contact_settings_message_pb2'
