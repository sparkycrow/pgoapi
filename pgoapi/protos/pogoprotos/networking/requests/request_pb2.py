...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_networking_dot_requests_dot_request__type__pb2.
        DESCRIPTOR,
    ])
...
_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='request_type',
            full_name='pogoprotos.networking.requests.Request.request_type',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.networking.requests.Request.request_message',
            index=1,
            number=2,
            type=12,
            cpp_type=9,
...
_REQUEST.fields_by_name[
    'request_type'].enum_type = pogoprotos_dot_networking_dot_requests_dot_request__type__pb2._REQUESTTYPE
