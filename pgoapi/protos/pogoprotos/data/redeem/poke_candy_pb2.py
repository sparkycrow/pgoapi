...
_POKECANDY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name='pogoprotos.data.redeem.PokeCandy.pokemon_id',
            index=0,
            number=1,
            type=6,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='candy_count',
            full_name='pogoprotos.data.redeem.PokeCandy.candy_count',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
PokeCandy = _reflection.GeneratedProtocolMessageType(
    'PokeCandy',
    (_message.Message, ),
    dict(
