...
_REDEEMEDAVATARITEM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.redeem.RedeemedAvatarItem.avatar_template_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='item_count',
            full_name='pogoprotos.data.redeem.RedeemedAvatarItem.item_count',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
RedeemedAvatarItem = _reflection.GeneratedProtocolMessageType(
    'RedeemedAvatarItem',
    (_message.Message, ),
    dict(
