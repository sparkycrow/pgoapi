...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_map_dot_pokemon_dot_motivated__pokemon__pb2.DESCRIPTOR,
...
_GYMDEFENDER_DEPLOYMENTTOTALS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='times_fed',
            full_name=
            'pogoprotos.data.gym.GymDefender.DeploymentTotals.times_fed',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='battles_won',
            full_name=
            'pogoprotos.data.gym.GymDefender.DeploymentTotals.battles_won',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='battles_lost',
            full_name=
            'pogoprotos.data.gym.GymDefender.DeploymentTotals.battles_lost',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.gym.GymDefender.DeploymentTotals.deployment_duration_ms',
            index=3,
            number=4,
            type=3,
            cpp_type=2,
...
_GYMDEFENDER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.gym.GymDefender.motivated_pokemon',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.gym.GymDefender.deployment_totals',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.gym.GymDefender.trainer_public_profile',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_GYMDEFENDER.fields_by_name[
    'motivated_pokemon'].message_type = pogoprotos_dot_map_dot_pokemon_dot_motivated__pokemon__pb2._MOTIVATEDPOKEMON
_GYMDEFENDER.fields_by_name[
    'deployment_totals'].message_type = _GYMDEFENDER_DEPLOYMENTTOTALS
_GYMDEFENDER.fields_by_name[
...
GymDefender = _reflection.GeneratedProtocolMessageType(
    'GymDefender',
    (_message.Message, ),
    dict(
        DeploymentTotals=_reflection.GeneratedProtocolMessageType(
            'DeploymentTotals',
            (_message.Message, ),
            dict(
