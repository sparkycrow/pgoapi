...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        pogoprotos_dot_data_dot_gym_dot_gym__membership__pb2.DESCRIPTOR,
    ])
...
_GYMSTATE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='fort_data',
            full_name='pogoprotos.data.gym.GymState.fort_data',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='memberships',
            full_name='pogoprotos.data.gym.GymState.memberships',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='deploy_lockout',
            full_name='pogoprotos.data.gym.GymState.deploy_lockout',
            index=2,
            number=3,
            type=8,
            cpp_type=7,
...
_GYMSTATE.fields_by_name[
    'fort_data'].message_type = pogoprotos_dot_map_dot_fort_dot_fort__data__pb2._FORTDATA
_GYMSTATE.fields_by_name[
    'memberships'].message_type = pogoprotos_dot_data_dot_gym_dot_gym__membership__pb2._GYMMEMBERSHIP
DESCRIPTOR.message_types_by_name['GymState'] = _GYMSTATE

GymState = _reflection.GeneratedProtocolMessageType(
    'GymState',
    (_message.Message, ),
    dict(
