...
_GYMMEMBERSHIP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='pokemon_data',
            full_name='pogoprotos.data.gym.GymMembership.pokemon_data',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.gym.GymMembership.trainer_public_profile',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.gym.GymMembership.training_pokemon',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_GYMMEMBERSHIP.fields_by_name[
    'training_pokemon'].message_type = pogoprotos_dot_data_dot_pokemon__data__pb2._POKEMONDATA
DESCRIPTOR.message_types_by_name['GymMembership'] = _GYMMEMBERSHIP

GymMembership = _reflection.GeneratedProtocolMessageType(
    'GymMembership',
    (_message.Message, ),
    dict(
