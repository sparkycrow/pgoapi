...
_POKEDEXENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name='pogoprotos.data.PokedexEntry.pokemon_id',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.PokedexEntry.times_encountered',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='times_captured',
            full_name='pogoprotos.data.PokedexEntry.times_captured',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.PokedexEntry.evolution_stone_pieces',
            index=3,
            number=4,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.PokedexEntry.captured_costumes',
            index=5,
            number=6,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='captured_forms',
            full_name='pogoprotos.data.PokedexEntry.captured_forms',
            index=6,
            number=7,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.PokedexEntry.captured_genders',
            index=7,
            number=8,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='captured_shiny',
            full_name='pogoprotos.data.PokedexEntry.captured_shiny',
            index=8,
            number=9,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.PokedexEntry.encountered_forms',
            index=10,
            number=11,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.PokedexEntry.encountered_genders',
            index=11,
            number=12,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.PokedexEntry.encountered_shiny',
            index=12,
            number=13,
            type=8,
            cpp_type=7,
...
_POKEDEXENTRY.fields_by_name[
    'pokemon_id'].enum_type = pogoprotos_dot_enums_dot_pokemon__id__pb2._POKEMONID
_POKEDEXENTRY.fields_by_name[
    'captured_costumes'].enum_type = pogoprotos_dot_enums_dot_costume__pb2._COSTUME
_POKEDEXENTRY.fields_by_name[
    'captured_forms'].enum_type = pogoprotos_dot_enums_dot_form__pb2._FORM
_POKEDEXENTRY.fields_by_name[
    'captured_genders'].enum_type = pogoprotos_dot_enums_dot_gender__pb2._GENDER
_POKEDEXENTRY.fields_by_name[
    'encountered_costumes'].enum_type = pogoprotos_dot_enums_dot_costume__pb2._COSTUME
_POKEDEXENTRY.fields_by_name[
    'encountered_forms'].enum_type = pogoprotos_dot_enums_dot_form__pb2._FORM
_POKEDEXENTRY.fields_by_name[
    'encountered_genders'].enum_type = pogoprotos_dot_enums_dot_gender__pb2._GENDER
DESCRIPTOR.message_types_by_name['PokedexEntry'] = _POKEDEXENTRY

PokedexEntry = _reflection.GeneratedProtocolMessageType(
    'PokedexEntry',
    (_message.Message, ),
    dict(
