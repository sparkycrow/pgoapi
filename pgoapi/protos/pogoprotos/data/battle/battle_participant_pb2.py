...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_data_dot_battle_dot_battle__pokemon__info__pb2.
        DESCRIPTOR,
        pogoprotos_dot_data_dot_player_dot_player__public__profile__pb2.
        DESCRIPTOR,
        pogoprotos_dot_map_dot_pokemon_dot_lobby__pokemon__pb2.DESCRIPTOR,
    ])
...
_BATTLEPARTICIPANT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='active_pokemon',
            full_name='pogoprotos.data.battle.BattleParticipant.active_pokemon',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.battle.BattleParticipant.trainer_public_profile',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.battle.BattleParticipant.reverse_pokemon',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.battle.BattleParticipant.defeated_pokemon',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='lobby_pokemon',
            full_name='pogoprotos.data.battle.BattleParticipant.lobby_pokemon',
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='damage_dealt',
            full_name='pogoprotos.data.battle.BattleParticipant.damage_dealt',
            index=5,
            number=6,
            type=5,
            cpp_type=1,
...
_BATTLEPARTICIPANT.fields_by_name[
    'active_pokemon'].message_type = pogoprotos_dot_data_dot_battle_dot_battle__pokemon__info__pb2._BATTLEPOKEMONINFO
_BATTLEPARTICIPANT.fields_by_name[
    'trainer_public_profile'].message_type = pogoprotos_dot_data_dot_player_dot_player__public__profile__pb2._PLAYERPUBLICPROFILE
_BATTLEPARTICIPANT.fields_by_name[
    'reverse_pokemon'].message_type = pogoprotos_dot_data_dot_battle_dot_battle__pokemon__info__pb2._BATTLEPOKEMONINFO
_BATTLEPARTICIPANT.fields_by_name[
    'defeated_pokemon'].message_type = pogoprotos_dot_data_dot_battle_dot_battle__pokemon__info__pb2._BATTLEPOKEMONINFO
_BATTLEPARTICIPANT.fields_by_name[
    'lobby_pokemon'].message_type = pogoprotos_dot_map_dot_pokemon_dot_lobby__pokemon__pb2._LOBBYPOKEMON
DESCRIPTOR.message_types_by_name['BattleParticipant'] = _BATTLEPARTICIPANT

BattleParticipant = _reflection.GeneratedProtocolMessageType(
    'BattleParticipant',
    (_message.Message, ),
    dict(
