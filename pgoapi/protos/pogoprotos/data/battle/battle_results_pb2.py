...
_BATTLERESULTS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='gym_state',
            full_name='pogoprotos.data.battle.BattleResults.gym_state',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='attackers',
            full_name='pogoprotos.data.battle.BattleResults.attackers',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.battle.BattleResults.player_experience_awarded',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.battle.BattleResults.next_defender_pokemon_id',
            index=3,
            number=4,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.battle.BattleResults.gym_points_delta',
            index=4,
            number=5,
            type=5,
            cpp_type=1,
...
_BATTLERESULTS.fields_by_name[
    'gym_state'].message_type = pogoprotos_dot_data_dot_gym_dot_gym__state__pb2._GYMSTATE
_BATTLERESULTS.fields_by_name[
    'attackers'].message_type = pogoprotos_dot_data_dot_battle_dot_battle__participant__pb2._BATTLEPARTICIPANT
DESCRIPTOR.message_types_by_name['BattleResults'] = _BATTLERESULTS

BattleResults = _reflection.GeneratedProtocolMessageType(
    'BattleResults',
    (_message.Message, ),
    dict(
