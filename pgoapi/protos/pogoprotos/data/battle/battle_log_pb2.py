...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_data_dot_battle_dot_battle__state__pb2.DESCRIPTOR,
        pogoprotos_dot_data_dot_battle_dot_battle__type__pb2.DESCRIPTOR,
        pogoprotos_dot_data_dot_battle_dot_battle__action__pb2.DESCRIPTOR,
    ])
...
_BATTLELOG = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='battle_type',
            full_name='pogoprotos.data.battle.BattleLog.battle_type',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='server_ms',
            full_name='pogoprotos.data.battle.BattleLog.server_ms',
            index=2,
            number=3,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='battle_actions',
            full_name='pogoprotos.data.battle.BattleLog.battle_actions',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.battle.BattleLog.battle_start_timestamp_ms',
            index=4,
            number=5,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.battle.BattleLog.battle_end_timestamp_ms',
            index=5,
            number=6,
            type=3,
            cpp_type=2,
...
_BATTLELOG.fields_by_name[
    'state'].enum_type = pogoprotos_dot_data_dot_battle_dot_battle__state__pb2._BATTLESTATE
_BATTLELOG.fields_by_name[
    'battle_type'].enum_type = pogoprotos_dot_data_dot_battle_dot_battle__type__pb2._BATTLETYPE
_BATTLELOG.fields_by_name[
    'battle_actions'].message_type = pogoprotos_dot_data_dot_battle_dot_battle__action__pb2._BATTLEACTION
DESCRIPTOR.message_types_by_name['BattleLog'] = _BATTLELOG

BattleLog = _reflection.GeneratedProtocolMessageType(
    'BattleLog',
    (_message.Message, ),
    dict(
