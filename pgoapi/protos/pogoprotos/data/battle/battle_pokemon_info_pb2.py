...
_BATTLEPOKEMONINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='pokemon_data',
            full_name='pogoprotos.data.battle.BattlePokemonInfo.pokemon_data',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='current_health',
            full_name='pogoprotos.data.battle.BattlePokemonInfo.current_health',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='current_energy',
            full_name='pogoprotos.data.battle.BattlePokemonInfo.current_energy',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
...
_BATTLEPOKEMONINFO.fields_by_name[
...
BattlePokemonInfo = _reflection.GeneratedProtocolMessageType(
    'BattlePokemonInfo',
    (_message.Message, ),
    dict(
