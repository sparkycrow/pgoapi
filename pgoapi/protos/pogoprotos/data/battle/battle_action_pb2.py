...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_data_dot_battle_dot_battle__results__pb2.DESCRIPTOR,
        pogoprotos_dot_data_dot_battle_dot_battle__action__type__pb2.
        DESCRIPTOR,
...
_BATTLEACTION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='type',
            full_name='pogoprotos.data.battle.BattleAction.type',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.battle.BattleAction.action_start_ms',
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='duration_ms',
            full_name='pogoprotos.data.battle.BattleAction.duration_ms',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='energy_delta',
            full_name='pogoprotos.data.battle.BattleAction.energy_delta',
            index=3,
            number=5,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='attacker_index',
            full_name='pogoprotos.data.battle.BattleAction.attacker_index',
            index=4,
            number=6,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='target_index',
            full_name='pogoprotos.data.battle.BattleAction.target_index',
            index=5,
            number=7,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.battle.BattleAction.active_pokemon_id',
            index=6,
            number=8,
            type=6,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='player_joined',
            full_name='pogoprotos.data.battle.BattleAction.player_joined',
            index=7,
            number=9,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='battle_results',
            full_name='pogoprotos.data.battle.BattleAction.battle_results',
            index=8,
            number=10,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.battle.BattleAction.damage_windows_start_timestamp_ms',
            index=9,
            number=11,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.battle.BattleAction.damage_windows_end_timestamp_ms',
            index=10,
            number=12,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='player_left',
            full_name='pogoprotos.data.battle.BattleAction.player_left',
            index=11,
            number=13,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.battle.BattleAction.target_pokemon_id',
            index=12,
            number=14,
            type=6,
            cpp_type=4,
...
_BATTLEACTION.fields_by_name[
    'type'].enum_type = pogoprotos_dot_data_dot_battle_dot_battle__action__type__pb2._BATTLEACTIONTYPE
_BATTLEACTION.fields_by_name[
    'player_joined'].message_type = pogoprotos_dot_data_dot_battle_dot_battle__participant__pb2._BATTLEPARTICIPANT
_BATTLEACTION.fields_by_name[
    'battle_results'].message_type = pogoprotos_dot_data_dot_battle_dot_battle__results__pb2._BATTLERESULTS
_BATTLEACTION.fields_by_name[
    'player_left'].message_type = pogoprotos_dot_data_dot_battle_dot_battle__participant__pb2._BATTLEPARTICIPANT
DESCRIPTOR.message_types_by_name['BattleAction'] = _BATTLEACTION

BattleAction = _reflection.GeneratedProtocolMessageType(
    'BattleAction',
    (_message.Message, ),
    dict(
