...
_BATTLE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.battle.Battle.battle_start_ms',
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='battle_end_ms',
            full_name='pogoprotos.data.battle.Battle.battle_end_ms',
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='battle_id',
            full_name='pogoprotos.data.battle.Battle.battle_id',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='defender',
            full_name='pogoprotos.data.battle.Battle.defender',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='battle_log',
            full_name='pogoprotos.data.battle.Battle.battle_log',
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='attacker',
            full_name='pogoprotos.data.battle.Battle.attacker',
            index=5,
            number=6,
            type=11,
            cpp_type=10,
...
Battle = _reflection.GeneratedProtocolMessageType(
    'Battle',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_BATTLE,
