...
_CATCHPOKEMONLOGENTRY_RESULT = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='POKEMON_FLED', index=2, number=2, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='POKEMON_HATCHED', index=3, number=3, options=None,
            type=None),
    ],
...
_CATCHPOKEMONLOGENTRY = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name='pogoprotos.data.logs.CatchPokemonLogEntry.pokemon_id',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='combat_points',
            full_name='pogoprotos.data.logs.CatchPokemonLogEntry.combat_points',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.logs.CatchPokemonLogEntry.pokemon_data_id',
            index=3,
            number=4,
            type=6,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.logs.CatchPokemonLogEntry.pokemon_display',
            index=4,
            number=5,
            type=11,
            cpp_type=10,
...
_CATCHPOKEMONLOGENTRY.fields_by_name[
    'result'].enum_type = _CATCHPOKEMONLOGENTRY_RESULT
_CATCHPOKEMONLOGENTRY.fields_by_name[
...
DESCRIPTOR.message_types_by_name[
    'CatchPokemonLogEntry'] = _CATCHPOKEMONLOGENTRY

CatchPokemonLogEntry = _reflection.GeneratedProtocolMessageType(
