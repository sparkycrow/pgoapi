...
_BUDDYPOKEMONLOGENTRY_RESULT = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name='CANDY_FOUND', index=1, number=1, options=None, type=None),
    ],
...
_BUDDYPOKEMONLOGENTRY = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name='pogoprotos.data.logs.BuddyPokemonLogEntry.pokemon_id',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='amount',
            full_name='pogoprotos.data.logs.BuddyPokemonLogEntry.amount',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.logs.BuddyPokemonLogEntry.pokemon_display',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='pokemon',
            full_name='pogoprotos.data.logs.BuddyPokemonLogEntry.pokemon',
            index=4,
            number=5,
            type=6,
            cpp_type=4,
...
_BUDDYPOKEMONLOGENTRY.fields_by_name[
    'result'].enum_type = _BUDDYPOKEMONLOGENTRY_RESULT
_BUDDYPOKEMONLOGENTRY.fields_by_name[
...
DESCRIPTOR.message_types_by_name[
    'BuddyPokemonLogEntry'] = _BUDDYPOKEMONLOGENTRY

BuddyPokemonLogEntry = _reflection.GeneratedProtocolMessageType(
