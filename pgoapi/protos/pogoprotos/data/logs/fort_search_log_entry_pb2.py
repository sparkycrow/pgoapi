...
_FORTSEARCHLOGENTRY = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='fort_id',
            full_name='pogoprotos.data.logs.FortSearchLogEntry.fort_id',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='items',
            full_name='pogoprotos.data.logs.FortSearchLogEntry.items',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='eggs',
            full_name='pogoprotos.data.logs.FortSearchLogEntry.eggs',
            index=3,
            number=4,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='pokemon_eggs',
            full_name='pogoprotos.data.logs.FortSearchLogEntry.pokemon_eggs',
            index=4,
            number=5,
            type=11,
            cpp_type=10,
...
_FORTSEARCHLOGENTRY.fields_by_name[
    'result'].enum_type = _FORTSEARCHLOGENTRY_RESULT
_FORTSEARCHLOGENTRY.fields_by_name[
    'items'].message_type = pogoprotos_dot_inventory_dot_item_dot_item__data__pb2._ITEMDATA
_FORTSEARCHLOGENTRY.fields_by_name[
    'pokemon_eggs'].message_type = pogoprotos_dot_data_dot_pokemon__data__pb2._POKEMONDATA
...
FortSearchLogEntry = _reflection.GeneratedProtocolMessageType(
    'FortSearchLogEntry',
    (_message.Message, ),
    dict(
