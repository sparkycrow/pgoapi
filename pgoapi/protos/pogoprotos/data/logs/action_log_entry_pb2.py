...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        DESCRIPTOR,
        pogoprotos_dot_data_dot_logs_dot_fort__search__log__entry__pb2.
        DESCRIPTOR,
        pogoprotos_dot_data_dot_logs_dot_buddy__pokemon__log__entry__pb2.
        DESCRIPTOR,
    ])
...
_ACTIONLOGENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='timestamp_ms',
            full_name='pogoprotos.data.logs.ActionLogEntry.timestamp_ms',
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='sfida',
            full_name='pogoprotos.data.logs.ActionLogEntry.sfida',
            index=1,
            number=2,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='catch_pokemon',
            full_name='pogoprotos.data.logs.ActionLogEntry.catch_pokemon',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='fort_search',
            full_name='pogoprotos.data.logs.ActionLogEntry.fort_search',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='buddy_pokemon',
            full_name='pogoprotos.data.logs.ActionLogEntry.buddy_pokemon',
            index=4,
            number=5,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name='Action',
            full_name='pogoprotos.data.logs.ActionLogEntry.Action',
            index=0,
            containing_type=None,
            fields=[]),
    ],
...
_ACTIONLOGENTRY.fields_by_name[
    'catch_pokemon'].message_type = pogoprotos_dot_data_dot_logs_dot_catch__pokemon__log__entry__pb2._CATCHPOKEMONLOGENTRY
_ACTIONLOGENTRY.fields_by_name[
    'fort_search'].message_type = pogoprotos_dot_data_dot_logs_dot_fort__search__log__entry__pb2._FORTSEARCHLOGENTRY
_ACTIONLOGENTRY.fields_by_name[
    'buddy_pokemon'].message_type = pogoprotos_dot_data_dot_logs_dot_buddy__pokemon__log__entry__pb2._BUDDYPOKEMONLOGENTRY
_ACTIONLOGENTRY.oneofs_by_name['Action'].fields.append(
    _ACTIONLOGENTRY.fields_by_name['catch_pokemon'])
_ACTIONLOGENTRY.fields_by_name[
    'catch_pokemon'].containing_oneof = _ACTIONLOGENTRY.oneofs_by_name[
        'Action']
_ACTIONLOGENTRY.oneofs_by_name['Action'].fields.append(
    _ACTIONLOGENTRY.fields_by_name['fort_search'])
_ACTIONLOGENTRY.fields_by_name[
    'fort_search'].containing_oneof = _ACTIONLOGENTRY.oneofs_by_name['Action']
_ACTIONLOGENTRY.oneofs_by_name['Action'].fields.append(
    _ACTIONLOGENTRY.fields_by_name['buddy_pokemon'])
_ACTIONLOGENTRY.fields_by_name[
    'buddy_pokemon'].containing_oneof = _ACTIONLOGENTRY.oneofs_by_name[
        'Action']
DESCRIPTOR.message_types_by_name['ActionLogEntry'] = _ACTIONLOGENTRY

ActionLogEntry = _reflection.GeneratedProtocolMessageType(
    'ActionLogEntry',
    (_message.Message, ),
    dict(
