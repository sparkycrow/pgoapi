...
_CAPTUREPROBABILITY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='pokeball_type',
            full_name=
            'pogoprotos.data.capture.CaptureProbability.pokeball_type',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.capture.CaptureProbability.capture_probability',
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.capture.CaptureProbability.reticle_difficulty_scale',
            index=2,
            number=12,
            type=1,
            cpp_type=5,
...
_CAPTUREPROBABILITY.fields_by_name[
    'pokeball_type'].enum_type = pogoprotos_dot_inventory_dot_item_dot_item__id__pb2._ITEMID
DESCRIPTOR.message_types_by_name['CaptureProbability'] = _CAPTUREPROBABILITY

CaptureProbability = _reflection.GeneratedProtocolMessageType(
    'CaptureProbability',
    (_message.Message, ),
    dict(
