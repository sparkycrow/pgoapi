...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_enums_dot_activity__type__pb2.DESCRIPTOR,
    ])
...
_CAPTUREAWARD = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='activity_type',
            full_name='pogoprotos.data.capture.CaptureAward.activity_type',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='xp',
            full_name='pogoprotos.data.capture.CaptureAward.xp',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='candy',
            full_name='pogoprotos.data.capture.CaptureAward.candy',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='stardust',
            full_name='pogoprotos.data.capture.CaptureAward.stardust',
            index=3,
            number=4,
            type=5,
            cpp_type=1,
...
_CAPTUREAWARD.fields_by_name[
    'activity_type'].enum_type = pogoprotos_dot_enums_dot_activity__type__pb2._ACTIVITYTYPE
DESCRIPTOR.message_types_by_name['CaptureAward'] = _CAPTUREAWARD

CaptureAward = _reflection.GeneratedProtocolMessageType(
    'CaptureAward',
    (_message.Message, ),
    dict(
...
_CAPTUREAWARD.fields_by_name[
    'activity_type']._options = _descriptor._ParseOptions(
        descriptor_pb2.FieldOptions(), _b('\020\001'))
_CAPTUREAWARD.fields_by_name['xp'].has_options = True
_CAPTUREAWARD.fields_by_name['xp']._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b('\020\001'))
_CAPTUREAWARD.fields_by_name['candy'].has_options = True
_CAPTUREAWARD.fields_by_name['candy']._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b('\020\001'))
_CAPTUREAWARD.fields_by_name['stardust'].has_options = True
_CAPTUREAWARD.fields_by_name['stardust']._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b('\020\001'))
