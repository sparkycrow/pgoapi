...
_AVATARCUSTOMIZATION_LABEL = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name='OWNED', index=2, number=2, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='FEATURED', index=3, number=3, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='NEW', index=4, number=4, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='SALE', index=5, number=5, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='PURCHASABLE', index=6, number=6, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='UNLOCKABLE', index=7, number=7, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='VIEWED', index=8, number=8, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='LOCKED_PURCHASABLE',
            index=9,
            number=9,
            options=None,
            type=None),
...
_AVATARCUSTOMIZATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.avatar.AvatarCustomization.avatar_template_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='labels',
            full_name='pogoprotos.data.avatar.AvatarCustomization.labels',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
...
_AVATARCUSTOMIZATION.fields_by_name[
    'labels'].enum_type = _AVATARCUSTOMIZATION_LABEL
...
AvatarCustomization = _reflection.GeneratedProtocolMessageType(
    'AvatarCustomization',
    (_message.Message, ),
    dict(
