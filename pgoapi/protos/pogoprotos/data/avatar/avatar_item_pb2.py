...
_AVATARITEM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.avatar.AvatarItem.avatar_template_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.avatar.AvatarItem.new_timestamp_ms',
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='viewed',
            full_name='pogoprotos.data.avatar.AvatarItem.viewed',
            index=2,
            number=3,
            type=8,
            cpp_type=7,
...
AvatarItem = _reflection.GeneratedProtocolMessageType(
    'AvatarItem',
    (_message.Message, ),
    dict(
