...
_RAID = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='raid_seed',
            full_name='pogoprotos.data.raid.Raid.raid_seed',
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='started_ms',
            full_name='pogoprotos.data.raid.Raid.started_ms',
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='completed_ms',
            full_name='pogoprotos.data.raid.Raid.completed_ms',
            index=2,
            number=3,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.raid.Raid.encounter_pokemon_id',
            index=3,
            number=4,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.raid.Raid.completed_battle',
            index=4,
            number=5,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.raid.Raid.received_rewards',
            index=5,
            number=6,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.raid.Raid.finished_encounter',
            index=6,
            number=7,
            type=8,
            cpp_type=7,
...
_RAID.fields_by_name[
    'encounter_pokemon_id'].enum_type = pogoprotos_dot_enums_dot_pokemon__id__pb2._POKEMONID
DESCRIPTOR.message_types_by_name['Raid'] = _RAID

Raid = _reflection.GeneratedProtocolMessageType(
    'Raid',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_RAID,
