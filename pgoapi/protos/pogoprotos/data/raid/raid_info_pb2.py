...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        pogoprotos_dot_enums_dot_raid__level__pb2.DESCRIPTOR,
    ])
...
_RAIDINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='raid_seed',
            full_name='pogoprotos.data.raid.RaidInfo.raid_seed',
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='raid_spawn_ms',
            full_name='pogoprotos.data.raid.RaidInfo.raid_spawn_ms',
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='raid_battle_ms',
            full_name='pogoprotos.data.raid.RaidInfo.raid_battle_ms',
            index=2,
            number=3,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='raid_end_ms',
            full_name='pogoprotos.data.raid.RaidInfo.raid_end_ms',
            index=3,
            number=4,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='raid_pokemon',
            full_name='pogoprotos.data.raid.RaidInfo.raid_pokemon',
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='raid_level',
            full_name='pogoprotos.data.raid.RaidInfo.raid_level',
            index=5,
            number=6,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='complete',
            full_name='pogoprotos.data.raid.RaidInfo.complete',
            index=6,
            number=7,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='is_exclusive',
            full_name='pogoprotos.data.raid.RaidInfo.is_exclusive',
            index=7,
            number=8,
            type=8,
            cpp_type=7,
...
_RAIDINFO.fields_by_name[
    'raid_pokemon'].message_type = pogoprotos_dot_data_dot_pokemon__data__pb2._POKEMONDATA
_RAIDINFO.fields_by_name[
    'raid_level'].enum_type = pogoprotos_dot_enums_dot_raid__level__pb2._RAIDLEVEL
DESCRIPTOR.message_types_by_name['RaidInfo'] = _RAIDINFO

RaidInfo = _reflection.GeneratedProtocolMessageType(
    'RaidInfo',
    (_message.Message, ),
    dict(
