...
_DAILYBONUS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.player.DailyBonus.next_collected_timestamp_ms',
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.player.DailyBonus.next_defender_bonus_collect_timestamp_ms',
            index=1,
            number=2,
            type=3,
            cpp_type=2,
...
DailyBonus = _reflection.GeneratedProtocolMessageType(
    'DailyBonus',
    (_message.Message, ),
    dict(
