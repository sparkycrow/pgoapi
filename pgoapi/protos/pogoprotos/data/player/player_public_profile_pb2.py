...
_PLAYERPUBLICPROFILE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='name',
            full_name='pogoprotos.data.player.PlayerPublicProfile.name',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='level',
            full_name='pogoprotos.data.player.PlayerPublicProfile.level',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='avatar',
            full_name='pogoprotos.data.player.PlayerPublicProfile.avatar',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='team_color',
            full_name='pogoprotos.data.player.PlayerPublicProfile.team_color',
            index=3,
            number=4,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='battles_won',
            full_name='pogoprotos.data.player.PlayerPublicProfile.battles_won',
            index=4,
            number=5,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='km_walked',
            full_name='pogoprotos.data.player.PlayerPublicProfile.km_walked',
            index=5,
            number=6,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='caught_pokemon',
            full_name=
            'pogoprotos.data.player.PlayerPublicProfile.caught_pokemon',
            index=6,
            number=7,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='gym_badge_type',
            full_name=
            'pogoprotos.data.player.PlayerPublicProfile.gym_badge_type',
            index=7,
            number=8,
            type=14,
            cpp_type=8,
...
_PLAYERPUBLICPROFILE.fields_by_name[
...
PlayerPublicProfile = _reflection.GeneratedProtocolMessageType(
    'PlayerPublicProfile',
    (_message.Message, ),
    dict(
