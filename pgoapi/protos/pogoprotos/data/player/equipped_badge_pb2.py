...
_EQUIPPEDBADGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='badge_type',
            full_name='pogoprotos.data.player.EquippedBadge.badge_type',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='level',
            full_name='pogoprotos.data.player.EquippedBadge.level',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.player.EquippedBadge.next_equip_change_allowed_timestamp_ms',
            index=2,
            number=3,
            type=3,
            cpp_type=2,
...
EquippedBadge = _reflection.GeneratedProtocolMessageType(
    'EquippedBadge',
    (_message.Message, ),
    dict(
