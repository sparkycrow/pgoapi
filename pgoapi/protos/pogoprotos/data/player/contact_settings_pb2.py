...
_CONTACTSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.player.ContactSettings.send_marketing_emails',
            index=0,
            number=1,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.player.ContactSettings.send_push_notifications',
            index=1,
            number=2,
            type=8,
            cpp_type=7,
...
ContactSettings = _reflection.GeneratedProtocolMessageType(
    'ContactSettings',
    (_message.Message, ),
    dict(
