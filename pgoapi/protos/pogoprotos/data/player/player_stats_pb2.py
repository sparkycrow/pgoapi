...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_enums_dot_gym__badge__type__pb2.DESCRIPTOR,
    ])
...
_PLAYERSTATS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='level',
            full_name='pogoprotos.data.player.PlayerStats.level',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='experience',
            full_name='pogoprotos.data.player.PlayerStats.experience',
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='prev_level_xp',
            full_name='pogoprotos.data.player.PlayerStats.prev_level_xp',
            index=2,
            number=3,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='next_level_xp',
            full_name='pogoprotos.data.player.PlayerStats.next_level_xp',
            index=3,
            number=4,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.player.PlayerStats.pokemons_encountered',
            index=5,
            number=6,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.player.PlayerStats.unique_pokedex_entries',
            index=6,
            number=7,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.player.PlayerStats.pokemons_captured',
            index=7,
            number=8,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='evolutions',
            full_name='pogoprotos.data.player.PlayerStats.evolutions',
            index=8,
            number=9,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.player.PlayerStats.poke_stop_visits',
            index=9,
            number=10,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.player.PlayerStats.pokeballs_thrown',
            index=10,
            number=11,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='eggs_hatched',
            full_name='pogoprotos.data.player.PlayerStats.eggs_hatched',
            index=11,
            number=12,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.player.PlayerStats.big_magikarp_caught',
            index=12,
            number=13,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.player.PlayerStats.battle_attack_won',
            index=13,
            number=14,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.player.PlayerStats.battle_attack_total',
            index=14,
            number=15,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.player.PlayerStats.battle_defended_won',
            index=15,
            number=16,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.player.PlayerStats.battle_training_won',
            index=16,
            number=17,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.player.PlayerStats.battle_training_total',
            index=17,
            number=18,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.player.PlayerStats.prestige_raised_total',
            index=18,
            number=19,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.player.PlayerStats.prestige_dropped_total',
            index=19,
            number=20,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.player.PlayerStats.pokemon_deployed',
            index=20,
            number=21,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.player.PlayerStats.pokemon_caught_by_type',
            index=21,
            number=22,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.player.PlayerStats.small_rattata_caught',
            index=22,
            number=23,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='used_km_pool',
            full_name='pogoprotos.data.player.PlayerStats.used_km_pool',
            index=23,
            number=24,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.player.PlayerStats.last_km_refill_ms',
            index=24,
            number=25,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.player.PlayerStats.num_raid_battle_won',
            index=25,
            number=26,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.player.PlayerStats.num_raid_battle_total',
            index=26,
            number=27,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.player.PlayerStats.num_legendary_battle_won',
            index=27,
            number=28,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.player.PlayerStats.num_legendary_battle_total',
            index=28,
            number=29,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.player.PlayerStats.num_berries_fed',
            index=29,
            number=30,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.player.PlayerStats.total_defended_ms',
            index=30,
            number=31,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='event_badges',
            full_name='pogoprotos.data.player.PlayerStats.event_badges',
            index=31,
            number=32,
            type=14,
            cpp_type=8,
...
_PLAYERSTATS.fields_by_name[
    'event_badges'].enum_type = pogoprotos_dot_enums_dot_gym__badge__type__pb2._GYMBADGETYPE
