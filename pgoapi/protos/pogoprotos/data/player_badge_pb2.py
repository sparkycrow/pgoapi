...
_PLAYERBADGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='badge_type',
            full_name='pogoprotos.data.PlayerBadge.badge_type',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='rank',
            full_name='pogoprotos.data.PlayerBadge.rank',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='start_value',
            full_name='pogoprotos.data.PlayerBadge.start_value',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='end_value',
            full_name='pogoprotos.data.PlayerBadge.end_value',
            index=3,
            number=4,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='current_value',
            full_name='pogoprotos.data.PlayerBadge.current_value',
            index=4,
            number=5,
            type=1,
            cpp_type=5,
...
PlayerBadge = _reflection.GeneratedProtocolMessageType(
    'PlayerBadge',
    (_message.Message, ),
    dict(
