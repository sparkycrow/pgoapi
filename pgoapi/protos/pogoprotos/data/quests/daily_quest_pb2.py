...
_DAILYQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.quests.DailyQuest.current_period_bucket',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.quests.DailyQuest.current_streak_count',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
DailyQuest = _reflection.GeneratedProtocolMessageType(
    'DailyQuest',
    (_message.Message, ),
    dict(
