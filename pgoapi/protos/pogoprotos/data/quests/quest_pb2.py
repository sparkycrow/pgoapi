...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        pogoprotos_dot_data_dot_quests_dot_daily__quest__pb2.DESCRIPTOR,
    ])
...
_QUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='quest_type',
            full_name='pogoprotos.data.quests.Quest.quest_type',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='daily_quest',
            full_name='pogoprotos.data.quests.Quest.daily_quest',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_QUEST.fields_by_name[
    'quest_type'].enum_type = pogoprotos_dot_enums_dot_quest__type__pb2._QUESTTYPE
_QUEST.fields_by_name[
    'daily_quest'].message_type = pogoprotos_dot_data_dot_quests_dot_daily__quest__pb2._DAILYQUEST
DESCRIPTOR.message_types_by_name['Quest'] = _QUEST

Quest = _reflection.GeneratedProtocolMessageType(
    'Quest',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_QUEST,
