...
_FOODVALUE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.FoodValue.motivation_increase',
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='cp_increase',
            full_name='pogoprotos.data.FoodValue.cp_increase',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='food_item',
            full_name='pogoprotos.data.FoodValue.food_item',
            index=2,
            number=3,
            type=14,
            cpp_type=8,
...
_FOODVALUE.fields_by_name[
    'food_item'].enum_type = pogoprotos_dot_inventory_dot_item_dot_item__id__pb2._ITEMID
DESCRIPTOR.message_types_by_name['FoodValue'] = _FOODVALUE

FoodValue = _reflection.GeneratedProtocolMessageType(
    'FoodValue',
    (_message.Message, ),
    dict(
