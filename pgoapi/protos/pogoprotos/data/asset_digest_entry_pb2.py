...
_ASSETDIGESTENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='asset_id',
            full_name='pogoprotos.data.AssetDigestEntry.asset_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='bundle_name',
            full_name='pogoprotos.data.AssetDigestEntry.bundle_name',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='version',
            full_name='pogoprotos.data.AssetDigestEntry.version',
            index=2,
            number=3,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='checksum',
            full_name='pogoprotos.data.AssetDigestEntry.checksum',
            index=3,
            number=4,
            type=7,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='size',
            full_name='pogoprotos.data.AssetDigestEntry.size',
            index=4,
            number=5,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='key',
            full_name='pogoprotos.data.AssetDigestEntry.key',
            index=5,
            number=6,
            type=12,
            cpp_type=9,
...
AssetDigestEntry = _reflection.GeneratedProtocolMessageType(
    'AssetDigestEntry',
    (_message.Message, ),
    dict(
