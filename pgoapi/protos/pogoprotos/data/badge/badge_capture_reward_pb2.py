...
_BADGECAPTUREREWARD = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.badge.BadgeCaptureReward.capture_reward_multiplier',
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.data.badge.BadgeCaptureReward.avatar_template_ids',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
BadgeCaptureReward = _reflection.GeneratedProtocolMessageType(
    'BadgeCaptureReward',
    (_message.Message, ),
    dict(
