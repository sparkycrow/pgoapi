...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_enums_dot_tutorial__state__pb2.DESCRIPTOR,
        pogoprotos_dot_data_dot_player_dot_player__avatar__pb2.DESCRIPTOR,
        pogoprotos_dot_data_dot_player_dot_daily__bonus__pb2.DESCRIPTOR,
        pogoprotos_dot_data_dot_player_dot_equipped__badge__pb2.DESCRIPTOR,
        pogoprotos_dot_data_dot_player_dot_contact__settings__pb2.DESCRIPTOR,
        pogoprotos_dot_data_dot_player_dot_currency__pb2.DESCRIPTOR,
        pogoprotos_dot_data_dot_buddy__pokemon__pb2.DESCRIPTOR,
...
_PLAYERDATA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.PlayerData.creation_timestamp_ms',
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='username',
            full_name='pogoprotos.data.PlayerData.username',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='team',
            full_name='pogoprotos.data.PlayerData.team',
            index=2,
            number=5,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='tutorial_state',
            full_name='pogoprotos.data.PlayerData.tutorial_state',
            index=3,
            number=7,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='avatar',
            full_name='pogoprotos.data.PlayerData.avatar',
            index=4,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.PlayerData.max_pokemon_storage',
            index=5,
            number=9,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.PlayerData.max_item_storage',
            index=6,
            number=10,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='daily_bonus',
            full_name='pogoprotos.data.PlayerData.daily_bonus',
            index=7,
            number=11,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='equipped_badge',
            full_name='pogoprotos.data.PlayerData.equipped_badge',
            index=8,
            number=12,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.PlayerData.contact_settings',
            index=9,
            number=13,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='currencies',
            full_name='pogoprotos.data.PlayerData.currencies',
            index=10,
            number=14,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.PlayerData.remaining_codename_claims',
            index=11,
            number=15,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='buddy_pokemon',
            full_name='pogoprotos.data.PlayerData.buddy_pokemon',
            index=12,
            number=16,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.PlayerData.battle_lockout_end_ms',
            index=13,
            number=17,
            type=3,
            cpp_type=2,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='secondary_player_avatar',
            full_name='pogoprotos.data.PlayerData.secondary_player_avatar',
            index=14,
            number=18,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.data.PlayerData.name_is_blacklisted',
            index=15,
            number=19,
            type=8,
            cpp_type=7,
...
_PLAYERDATA.fields_by_name[
    'team'].enum_type = pogoprotos_dot_enums_dot_team__color__pb2._TEAMCOLOR
_PLAYERDATA.fields_by_name[
    'tutorial_state'].enum_type = pogoprotos_dot_enums_dot_tutorial__state__pb2._TUTORIALSTATE
_PLAYERDATA.fields_by_name[
    'avatar'].message_type = pogoprotos_dot_data_dot_player_dot_player__avatar__pb2._PLAYERAVATAR
_PLAYERDATA.fields_by_name[
    'daily_bonus'].message_type = pogoprotos_dot_data_dot_player_dot_daily__bonus__pb2._DAILYBONUS
_PLAYERDATA.fields_by_name[
    'equipped_badge'].message_type = pogoprotos_dot_data_dot_player_dot_equipped__badge__pb2._EQUIPPEDBADGE
_PLAYERDATA.fields_by_name[
    'contact_settings'].message_type = pogoprotos_dot_data_dot_player_dot_contact__settings__pb2._CONTACTSETTINGS
_PLAYERDATA.fields_by_name[
    'currencies'].message_type = pogoprotos_dot_data_dot_player_dot_currency__pb2._CURRENCY
_PLAYERDATA.fields_by_name[
    'buddy_pokemon'].message_type = pogoprotos_dot_data_dot_buddy__pokemon__pb2._BUDDYPOKEMON
_PLAYERDATA.fields_by_name[
    'secondary_player_avatar'].message_type = pogoprotos_dot_data_dot_player_dot_player__avatar__pb2._PLAYERAVATAR
DESCRIPTOR.message_types_by_name['PlayerData'] = _PLAYERDATA

PlayerData = _reflection.GeneratedProtocolMessageType(
    'PlayerData',
    (_message.Message, ),
    dict(
...
_PLAYERDATA.fields_by_name[
    'tutorial_state']._options = _descriptor._ParseOptions(
