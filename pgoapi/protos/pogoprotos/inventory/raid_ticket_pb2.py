...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        pogoprotos_dot_inventory_dot_exclusive__ticket__info__pb2.DESCRIPTOR,
    ])
...
_RAIDTICKET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='ticket_id',
            full_name='pogoprotos.inventory.RaidTicket.ticket_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='item',
            full_name='pogoprotos.inventory.RaidTicket.item',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='exclusive_info',
            full_name='pogoprotos.inventory.RaidTicket.exclusive_info',
            index=2,
            number=4,
            type=11,
            cpp_type=10,
...
_RAIDTICKET.fields_by_name[
    'exclusive_info'].message_type = pogoprotos_dot_inventory_dot_exclusive__ticket__info__pb2._EXCLUSIVETICKETINFO
DESCRIPTOR.message_types_by_name['RaidTicket'] = _RAIDTICKET

RaidTicket = _reflection.GeneratedProtocolMessageType(
    'RaidTicket',
    (_message.Message, ),
    dict(
