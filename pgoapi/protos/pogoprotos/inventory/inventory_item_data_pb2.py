...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_inventory_dot_item_dot_item__data__pb2.DESCRIPTOR,
        pogoprotos_dot_inventory_dot_applied__items__pb2.DESCRIPTOR,
        pogoprotos_dot_inventory_dot_egg__incubators__pb2.DESCRIPTOR,
        pogoprotos_dot_inventory_dot_candy__pb2.DESCRIPTOR,
        pogoprotos_dot_inventory_dot_inventory__upgrades__pb2.DESCRIPTOR,
        pogoprotos_dot_inventory_dot_raid__tickets__pb2.DESCRIPTOR,
        pogoprotos_dot_data_dot_avatar_dot_avatar__item__pb2.DESCRIPTOR,
        pogoprotos_dot_data_dot_pokemon__data__pb2.DESCRIPTOR,
        pogoprotos_dot_data_dot_pokedex__entry__pb2.DESCRIPTOR,
        pogoprotos_dot_data_dot_player_dot_player__stats__pb2.DESCRIPTOR,
        pogoprotos_dot_data_dot_player_dot_player__currency__pb2.DESCRIPTOR,
        pogoprotos_dot_data_dot_player_dot_player__camera__pb2.DESCRIPTOR,
        pogoprotos_dot_data_dot_quests_dot_quest__pb2.DESCRIPTOR,
    ])
...
_INVENTORYITEMDATA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='pokemon_data',
            full_name='pogoprotos.inventory.InventoryItemData.pokemon_data',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='item',
            full_name='pogoprotos.inventory.InventoryItemData.item',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='pokedex_entry',
            full_name='pogoprotos.inventory.InventoryItemData.pokedex_entry',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='player_stats',
            full_name='pogoprotos.inventory.InventoryItemData.player_stats',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.inventory.InventoryItemData.player_currency',
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='player_camera',
            full_name='pogoprotos.inventory.InventoryItemData.player_camera',
            index=5,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='applied_items',
            full_name='pogoprotos.inventory.InventoryItemData.applied_items',
            index=7,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='egg_incubators',
            full_name='pogoprotos.inventory.InventoryItemData.egg_incubators',
            index=8,
            number=9,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='candy',
            full_name='pogoprotos.inventory.InventoryItemData.candy',
            index=9,
            number=10,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='quest',
            full_name='pogoprotos.inventory.InventoryItemData.quest',
            index=10,
            number=11,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='raid_tickets',
            full_name='pogoprotos.inventory.InventoryItemData.raid_tickets',
            index=12,
            number=13,
            type=11,
            cpp_type=10,
...
_INVENTORYITEMDATA.fields_by_name[
    'pokemon_data'].message_type = pogoprotos_dot_data_dot_pokemon__data__pb2._POKEMONDATA
_INVENTORYITEMDATA.fields_by_name[
    'item'].message_type = pogoprotos_dot_inventory_dot_item_dot_item__data__pb2._ITEMDATA
_INVENTORYITEMDATA.fields_by_name[
    'pokedex_entry'].message_type = pogoprotos_dot_data_dot_pokedex__entry__pb2._POKEDEXENTRY
_INVENTORYITEMDATA.fields_by_name[
    'player_stats'].message_type = pogoprotos_dot_data_dot_player_dot_player__stats__pb2._PLAYERSTATS
_INVENTORYITEMDATA.fields_by_name[
    'player_currency'].message_type = pogoprotos_dot_data_dot_player_dot_player__currency__pb2._PLAYERCURRENCY
_INVENTORYITEMDATA.fields_by_name[
    'player_camera'].message_type = pogoprotos_dot_data_dot_player_dot_player__camera__pb2._PLAYERCAMERA
_INVENTORYITEMDATA.fields_by_name[
    'inventory_upgrades'].message_type = pogoprotos_dot_inventory_dot_inventory__upgrades__pb2._INVENTORYUPGRADES
_INVENTORYITEMDATA.fields_by_name[
    'applied_items'].message_type = pogoprotos_dot_inventory_dot_applied__items__pb2._APPLIEDITEMS
_INVENTORYITEMDATA.fields_by_name[
    'egg_incubators'].message_type = pogoprotos_dot_inventory_dot_egg__incubators__pb2._EGGINCUBATORS
_INVENTORYITEMDATA.fields_by_name[
    'candy'].message_type = pogoprotos_dot_inventory_dot_candy__pb2._CANDY
_INVENTORYITEMDATA.fields_by_name[
    'quest'].message_type = pogoprotos_dot_data_dot_quests_dot_quest__pb2._QUEST
_INVENTORYITEMDATA.fields_by_name[
    'avatar_item'].message_type = pogoprotos_dot_data_dot_avatar_dot_avatar__item__pb2._AVATARITEM
_INVENTORYITEMDATA.fields_by_name[
    'raid_tickets'].message_type = pogoprotos_dot_inventory_dot_raid__tickets__pb2._RAIDTICKETS
DESCRIPTOR.message_types_by_name['InventoryItemData'] = _INVENTORYITEMDATA

InventoryItemData = _reflection.GeneratedProtocolMessageType(
    'InventoryItemData',
    (_message.Message, ),
    dict(
