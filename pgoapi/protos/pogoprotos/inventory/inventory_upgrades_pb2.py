...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_inventory_dot_inventory__upgrade__pb2.DESCRIPTOR,
    ])
...
_INVENTORYUPGRADES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.inventory.InventoryUpgrades.inventory_upgrades',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_INVENTORYUPGRADES.fields_by_name[
    'inventory_upgrades'].message_type = pogoprotos_dot_inventory_dot_inventory__upgrade__pb2._INVENTORYUPGRADE
DESCRIPTOR.message_types_by_name['InventoryUpgrades'] = _INVENTORYUPGRADES

InventoryUpgrades = _reflection.GeneratedProtocolMessageType(
    'InventoryUpgrades',
    (_message.Message, ),
    dict(
