...
_ITEMDATA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='item_id',
            full_name='pogoprotos.inventory.item.ItemData.item_id',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='count',
            full_name='pogoprotos.inventory.item.ItemData.count',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='unseen',
            full_name='pogoprotos.inventory.item.ItemData.unseen',
            index=2,
            number=3,
            type=8,
            cpp_type=7,
...
ItemData = _reflection.GeneratedProtocolMessageType(
    'ItemData',
    (_message.Message, ),
    dict(
