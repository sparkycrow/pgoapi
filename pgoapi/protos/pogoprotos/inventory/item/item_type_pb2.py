...
_ITEMTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name='ITEM_TYPE_NONE', index=0, number=0, options=None, type=None),
        _descriptor.EnumValueDescriptor(
        ...
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='ITEM_TYPE_MAP', index=4, number=4, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='ITEM_TYPE_FOOD', index=6, number=6, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='ITEM_TYPE_DISK', index=8, number=8, options=None, type=None),
        _descriptor.EnumValueDescriptor(
        ...
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='ITEM_TYPE_EVOLUTION_REQUIREMENT',
            index=13,
            number=13,
            options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='ITEM_TYPE_MOVE_REROLL',
            index=14,
            number=14,
            options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='ITEM_TYPE_CANDY',
            index=15,
            number=15,
            options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='ITEM_TYPE_RAID_TICKET',
            index=16,
            number=16,
            options=None,
            type=None),
