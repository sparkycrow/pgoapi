...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_inventory_dot_inventory__item__pb2.DESCRIPTOR,
    ])
...
_INVENTORYDELTA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.inventory.InventoryDelta.original_timestamp_ms',
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.inventory.InventoryDelta.new_timestamp_ms',
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.inventory.InventoryDelta.inventory_items',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_INVENTORYDELTA.fields_by_name[
    'inventory_items'].message_type = pogoprotos_dot_inventory_dot_inventory__item__pb2._INVENTORYITEM
DESCRIPTOR.message_types_by_name['InventoryDelta'] = _INVENTORYDELTA

InventoryDelta = _reflection.GeneratedProtocolMessageType(
    'InventoryDelta',
    (_message.Message, ),
    dict(
