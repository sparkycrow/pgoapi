...
_INVENTORYUPGRADE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='item_id',
            full_name='pogoprotos.inventory.InventoryUpgrade.item_id',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='upgrade_type',
            full_name='pogoprotos.inventory.InventoryUpgrade.upgrade_type',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.inventory.InventoryUpgrade.additional_storage',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
...
_INVENTORYUPGRADE.fields_by_name[
...
InventoryUpgrade = _reflection.GeneratedProtocolMessageType(
    'InventoryUpgrade',
    (_message.Message, ),
    dict(
