...
_APPLIEDITEMS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='item',
            full_name='pogoprotos.inventory.AppliedItems.item',
            index=0,
            number=4,
            type=11,
            cpp_type=10,
...
_APPLIEDITEMS.fields_by_name[
    'item'].message_type = pogoprotos_dot_inventory_dot_applied__item__pb2._APPLIEDITEM
DESCRIPTOR.message_types_by_name['AppliedItems'] = _APPLIEDITEMS

AppliedItems = _reflection.GeneratedProtocolMessageType(
    'AppliedItems',
    (_message.Message, ),
    dict(
