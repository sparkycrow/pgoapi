...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_enums_dot_quest__type__pb2.DESCRIPTOR,
...
_INVENTORYKEY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name='pogoprotos.inventory.InventoryKey.pokemon_id',
            index=0,
            number=1,
            type=6,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='item',
            full_name='pogoprotos.inventory.InventoryKey.item',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.inventory.InventoryKey.pokedex_entry_id',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='player_stats',
            full_name='pogoprotos.inventory.InventoryKey.player_stats',
            index=3,
            number=4,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.inventory.InventoryKey.player_currency',
            index=4,
            number=5,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.inventory.InventoryKey.inventory_upgrades',
            index=6,
            number=7,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='applied_items',
            full_name='pogoprotos.inventory.InventoryKey.applied_items',
            index=7,
            number=8,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='egg_incubators',
            full_name='pogoprotos.inventory.InventoryKey.egg_incubators',
            index=8,
            number=9,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.inventory.InventoryKey.pokemon_family_id',
            index=9,
            number=10,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='quest_type',
            full_name='pogoprotos.inventory.InventoryKey.quest_type',
            index=10,
            number=11,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.inventory.InventoryKey.avatar_template_id',
            index=11,
            number=12,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='raid_tickets',
            full_name='pogoprotos.inventory.InventoryKey.raid_tickets',
            index=12,
            number=13,
            type=8,
            cpp_type=7,
...
_INVENTORYKEY.fields_by_name[
    'item'].enum_type = pogoprotos_dot_inventory_dot_item_dot_item__id__pb2._ITEMID
_INVENTORYKEY.fields_by_name[
    'pokemon_family_id'].enum_type = pogoprotos_dot_enums_dot_pokemon__family__id__pb2._POKEMONFAMILYID
_INVENTORYKEY.fields_by_name[
    'quest_type'].enum_type = pogoprotos_dot_enums_dot_quest__type__pb2._QUESTTYPE
DESCRIPTOR.message_types_by_name['InventoryKey'] = _INVENTORYKEY

InventoryKey = _reflection.GeneratedProtocolMessageType(
    'InventoryKey',
    (_message.Message, ),
    dict(
