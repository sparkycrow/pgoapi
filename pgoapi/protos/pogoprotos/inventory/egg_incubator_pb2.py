...
_EGGINCUBATOR = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='id',
            full_name='pogoprotos.inventory.EggIncubator.id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='item_id',
            full_name='pogoprotos.inventory.EggIncubator.item_id',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='incubator_type',
            full_name='pogoprotos.inventory.EggIncubator.incubator_type',
            index=2,
            number=3,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='uses_remaining',
            full_name='pogoprotos.inventory.EggIncubator.uses_remaining',
            index=3,
            number=4,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name='pogoprotos.inventory.EggIncubator.pokemon_id',
            index=4,
            number=5,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.inventory.EggIncubator.start_km_walked',
            index=5,
            number=6,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.inventory.EggIncubator.target_km_walked',
            index=6,
            number=7,
            type=1,
            cpp_type=5,
...
EggIncubator = _reflection.GeneratedProtocolMessageType(
    'EggIncubator',
    (_message.Message, ),
    dict(
