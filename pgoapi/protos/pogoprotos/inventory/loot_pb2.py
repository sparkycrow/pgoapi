...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_inventory_dot_loot__item__pb2.DESCRIPTOR,
    ])
...
_LOOT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='loot_item',
            full_name='pogoprotos.inventory.Loot.loot_item',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_LOOT.fields_by_name[
    'loot_item'].message_type = pogoprotos_dot_inventory_dot_loot__item__pb2._LOOTITEM
