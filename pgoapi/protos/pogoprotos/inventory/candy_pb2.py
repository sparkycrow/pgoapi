...
_CANDY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='family_id',
            full_name='pogoprotos.inventory.Candy.family_id',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='candy',
            full_name='pogoprotos.inventory.Candy.candy',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
Candy = _reflection.GeneratedProtocolMessageType(
    'Candy',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_CANDY,
