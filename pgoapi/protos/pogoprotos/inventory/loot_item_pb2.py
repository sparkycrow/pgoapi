...
_LOOTITEM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='item',
            full_name='pogoprotos.inventory.LootItem.item',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='stardust',
            full_name='pogoprotos.inventory.LootItem.stardust',
            index=1,
            number=2,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='pokecoin',
            full_name='pogoprotos.inventory.LootItem.pokecoin',
            index=2,
            number=3,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='pokemon_candy',
            full_name='pogoprotos.inventory.LootItem.pokemon_candy',
            index=3,
            number=4,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='count',
            full_name='pogoprotos.inventory.LootItem.count',
            index=4,
            number=5,
            type=5,
            cpp_type=1,
...
_LOOTITEM.fields_by_name[
    'pokemon_candy'].enum_type = pogoprotos_dot_enums_dot_pokemon__id__pb2._POKEMONID
DESCRIPTOR.message_types_by_name['LootItem'] = _LOOTITEM

LootItem = _reflection.GeneratedProtocolMessageType(
    'LootItem',
    (_message.Message, ),
    dict(
