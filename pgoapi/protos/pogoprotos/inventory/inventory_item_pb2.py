...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        pogoprotos_dot_inventory_dot_inventory__item__data__pb2.DESCRIPTOR,
    ])
...
_INVENTORYITEM_DELETEDITEM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='pokemon_id',
            full_name=
            'pogoprotos.inventory.InventoryItem.DeletedItem.pokemon_id',
            index=0,
            number=1,
            type=6,
            cpp_type=4,
...
_INVENTORYITEM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'pogoprotos.inventory.InventoryItem.modified_timestamp_ms',
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='deleted_item',
            full_name='pogoprotos.inventory.InventoryItem.deleted_item',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='pogoprotos.inventory.InventoryItem.inventory_item_data',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_INVENTORYITEM.fields_by_name[
    'deleted_item'].message_type = _INVENTORYITEM_DELETEDITEM
_INVENTORYITEM.fields_by_name[
    'inventory_item_data'].message_type = pogoprotos_dot_inventory_dot_inventory__item__data__pb2._INVENTORYITEMDATA
...
InventoryItem = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message, ),
    dict(
        DeletedItem=_reflection.GeneratedProtocolMessageType(
            'DeletedItem',
            (_message.Message, ),
            dict(
