...
_EXCLUSIVETICKETINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='raid_seed',
            full_name='pogoprotos.inventory.ExclusiveTicketInfo.raid_seed',
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='fort_id',
            full_name='pogoprotos.inventory.ExclusiveTicketInfo.fort_id',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='description',
            full_name='pogoprotos.inventory.ExclusiveTicketInfo.description',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='start_time_ms',
            full_name='pogoprotos.inventory.ExclusiveTicketInfo.start_time_ms',
            index=3,
            number=4,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='end_time_ms',
            full_name='pogoprotos.inventory.ExclusiveTicketInfo.end_time_ms',
            index=4,
            number=5,
            type=3,
            cpp_type=2,
...
ExclusiveTicketInfo = _reflection.GeneratedProtocolMessageType(
    'ExclusiveTicketInfo',
    (_message.Message, ),
    dict(
