...
_RAIDLEVEL = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name='RAID_LEVEL_UNSET',
            index=0,
            number=0,
            options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='RAID_LEVEL_1', index=1, number=1, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='RAID_LEVEL_2', index=2, number=2, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='RAID_LEVEL_3', index=3, number=3, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='RAID_LEVEL_4', index=4, number=4, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='RAID_LEVEL_5', index=5, number=5, options=None, type=None),
    ],
