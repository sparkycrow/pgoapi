...
_GYMBADGETYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name='GYM_BADGE_UNSET', index=0, number=0, options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='GYM_BADGE_VANILLA',
            index=1,
            number=1,
            options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='GYM_BADGE_BRONZE',
            index=2,
            number=2,
            options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='GYM_BADGE_SILVER',
            index=3,
            number=3,
            options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='GYM_BADGE_GOLD', index=4, number=4, options=None, type=None),
    ],
