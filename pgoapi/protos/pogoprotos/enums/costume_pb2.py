...
_COSTUME = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name='COSTUME_UNSET', index=0, number=0, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='HOLIDAY_2016', index=1, number=1, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='ANNIVERSARY', index=2, number=2, options=None, type=None),
    ],
