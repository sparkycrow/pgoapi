...
_ENCOUNTERTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name='SPAWN_POINT', index=0, number=0, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='INCENSE', index=1, number=1, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='DISK', index=2, number=2, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='POST_RAID', index=3, number=3, options=None, type=None),
    ],
