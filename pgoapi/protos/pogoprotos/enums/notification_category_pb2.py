...
_NOTIFICATIONCATEGORY = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name='UNSET_NotificationCategory',
            index=0,
            number=0,
            options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='GYM_REMOVAL', index=1, number=1, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='POKEMON_HUNGRY', index=2, number=2, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='POKEMON_WON', index=3, number=3, options=None, type=None),
    ],
