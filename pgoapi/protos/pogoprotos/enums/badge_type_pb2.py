...
_BADGETYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name='BADGE_UNSET', index=0, number=0, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='BADGE_TRAVEL_KM', index=1, number=1, options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
        ...
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='BADGE_PIKACHU', index=37, number=37, options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='BADGE_UNOWN', index=38, number=38, options=None, type=None),
        _descriptor.EnumValueDescriptor(
